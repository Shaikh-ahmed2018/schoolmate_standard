...
public class UploadStudentXlsPOJO {
	...
	private String classNameById;
	private String sectionname;
	private String sectionNameById;
	private String concession_applicable;
	private String concession_type;
	private String caste;
	private String medicalhistory;
	private String studentsiblingname;
	private String studentsiblingadmission;
	private String studentsiblingclass;
	private String reason;
	
	private String specilization;
	private String schoolName;
	private String isParentsGuardianWorking;
	...
	private int duplicateInExcel;
	private String workingParentsGuardianName;
	
	private String streamValue;
	private String calssValue;
	...
	public String getCalssValue() {
		return calssValue;
	}
	public void setCalssValue(String calssValue) {
		this.calssValue = calssValue;
	}
	...
	public String getWorkingParentsGuardianName() {
		return workingParentsGuardianName;
	}
	public void setWorkingParentsGuardianName(String workingParentsGuardianName) {
		this.workingParentsGuardianName = workingParentsGuardianName;
	}
	public int getDuplicateInExcel() {
		return duplicateInExcel;
	}
	public void setDuplicateInExcel(int duplicateInExcel) {
	...
	public String getIsParentsGuardianWorking() {
		return isParentsGuardianWorking;
	}
	public void setIsParentsGuardianWorking(String isParentsGuardianWorking) {
		this.isParentsGuardianWorking = isParentsGuardianWorking;
	}
	...
	public String getStudentsiblingadmission() {
		return studentsiblingadmission;
	}
	public void setStudentsiblingadmission(String studentsiblingadmission) {
		this.studentsiblingadmission = studentsiblingadmission;
	}
	public String getStudentsiblingclass() {
		return studentsiblingclass;
	}
	public void setStudentsiblingclass(String studentsiblingclass) {
		this.studentsiblingclass = studentsiblingclass;
	}
	public String getStudentsiblingname() {
		return studentsiblingname;
	}
	public void setStudentsiblingname(String studentsiblingname) {
		this.studentsiblingname = studentsiblingname;
	}
	...
	public String getConcession_applicable() {
		return concession_applicable;
	}
	public void setConcession_applicable(String concession_applicable) {
		this.concession_applicable = concession_applicable;
	}
	public String getConcession_type() {
		return concession_type;
	}
	public void setConcession_type(String concession_type) {
	...
	public void setClassNameById(String classNameById) {
		this.classNameById = classNameById;
	}
	public String getSectionNameById() {
		return sectionNameById;
	}
	public void setSectionNameById(String sectionNameById) {
		this.sectionNameById = sectionNameById;
	}
