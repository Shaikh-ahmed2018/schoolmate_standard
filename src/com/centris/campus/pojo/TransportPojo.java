...
public class TransportPojo {
	...
	public String[] getStagesidArray() {
		return stagesidArray;
	}

	public void setStagesidArray(String[] stagesidArray) {
		this.stagesidArray = stagesidArray;
	}
