...
public class StudentAttendancePojo {
	...
	public int getAtenid() {
		return atenid;
	}
	public void setAtenid(int atenid) {
		this.atenid = atenid;
	}
	...
	public String getSectinId() {
		return sectinId;
	}
	public void setSectinId(String sectinId) {
		this.sectinId = sectinId;
	}
