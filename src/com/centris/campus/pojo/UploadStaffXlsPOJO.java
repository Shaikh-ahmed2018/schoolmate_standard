...
public class UploadStaffXlsPOJO {
 ...
 private String isStudentStudying;
...
public String getIsStudentStudying() {
	return isStudentStudying;
}
public void setIsStudentStudying(String isStudentStudying) {
	this.isStudentStudying = isStudentStudying;
}
