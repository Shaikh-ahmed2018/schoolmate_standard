...
/*Pojo class for teacher registration */
public class TeacherRegistrationPojo {
	...
	public void setLeavemap(Map<String, String> leavemap) {
	...
	public void setSchoolNameId(String schoolNameId) {
