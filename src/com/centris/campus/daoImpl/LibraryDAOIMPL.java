...
public class LibraryDAOIMPL implements LibraryDAO {
		...
		try {
			...
			if (!insert_categoryType.getHidden_category_id().equals("")) {
				...
				if (!code.equals(hiddencode)) {
					...
					count = validateCategoryType(insert_categoryType, custdetails);
					if (count == 1) {
						...
						if (count > 0) {
							//HelperClass.recordLog_Activity(insert_categoryType.getLog_audit_session(),"Library","Category Type","Update",pstmt.toString());
				...
				if (!code.equals(hiddencode)) {
					...
					if (count == 1) {
						...
						if (count > 0) {
							//HelperClass.recordLog_Activity(insert_categoryType.getLog_audit_session(),"Library","Category Type","Insert",pstmt.toString());
	...
	public String inactiveCategoryType(String[] catIdlist,String log_audit_session, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for(int i=0; i<catIdlist.length;  i++){
				...
				count = pstmt.executeUpdate();
				if (count > 0) {
					//HelperClass.recordLog_Activity(log_audit_session,"Library","Category Type","Inactive",pstmt.toString());   
					pstmt1 = conn
							.prepareStatement(SQLUtilConstants.INACTIVE_SUB_CATEGORY_TYPE);
					pstmt1.setString(1, category_code);
					count1 = pstmt1.executeUpdate();
					if (count1 > 0) {
						//HelperClass.recordLog_Activity(log_audit_session,"Library","Category Type","Inactive",pstmt1.toString());   
						pstmt2 = conn
								.prepareStatement(SQLUtilConstants.INACTIVE_SUB1_CATEGORY_TYPE);
						pstmt2.setString(1, category_code);
						count2 = pstmt2.executeUpdate();
						if (count2 > 0) {
							//HelperClass.recordLog_Activity(log_audit_session,"Library","Category Type","Inactive",pstmt2.toString());   
							pstmt3 = conn
									.prepareStatement(SQLUtilConstants.INACTIVE_SUB2_CATEGORY_TYPE);
							pstmt3.setString(1, category_code);
							count3 = pstmt3.executeUpdate();
							if (count3 > 0) {
								//HelperClass.recordLog_Activity(log_audit_session,"Library","Category Type","Inactive",pstmt3.toString());   
								...
								if (count4 > 0) {
									////HelperClass.recordLog_Activity(log_audit_session,"Library","Category Type","Inactive",pstmt4.toString());   
	...
	public String insertLibraryLocations(LibraryLocationPojo insert_libLoc, UserLoggingsPojo custdetails) {
		...
		try {
			...
			pstmt.setString(1,IDGenerator.getPrimaryKeyID("campus_library_location",custdetails));
			...
			count = pstmt.executeUpdate();
			if (count > 0) {
				////HelperClass.recordLog_Activity(insert_libLoc.getLog_audit_session(),"Library","Library location","Insert",pstmt.toString());
				result = "success";
			} else {
				result = "fail";
			}
		...
		try {
			...
			if (!sub1.getHidden_subcategory1_id().equals("")) {
				...
				if (!id.equalsIgnoreCase(Hid)) {
					...
					countid = validateSubcategoryType1(sub1,custdetails);
					...
					if (countid == false) {
						...
						if (count > 0) {
							//HelperClass.recordLog_Activity(sub1.getLog_audit_session(),"Library"," Sub Category Type1","Update",pstmt.toString());
							status = "Updating Record Progressing...";
						} else {
							status = "Failed To Update The Record";
						}
				...
				if (sub1.getSubcategorytype1code() != null) {
					...
					if (countid == true) {
						...
						if (count > 0) {
							//HelperClass.recordLog_Activity(sub1.getLog_audit_session(),"Library","Sub Category Type1","Insert",pstmt.toString());
							status = "Adding Record Progressing...";
						} else {
	...
	public ArrayList<LibrarySearchIssueDetailsVO> getStudentIssuedList(
			String locid, String accyear, UserLoggingsPojo custdetails) {
	...
	/*public String saveSubscriberDetails(LibrarySubsciberDetailsPojo pojo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			conn = JDBCConnection.getSeparateConnection(custdetails);
			psmt1=conn.prepareStatement("SELECT COUNT(`subscriberNumber`) FROM `campus_library_subscriber_details` WHERE `subscriberNumber`=? AND `accyear_ID`=? AND `libraryid`=?");
			...
			if(count2==0){
			psmt2=conn.prepareStatement("SELECT COUNT(`staffId`) FROM `campus_library_subscriber_details` WHERE `staffId`=? AND `accyear_ID`=? AND `libraryid`=? AND `subscriberType`='teacher' ");
	...
	public String saveSubscriberDetails(LibrarySubsciberDetailsPojo pojo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			if(count2==0){
				...
				if(pojo.getSuscriberType().equalsIgnoreCase("others")) {
					key = IDGenerator.getPrimaryKeyID("campus_library_other_subscriber",custdetails);
					PreparedStatement pstmt=conn.prepareStatement("INSERT INTO campus_library_other_subscriber (subscriberid,name,address,gender,contact_number,emailid) VALUES(?,?,?,?,?,?)");
					pstmt.setString(1, key);
					pstmt.setString(2, pojo.getOtherUserName());
					pstmt.setString(3, pojo.getOtherUserAddr());
					pstmt.setString(4, pojo.getOtherUserGender());
					pstmt.setString(5, pojo.getOtherUserContact());
					pstmt.setString(6, pojo.getOtherUserEmail());
					pstmt.executeUpdate();
					pstmt.close();
				}
				else if(pojo.getSuscriberType().equalsIgnoreCase("teacher")) {
					key=pojo.getStaffid();
				}
				else {
					key=pojo.getStudentIdHidden();
				}

				psmt = conn.prepareStatement(LibrarySqlUtils.saveSubscriberDetails);
				psmt.setString(1, key);
				psmt.setString(2, pojo.getSuscriberType());
				psmt.setString(3, pojo.getSubscriberNo().toUpperCase());
				psmt.setString(4, pojo.getLocationName());
				psmt.setString(5, pojo.getAccId());
				psmt.setString(6, pojo.getDepositType());
				psmt.setString(7, pojo.getCardNo());
				psmt.setString(8, pojo.getCheckNo());
				psmt.setString(9, pojo.getEnterAmount());
				psmt.setString(10, pojo.getPaymentDate());
				psmt.setString(11, pojo.getStatus());


				count1 = psmt.executeUpdate();

				if (count1 > 0) {
					HelperClass.recordLog_Activity(pojo.getLog_audit_session(),"Library","Subscriber Details","Insert",psmt.toString(),custdetails);
					result = "true";
				} else {
					result = "false";
				}
	...
	public ArrayList<LibrarySubscribVO> getStudentData(String academicYear,
			String admissionNo, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
	...
	public ArrayList<LibrarySubscribVO> getStaffData(String staffid,
			String locId, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
	...
	@Override
	public ArrayList<LibrarySearchSubscriberVO> getStudentListDetails(String academic_year, 
	 String location, String select,String classname,String sectionid,UserLoggingsPojo custdetails,String searchValue)
	{
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		...
		try {
			...
			while (rs.next()) {
				...
				vo.setLocation(rs.getString("libraryid"));
				...
				vo.setDivision(rs.getString("classsection_name_var"));
				vo.setStatus(rs.getString("statuss"));
	...
	public String inactiveSubCategoryType1(String[] id,String log_audit_session, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for(int i=0 ;i<id.length;i++){
				...
				count = pstmt.executeUpdate();
				if (count > 0) {
					//HelperClass.recordLog_Activity(log_audit_session,"Library","Sub Category Type1","InActive",pstmt.toString());
					...
					count1 = pstmt1.executeUpdate();
					if (count1 > 0) {
						//HelperClass.recordLog_Activity(log_audit_session,"Library","Sub Category Type1","InActive",pstmt1.toString());
						...
						count2 = pstmt2.executeUpdate();
						if (count2 > 0) {
							//HelperClass.recordLog_Activity(log_audit_session,"Library","Sub Category Type1","InActive",pstmt2.toString());
							conn.commit();
							status = "Record Inactivated";
						}
						else{
	...
	public ArrayList<LibrarySearchSubscriberVO> getStudentListByClassName(
			...
			UserLoggingsPojo custdetails,String searchValue) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public String updateLibLocations(LibraryLocationPojo insert_libLoc, UserLoggingsPojo custdetails) {
		...
		try {
			...
			count = pstmt.executeUpdate();
			if (count > 0) {
				//HelperClass.recordLog_Activity(insert_libLoc.getLog_audit_session(),"Library","Library location","Update",pstmt.toString());
				result = "successfully";
			} else {
				result = "failed";
			}
	...
	public ArrayList<LibrarySearchSubscriberVO> getStudentListBySection(
			...
			String sectionid,String select, UserLoggingsPojo custdetails,String searchValue) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public List<LibrarySearchSubscriberVO> searchsubscriberList(
			String searchTextVal, String academic_year, String location, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public ArrayList<LibrarySearchSubscriberVO> SearchStaffDetailsByEndsWith(String searchTextVal,
			String location,String select,String department,String designation,String accyear, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public ArrayList<LibrarySearchSubscriberVO> getStaffListFilterByLocationAndAcyearid(
			String accyear_ID, String libraryid, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public String insertSubCategoryTypeDetail(SubCategoryTypeVO sub, UserLoggingsPojo custdetails) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int count = 0;
		String result = null;
		...
		try {
			...
			if (sub.getSubcategory_id().equals("")) {
				...
				System.out.println("Validating--------------");
				countid = validateSubcategoryType(sub, custdetails);
				System.out.println("countid is " + countid);
				...
				if (countid == true) {
					...
					count = pstmt.executeUpdate();
					if (count > 0) {
						//HelperClass.recordLog_Activity(sub.getLog_audit_session(),"Library","Sub Category Type","Insert",pstmt.toString());
				...
				if (!id.equalsIgnoreCase(hid)) {
					...
					count = pstmt.executeUpdate();
					if (count > 0) {
						//HelperClass.recordLog_Activity(sub.getLog_audit_session(),"Library","Sub Category Type","Update",pstmt.toString());
					...
					if (countid == true) {
						...
						pstmt = conn.prepareStatement(SQLUtilConstants.UPDATE_SUBCATEGORY_TYPE);
						pstmt.setString(1, sub.getCategorytypecode());
						pstmt.setString(2, sub.getSubcategorytypecode());
						pstmt.setString(3, sub.getSubcategorytypename());
						pstmt.setString(4, sub.getDescription());
	...
	@Override
	public boolean validateSubcategoryType2(SubCategoryType2VO sub2, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public String insertSubCategoryType2Detail(SubCategoryType2VO sub2, UserLoggingsPojo custdetails) {
		...
		try {
			if (!sub2.getHidden_subcat2_id().equals("")) {
				...
				if (!id.equalsIgnoreCase(Hid)) {
					System.out.println("Validating--------------");
					countid = validateSubcategoryType2(sub2, custdetails);
					System.out.println("countid is " + countid);
					...
					if (countid == true) {
						...
						if (count > 0) {
							//HelperClass.recordLog_Activity(sub2.getLog_audit_session(),"Library","Sub Category Type2","Update",pstmt.toString());
							status = "Updating Record Progressing...";
						} else {
				...
				if (sub2.getSubcategorytype1code() != null) {
					...
					if (countid == true) {
						...
						if (count > 0) {
							//HelperClass.recordLog_Activity(sub2.getLog_audit_session(),"Library","Sub Category Type2","Insert",pstmt.toString());
							status = "Adding Record Progressing...";
						} else {
	...
	public String deleteLibraryLocations(String[] librarylocid,String log_audit_session, UserLoggingsPojo custdetails) {
		...
		try {
			for(int i=0;i<librarylocid.length;i++){
				...
				location_pstmt = conn.prepareStatement("SELECT COUNT(*) libloc FROM `campus_library_stock_entry` WHERE `library_location`=?");

				location_pstmt.setString(1, librarylocid[i]);
				System.out.println("9999999999999"+location_pstmt);
				...
				if(no == 0){
					...
					System.out.println("888888888888"+pstmt);
					...
					if(no == 0){
						...
						System.out.println("777777777777777"+pstmtleave);
						...
						if(no == 0){
							...
							if(no == 0){
								...
								PreparedStatement pstmt3 = conn.prepareStatement("SELECT COUNT(*) libloc FROM `campus_library_subscriber_details` WHERE `libraryid`=?");
								...
								if(no == 0 ){
									...
									ps_deletelocation = conn.prepareStatement(LibrarySqlUtils.DELETE_LIBRARY_LOCATIONS);

									ps_deletelocation.setString(1, librarylocid[i]);

									System.out.println("11111111111111"+ps_deletelocation);
									no = ps_deletelocation.executeUpdate();

									if(no > 0){
										HelperClass.recordLog_Activity(log_audit_session,"Library","Library location","Delete",ps_deletelocation.toString(),custdetails);
										status = "true";
									}
									else{
										status = "false";
	...
	public List<LibrarySearchIssueDetailsVO> getIssueDetailsByAnyWhere(
			String searchTextVal, String locid, String accyear, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
	...
	public String inactiveSubCategoryType(String[] id, SubCategoryTypeVO vo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for(int i=0 ;i<id.length;i++){
				...
				count = pstmt.executeUpdate();
				if (count > 0) {
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type","Inactive",pstmt.toString());
					pstmt1 = conn.prepareStatement(SQLUtilConstants.INACTIVE_SUB1_CATEGORY_TYPE);
					pstmt1.setString(1, subcategory_code);
					count1 = pstmt1.executeUpdate();
					if (count1 > 0) {
						//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type","Inactive",pstmt1.toString());
						pstmt2 = conn.prepareStatement(SQLUtilConstants.INACTIVE_SUB2_CATEGORY_TYPE);
						pstmt2.setString(1, subcategory_code);
						count2 = pstmt2.executeUpdate();
						if (count2 > 0) {
							//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type","Inactive",pstmt2.toString());
							pstmt3 = conn.prepareStatement(SQLUtilConstants.INACTIVE_SUB3_CATEGORY_TYPE);
							pstmt3.setString(1, subcategory_code);
							count3 = pstmt3.executeUpdate();

							if (count3 > 0) {
								//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type","Inactive",pstmt3.toString());
								status = "Record Inactivated";
							} else {
								status = "Failed To Add The Record";
							}
	...
	public ArrayList<LibrarySearchIssueDetailsVO> getTeacherList(String locid,
			String accyear, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<CategoryTypeVO> getSubCategoryDetails(String cattype,
			String status, UserLoggingsPojo custdetails) {
	...
	public ArrayList<LibrarySubscribVO> getSubscriberDetailsListPage(
			...
			String designation, String name, UserLoggingsPojo custdetails) {
		PreparedStatement psmt = null;
		ResultSet rs = null;
		Connection conn = null;
		int sno = 0;
		...
		try {
			...
			if (suscriberType.equalsIgnoreCase("studentwise")) {
				...
				while (rs.next()) {
					...
					vo.setSubscriberId(rs.getString("subscriberId"));
					vo.setSubscriberNo(rs.getString("subscriberNumber"));
					vo.setOtherUserName(rs.getString("name"));
					vo.setOtherUserContact(rs.getString("contact_number"));
					vo.setOtherUserGender(rs.getString("gender"));
					vo.setOtherUserAddr(rs.getString("address"));
					vo.setStatus(rs.getString("status"));
					vo.setOtherUserEmail(rs.getString("emailid"));
					vo.setLocationName(rs.getString("library_location_name"));
					list.add(vo);
				}
			}
	...
	public List<CategoryTypeVO> getSubCategoryList(String catcode,
			String subcatcode, String status, UserLoggingsPojo custdetails) {
	...
	public ArrayList<LibrarySearchIssueDetailsVO> getTeacherDesgList(
			String locid, String accyear, String dept, String desg, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<LibrarySearchIssueDetailsVO> getIssueByStartwith(
			LibrarySearchIssueDetailsVO vo, String selection, UserLoggingsPojo custdetails) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public String inactiveSubCategoryType2(String[] id,String log_audit_session, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for(int i=0 ;i<id.length;i++){
				...
				count = pstmt.executeUpdate();
				if (count > 0) {
					//HelperClass.recordLog_Activity(log_audit_session,"Library","Sub Category Type2","InActive",pstmt.toString());
					...
					if(count1 > 0){
						//HelperClass.recordLog_Activity(log_audit_session,"Library","Sub Category Type2","InActive",pstmt1.toString());
						conn.commit();
						status = "Record Inactivated";
					}else{
						status = "Failed To Add The Record";
	...
	public ArrayList<LibrarySearchIssueDetailsVO> getOthersList(String locid,
		...
		try {
			...
			while (rs.next()) {
				...
				vo.setSlno(count);
				vo.setStuSubNo(rs.getString("subscriberNumber"));
				vo.setOthersName(rs.getString("name"));
				vo.setContactNo(rs.getString("contact_number"));
	...
	public ArrayList<LibrarySearchIssueDetailsVO> getTeacherDeptList(
			String locid, String accyear, String dept, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<CategoryTypeVO> SearchCategoryTypeList(String catcode,
			String subcatcode, String status, String searchname, UserLoggingsPojo custdetails) {
	...
	public List<SubCategoryType1VO> getTabByCategoryType(String cattype,
			String status, String subcacode, String subcacode1,UserLoggingsPojo custdetails) {
	...
	public String insertSubCategoryTypeDetail3(SubCategoryTypeVO sub, UserLoggingsPojo custdetails) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int count = 0;
		String result = null;
		...
		try {
			...
			if (sub.getSubcategory_id().equals("")) {
				...
				System.out.println("Validating--------------");
				countid = validateSubcategoryType3(sub, custdetails);
				System.out.println("countid is " + countid);
				System.out.println("countname is " + countname);
				...
				if (countid == true) {
					...
					count = pstmt.executeUpdate();
					if (count > 0) {
						//HelperClass.recordLog_Activity(sub.getLog_audit_session(),"Library","Sub Category Type3","Insert",pstmt.toString());
				...
				if (!id.equalsIgnoreCase(hid)) {
					...
					if (count > 0) {
						//HelperClass.recordLog_Activity(sub.getLog_audit_session(),"Library","Sub Category Type3","Update",pstmt.toString());
		...
		try {
			...
			{  
				if(!libform.getAccessionNo().equalsIgnoreCase(libform.getHaccessionNo())){
					String status=validateStockEnteryDetails(accno, custdetails);
					if(status.equalsIgnoreCase("true")){
						...
						if(count >0){
							//HelperClass.recordLog_Activity(libform.getLog_audit_session(),"Library","Stock Entry","Update",pstmt.toString());
				...
				if(status.equalsIgnoreCase("true")){
					...
					pstmt.setString(34, libform.getAcademicyear());

					count = pstmt.executeUpdate();
					System.out.println("save"+pstmt);
					if(count >0){
						//HelperClass.recordLog_Activity(libform.getLog_audit_session(),"Library","Stock Entry","Insert",pstmt.toString());
						result = "success";
					}
					else{
						result = "fail";
	...
	@Override
	public List<LibraryStockEntryVO> getBookIssueDetailsByAccessionNo(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			if(count!="0" && count1 >0){
				...
				while (rs.next()) {
					...
					form.setItem(rs.getString("itemtype"));
	...
	public String insertBookIssueDetails(LibraryStockEntryVO insert_issue, UserLoggingsPojo custdetails) {
		...
		try {
			...
			pstmt.setString(8, id.getPrimaryKeyID("campus_library_book_issue_details",custdetails));
			...
			if (count > 0) {
				//HelperClass.recordLog_Activity(insert_issue.getLog_audit_session(),"Library","Issued","Insert",pstmt.toString());
				result = "success";
	...
	public List<SubCategoryType1VO> getTableBycategorytypeandSub(
			String cattype, String status, String category, String subcacode1,UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		Connection con = null;
		ResultSet rs = null;
		ArrayList<SubCategoryType1VO> list = new ArrayList<SubCategoryType1VO>();
	...
	public List<SubCategoryType1VO> getTableBycategorytypeandSub1(
			String cattype, String status, String category, String subcacode, UserLoggingsPojo custdetails) {
	...
	public List<SubCategoryType1VO> getTableByStatus(String status,
			String categorycode, String subcategorycode, String subcategory1code, UserLoggingsPojo custdetails) {
	...
	public List<SubCategoryType2VO> getTabBySub2CategoryType(String cattype,
			...
			String subcategory2, UserLoggingsPojo custdetails) {
	...
	public List<SubCategoryType2VO> getTabBySub2subCategory1Type(
			...
			String subcategory1, String subcategory2, UserLoggingsPojo custdetails) {
	...
	public String inactiveSubCategoryType3(String[] id, SubCategoryTypeVO vo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for(int i=0 ;i<id.length;i++){
				...
				System.out.println(pstmt);
				if (count > 0) {
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type3","InActive",pstmt.toString());
					status = "Record Inactivated";
				} else {
	...
	public List<CategoryTypeVO> getSubCategoryDetails3(String cattype,
			...
			String subcatcode3, String status, UserLoggingsPojo custdetails) {
	...
	public List<CategoryTypeVO> SearchCategoryType3List(String catcode,
			String subcatcode, String subcatcode1, String subcatcode2,
			String subcatcode3, String status, String searchname, UserLoggingsPojo custdetails) {
		...
		try{
			...
			if(subscriberType.equalsIgnoreCase("others")){
				...
				while(rs.next()){
					...
					vo.setEnterAmount(rs.getString("Amount"));
					list.add(vo);
				}
			}
				...
				while(rs.next()){
					LibrarySubscribVO vo = new LibrarySubscribVO();
					vo.setStaffID(rs.getString("subscriberId"));
	...
	@Override
	public int validateCategoryType(CategoryTypeVO sub1,UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public ArrayList<LibrarySearchSubscriberVO> getOthersListDetails(
			String location, String select,String academic_year, UserLoggingsPojo custdetails,String searchValue) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
		...
		try {
			...
			while (rs.next()) {
				...
				vo.setLocation(rs.getString("libraryid"));
				vo.setSubssciberNo(rs.getString("subscriberNumber"));
				vo.setOthereName(rs.getString("name"));
				vo.setOthereContactNumber(rs.getString("contact_number"));
				vo.setOthereMail_Id(rs.getString("emailid"));
				vo.setOthereAddress(rs.getString("address"));
				vo.setStatus(rs.getString("statuss"));
	...
	public ArrayList<LibrarySearchSubscriberVO> SearchOthersDetailsByAnyWhere(String searchTextVal,String location,
			String select,String accyear, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public LibrarySubscribVO gotosubscribersDetails(String location,
			String subId, String academic_year, String subscriberType, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		PreparedStatement pstmt1 = null;
		ResultSet rs1 = null;
		...
		try {
			...
			if (subscriberType.equalsIgnoreCase("Student")) {
				...
				while (rs1.next()) {
					...
					vo.setLocation(rs1.getString("libraryid"));
					...
					vo.setEnterAmount(rs1.getString("Amount"));
					vo.setPaymentStatus(rs1.getString("paymentstatus"));

				}
			}

			else if (subscriberType.equalsIgnoreCase("staff")) {
				pstmt1 = conn.prepareStatement(LibrarySqlUtils.GET_STAFF_DETAIL_BY_SUBSCRIBER_DETAILS);
				...
				while (rs1.next()) {
					...
					vo.setSubscriberType(rs1.getString("subscriberType"));
					vo.setSubscriberNo(rs1.getString("subscriberNumber"));
					vo.setStaffID(rs1.getString("registerId"));
				...
				while (rs1.next()) {
					...
					vo.setSubscriberType(rs1.getString("subscriberType"));
					vo.setSubscriberNo(rs1.getString("subscriberNumber"));
					vo.setSubscriberName(rs1.getString("name"));
					vo.setGender(rs1.getString("gender"));
					vo.setContactNumber(rs1.getString("contact_number"));
					vo.setEmail(rs1.getString("emailid"));
					vo.setDepositType(rs1.getString("depositType"));
					vo.setStatus(rs1.getString("status"));
					vo.setPaymentDate(rs1.getString("paymentDate"));
					vo.setOtherUserAddr(rs1.getString("address"));
					vo.setEnterAmount(rs1.getString("Amount"));
					vo.setPaymentStatus(rs1.getString("paymentstatus"));
				}
			}
	...
	public String updateSubscriberDetails(LibrarySubscribVO resultData, UserLoggingsPojo custdetails) {
		...
		try {
			...
			if (subscriberType.equalsIgnoreCase("student")) {
				pstmt1 = conn.prepareStatement(LibrarySqlUtils.UPDATE_STUDENT_DETAIL_BY_SUBSCRIBER_DETAILS);
		...
		/*		pstmt1.setString(7, resultData.getOtherUserAddr());*/
				...
				pstmt1 = conn.prepareStatement(LibrarySqlUtils.UPDATE_STAFF_DETAIL_BY_SUBSCRIBER_DETAILS);
				...
				pstmt1 = conn.prepareStatement(LibrarySqlUtils.UPDATE_OTHERS_DETAIL_BY_SUBSCRIBER_DETAILS);
				...
				pstmt1.setString(11, resultData.getSubscriberId());
			/*	pstmt1.setString(12, resultData.getLoc_ID());*/
				/*pstmt1.setString(12, resultData.getAccyear());*/
	...
	public LibrarySubscribVO IssueStatementBySubScriberType(String location, String subId, String academic_year,String subscriberType, UserLoggingsPojo custdetails) {
		...
		try {
			...
			if(subscriberType.equalsIgnoreCase("Student")){
				...
				pstmt1.setString(2,location);
				pstmt1.setString(3,subId);
				//System.out.println("GET_STUDENT_DETAIL_BY_GOTO_ISSUESTATEMENT -->>"+pstmt1);
				rs1=pstmt1.executeQuery();
				...
				System.out.println("GET_STAFF_DETAIL_BY_GOTO_ISSUESTATEMENT -->>"+pstmt1);
				rs1=pstmt1.executeQuery();				
				while(rs1.next()){
					vo = new LibrarySubscribVO();
					vo.setSubscriberId(rs1.getString("subscriberId"));
				...
				pstmt1.setString(2,academic_year);
				pstmt1.setString(3,location);
				//System.out.println("GET_OTHERS_DETAIL_BY_GOTO_ISSUESTATEMENT -->>"+pstmt1);
				rs1=pstmt1.executeQuery();
	...
	@Override
	public ArrayList<LibrarySearchSubscriberVO> IssueStatementTable(String location,String subId,String academic_year,String subscriberType, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs=null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	@Override
	public boolean validateSubcategoryType(SubCategoryTypeVO sub, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<LibraryStockEntryVO> getAccessionNo(LibraryStockEntryVO registrationVo,UserLoggingsPojo custdetails)
	{
		logger.setLevel(Level.DEBUG);
	...
	@Override
	public boolean validateSubcategoryType3(SubCategoryTypeVO sub, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<LibraryStockEntryDetailsForm> getStockEntryBookList(UserLoggingsPojo custdetails, StockEntryVo vo) {
		...
		try{
			...
			pstmt.setString(2, vo.getLibrarylocation());
			
			System.out.println("STOCK_ENTRY_LIST -->>"+pstmt);
			rs=pstmt.executeQuery();
			while(rs.next()){
				...
				from.setItemType(rs.getString("itemtype"));
				...
				if(rs.getInt("total_available_copies")<=0){
					from.setCurrentStatus("Not Available");
				}else{
					from.setCurrentStatus(rs.getString("Availability_status"));
				}
				
				from.setAvailableCopies(rs.getInt("total_available_copies"));
				StockList.add(from);
			}
	...
	public String blockTheSubscriber(String subscribeNo, UserLoggingsPojo custdetails) {
		PreparedStatement psmt = null;
		int count=0;
		Connection conn =null;
		String status =null;
	...
	public ArrayList<LibrarySubscribVO> getStaffRegId(String loc, String searchterm, UserLoggingsPojo custdetails) {
		...
		try{
			conn=JDBCConnection.getSeparateConnection(custdetails);
			psmt=conn.prepareStatement("SELECT DISTINCT t.`registerId` FROM `campus_teachers` t LEFT JOIN campus_library_location cll ON cll.loc_id=t.`Loc_ID` WHERE t.registerId LIKE ? AND cll.library_loc_id = ?");
	...
	public String duplicateDataCheck(LibrarySubsciberDetailsPojo pojo, UserLoggingsPojo custdetails) {
		...
		{	
			...
			conn=JDBCConnection.getSeparateConnection(custdetails);
			psmt=conn.prepareStatement("SELECT COUNT(`subscriberId`) FROM `campus_library_subscriber_details` WHERE  subscriberId=? AND `libraryid`=? AND `accyear_ID`=?");
	...
	public String activeSubCategoryType(String[] id, SubCategoryTypeVO vo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for (int i = 0; i < id.length; i++) {
				...
				count = pstmt.executeUpdate();
				if (count > 0){
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type","Active",pstmt.toString());
					pstmt1 = conn.prepareStatement(SQLUtilConstants.ACTIVE_CATEGORY_TYPE);
					pstmt1.setString(1, subcategory_code);
					count = pstmt1.executeUpdate();
					if (count > 0) {
						//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type","Active",pstmt1.toString());
	...
	public String activeSubCategoryType3(String[] id, SubCategoryTypeVO vo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for(int i=0 ;i<id.length;i++){
				...
				count = pstmt.executeUpdate();
				if (count > 0) {
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type3","Active",pstmt.toString());
					pstmt1 = conn
							.prepareStatement(SQLUtilConstants.ACTIVE_SUB2_CATEGORY_TYPE);
					pstmt1.setString(1, category_code);
					count1 = pstmt1.executeUpdate();
					if (count > 0) {
						//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type3","Active",pstmt1.toString());
						pstmt1 = conn.prepareStatement(SQLUtilConstants.ACTIVE_SUB1_CATEGORY_TYPE);
						pstmt1.setString(1, category_code);
						count1 = pstmt1.executeUpdate();
						if (count1 > 0) {
							//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type3","Active",pstmt1.toString());
							...
							count2 = pstmt2.executeUpdate();
							if (count2 > 0) {
								//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type3","Active",pstmt2.toString());
								pstmt3 = conn
								...
								if (count3 > 0) {
									//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type3","Active",pstmt3.toString());
									status = "Record Activated";
								} else {
									status = "Failed To Activate The Record";
								}
	...
	public ArrayList<LibrarySubscribVO> getBlockListedStudentData(java.lang.String accyear, java.lang.String location, UserLoggingsPojo custdetails) {
		Connection conn =null;
		ResultSet rs = null;
		PreparedStatement psmt =null;
		ArrayList<LibrarySubscribVO> list = new ArrayList<LibrarySubscribVO>();
	...
	public String insertBookReturnDetails(LibraryStockEntryVO insert_issue, UserLoggingsPojo custdetails) {
		...
		try {
			...
			pstmt.setString(8,IDGenerator.getPrimaryKeyID("campus_library_book_return_details",custdetails));
			pstmt.setString(9, insert_issue.getSubscriberId());
			pstmt.setString(10, insert_issue.getIssueId());
			count = pstmt.executeUpdate();
			System.out.println(pstmt);
			if (count > 0) {
				//HelperClass.recordLog_Activity(insert_issue.getLog_audit_session(),"Library","Returns","Returns",pstmt.toString());
				result = "success";
	...
	public String activeSubCategoryType1(String[] id,
		...
		try {
			...
			for (int i = 0; i < id.length; i++) {
				...
				count = pstmt.executeUpdate();
				if (count > 0){
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type1","Active",pstmt.toString());
					pstmt1 = conn.prepareStatement(LibrarySqlUtils.ACTIVE_SUBCATEGORY_TYPE);
					pstmt1.setString(1, subcategory_code);
					count1 = pstmt1.executeUpdate();
					if (count1 > 0) {
						//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type1","Active",pstmt1.toString());
						pstmt2 = conn.prepareStatement(LibrarySqlUtils.ACTIVE_CATEGORY_TYPE);
						pstmt2.setString(1, category_code);
						count2 = pstmt2.executeUpdate();
						if (count2 > 0) {
							//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type1","Active",pstmt2.toString());
							status = "Record Activated";
						} else {
							status = "Failed To Activate The Record";
						}
	...
	public String activeSubCategoryType2(String[] id,
		...
		try {
			...
			for (int i = 0; i < id.length; i++) {
				...
				count = pstmt.executeUpdate();
				if (count > 0){
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type2","Active",pstmt.toString());
					pstmt1 = conn.prepareStatement(LibrarySqlUtils.ACTIVE_SUBCATEGORY_TYPE1_IN_2);
					pstmt1.setString(1, subcategory1_code);
					count1 = pstmt1.executeUpdate();
					if (count1 > 0) {
						//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type2","Active",pstmt1.toString());
						pstmt2 = conn.prepareStatement(LibrarySqlUtils.ACTIVE_SUBCATEGORY_TYPE_IN_2);
						pstmt2.setString(1, subcategory_code);
						count2 = pstmt2.executeUpdate();
						if (count2 > 0) {
							//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type2","Active",pstmt2.toString());
							pstmt3 = conn.prepareStatement(LibrarySqlUtils.ACTIVE_CATEGORY_TYPE_IN_2);
							pstmt3.setString(1, category_code);
							count3 = pstmt2.executeUpdate();
							if (count3 > 0) {
								//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Sub Category Type2","Active",pstmt3.toString());
								status = "Record Activated";
							} else {
								status = "Failed To Activate The Record";
							}
	...
	public String activeCategoryType(String[] id, CategoryTypeVO vo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for (int i = 0; i < id.length; i++) {
				...
				count = pstmt.executeUpdate();
				if (count > 0){
					//HelperClass.recordLog_Activity(vo.getLog_audit_session(),"Library","Category Type","Active",pstmt.toString());
					status = "Record Activated";
				}else{
					status = "Failed To Activate The Record";
				}
	...
	public List<StudentRegistrationVo> studentSearchbyadmissionNoForlibrary(
			StudentRegistrationVo registrationVo, UserLoggingsPojo custdetails) {
		...
		try{
			...
			if(!obj.getEntry_id().equalsIgnoreCase("") && obj.getEntry_id()!=null){
				...
				if(!obj.getPublisher().equalsIgnoreCase(obj.getEntry_id())){
					String status=validationpubsettings(pub, address, email,telphone,mobilenum, custdetails);
					/*	if(status.equalsIgnoreCase("true")){
					...
					System.out.println(pstmt);
					if(count >0){
						HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Publisher Setting","Update",pstmt.toString(), custdetails);
						result = "success";
					}
					else{
						result = "fail";
				...
				if(status.equalsIgnoreCase("true")){
					...
					pstmt.setString(1, IDGenerator.getPrimaryKeyID("campus_library_publisher_settings",custdetails));
					...
					if(count >0){
						HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Publisher Setting","Insert",pstmt.toString(), custdetails);
						result = "addsuccess";
					}
					else{
						result = "fail";
		...
		try{
			...
			for(int i=0;i<deleteId.length;i++){
				...
				if(no == 0 ){
					...
					if (result > 0) {
						HelperClass.recordLog_Activity(log_audit_session,"Library","Publisher Setting","Delete",pst.toString(),custdetails);
	...
	@Override
	public String validationpubsettings(String pub, String address, String email, String telphone, String mobilenum, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	@Override
	public ArrayList<LibrarySearchSubscriberVO> getTranferStudentListDetails(String academic_year, String location, String select,String classname, String sectionid, String libloc, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try{
			...
			rs=pstmt.executeQuery();
			/*System.out.println("TRANSFER_SUBSCRIBER_LIST -->>"+pstmt);*/
			while(rs.next()){
				count++;
				LibrarySearchSubscriberVO vo = new LibrarySearchSubscriberVO();
				vo.setSlno(count);
	...
	public ArrayList<LibrarySearchSubscriberVO> getTrasferStudentListBySection(
			String academic_year, String location, String classname,
			String sectionid,String select,String liblocation, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public ArrayList<LibrarySearchSubscriberVO> getTransferStaffListDetails(
			String accyear_ID, String libraryid, String select,
	...
	public ArrayList<LibrarySearchSubscriberVO> getlocationStudentList(
			String libloc, String select, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<LibrarySearchSubscriberVO> TransferSubscriberbySearch(String searchTextVal, String location,String academic_year,
			String liblocid, String select,String classname,String sectionid, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			System.out.println("TransferstudentlistSearch -->>"+pstmt);
			rs = pstmt.executeQuery();
	...
	public ArrayList<LibrarySearchSubscriberVO> TransferSubscriberbyStaffSearch(String searchTextVal, String location,
			String liblocid,String select,String department,String designation,String accyear, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public ArrayList<LibrarySearchSubscriberVO> TransferSubscriberbyotherSearch(
			String searchTextVal, String location, String select,String liblocid,
			String accyear,UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		...
		try {
			...
			System.out.println("TRANSFER_OTHER_SEARCH -->>"+pstmt);
			rs = pstmt.executeQuery();
		...
		try{
			...
			if(!obj.getEntry_id().equalsIgnoreCase("") && obj.getEntry_id()!=null)
			{
				if(!obj.getSuppliedBy().equalsIgnoreCase(obj.getEntry_id())){
					String status=validationsubsettings(suplier,supadd,emailid,telephone,supnum, custdetails);
					...
					System.out.println(pstmt);
					if(count >0){
						HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Supplier Settings","Update",pstmt.toString(),custdetails);
						result = "success";
					}
					else{
						result = "fail";
				...
				if(status.equalsIgnoreCase("true")){
					...
					pstmt.setString(1, IDGenerator.getPrimaryKeyID("campus_library_Supplier_settings",custdetails));
					...
					if(count >0){
						HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Supplier Settings","Insert",pstmt.toString(),custdetails);
						result = "addsuccess";
					}
					else{
						result = "fail";
		...
		try{
			...
			for(int i=0;i<deleteId.length;i++){
				...
				if(no==0){
					...
					if (result > 0) {
						HelperClass.recordLog_Activity(log_audit_session,"Library","Supplier Settings","Delete",pstmt.toString(),custdetails);
			...
			try {
				...
				if (rs_deleteliblocation != null && (!rs_deleteliblocation.isClosed())) {
					rs_deleteliblocation.close();
				}
				if (pst != null && (!pst.isClosed())) {
					pst.close();
	...
	public String validationsubsettings(String suplier,
			String supadd, String emailid, String telephone, String supnum, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try{
			...
			System.out.println("555555555555"+pstmt);
			rs=pstmt.executeQuery();
			while(rs.next()){
				count=rs.getInt(1);
	...
	public List<TeacherVo> othersSearchbyId(TeacherVo registrationVo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			while (rs.next()) {
				TeacherVo teachervo = new TeacherVo();
				teachervo.setSubscriberNumber(rs.getString("subscriberNumber")+ " - "+ rs.getString("name"));
	...
	public String insertBookReservationDetails(LibraryStockEntryVO insert_issue, UserLoggingsPojo custdetails) {
		...
		try {
			...
			pstmt.setString(1, IDGenerator.getPrimaryKeyID("campus_library_reservation_details",custdetails));
			...
			if (count > 0) {
				...
				//HelperClass.recordLog_Activity(insert_issue.getLog_audit_session(),"Library","Reservations","Insert",pstmt.toString());
				result = "success";
				/*pstmt1 = conn.prepareStatement(LibrarySqlUtils.UPDATE_STOCKENTRY_BY_ISSUE);
				pstmt1.setString(1, insert_issue.getAccessionNo());
				System.out.println("*****************************************************");
	...
	public List<LibraryStockEntryDetailsForm> getReservationListDetails(UserLoggingsPojo custdetails, LibraryVO vo) {
		...
		try{
			...
			pstmt.setString(1, vo.getLocId());
			pstmt.setString(2, vo.getLibLocId());
			...
			while(rs.next()){
				...
				else if(usertype.equalsIgnoreCase("other"))				
				{
					...
					while(rs1.next())
					{
						from.setSubscriberName(rs1.getString("name"));
						from.setContactNo(rs1.getString("contact_number"));
						from.setAddress(rs1.getString("address"));
	...
	public List<LibraryStockEntryVO> getOtherIssueDetails(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			while (rs.next()) {
				LibraryStockEntryVO form = new LibraryStockEntryVO();
				form.setContactNo(rs.getString("contact_number"));
	...
	public String addGeneralSettings(LibraryStockEntryVO obj, UserLoggingsPojo custdetails) {
		...
		try{
			...
			if(!obj.getEntry_id().equalsIgnoreCase("") && obj.getEntry_id()!=null)
			{
				...
				System.out.println(pstmt);
				if(count >0){
					//HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Genarel Settings","Update",pstmt.toString());
					result = "success";
				}
				else{
					result = "fail";
				...
				pstmt.setString(1, IDGenerator.getPrimaryKeyID("campus_library_generalsettings",custdetails));
				...
				if(count >0){
					//HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Genarel Settings","Insert",pstmt.toString());
					result = "addsuccess";
				}
				else{
					result = "fail";
	...
	@Override
	public String editGenarelSetting(String[] deleteId,String log_audit_session, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try{
			...
			if (result > 0) {
				//HelperClass.recordLog_Activity(log_audit_session,"Library","General Settings","Delete",pst.toString());
				status = MessageConstants.DELETE_SUPPLIER_SETTINGS_SUCCESS;
			} else {
				status = MessageConstants.DELETE_SUPPLIER_SETTINGS_FAIL;
	...
	public List<LibraryStockEntryVO> getBookReservationDetailsByAccNo(
			LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.START_POINT);
			logger.info(JDate.getTimeString(new Date())
	...
	@Override
	public List<LibraryStockEntryVO> getTeacherSubNo(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
			+ MessageConstants.START_POINT);
	logger.info(JDate.getTimeString(new Date())
	...
	@Override
	public List<LibraryStockEntryVO> getStuAccessionNo(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
			+ MessageConstants.START_POINT);
	logger.info(JDate.getTimeString(new Date())
	...
	@Override
	public List<LibraryStockEntryVO> getOtherSubName(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
			+ MessageConstants.START_POINT);
	logger.info(JDate.getTimeString(new Date())
	...
	try {
		...
		while (rs.next()) {
			LibraryStockEntryVO form = new LibraryStockEntryVO();
			form.setSubscriberId(rs.getString("issued_to"));
			form.setSubscriberName(rs.getString("name"));
			libVoList.add(form);
		}
	...
	@Override
	public List<LibraryStockEntryVO> getOtherSubNo(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
			+ MessageConstants.START_POINT);
	logger.info(JDate.getTimeString(new Date())
	...
	@Override
	public List<LibraryStockEntryVO> getFromDateList(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
			+ MessageConstants.START_POINT);
	logger.info(JDate.getTimeString(new Date())
	...
	@Override
	public List<LibraryStockEntryVO> getToDateList(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails) {logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
			+ MessageConstants.START_POINT);
	logger.info(JDate.getTimeString(new Date())
			...
			while (rs.next()) {
				...
				else if(usertype.equalsIgnoreCase("other"))				
				{
					...
					while(rs1.next())
					{
						...
						rsrv.setContactNo(rs1.getString("contact_number"));
						rsrv.setAddress(rs1.getString("address"));
	...
	public String updateBookReservationDetails(LibraryStockEntryVO insert_issue, UserLoggingsPojo custdetails) {
		...
		try {
			...
			count = pstmt.executeUpdate();
			if (count > 0) {
				//HelperClass.recordLog_Activity(insert_issue.getLog_audit_session(),"Library","Reservation","Update",pstmt.toString());
				result = "successfully";
			} else {
				result = "failed";
			}
	...
	public String deleteReservedBook(String[] librarylocid,String log_audit_session, UserLoggingsPojo custdetails) {
		...
		try {
			...
			for (int i = 0; i < librarylocid.length; i++) {
				...
				if (count > 0) {
					//HelperClass.recordLog_Activity(log_audit_session,"Library","Reservation","Delete",pstmt.toString());
	...
	public ArrayList<LibrarySearchSubscriberVO> getMostWantedStaffListDetails(String academic_year,
			String location,String select,String department,String designation, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public ArrayList<LibrarySearchSubscriberVO> getMostWantedStaffdetailsByDepartment(String accyear_ID,String libraryid,String department,String designation, String select, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public ArrayList<LibrarySearchSubscriberVO> getMostWantedStaffdetailsByDesignation(String accyear_ID,
			String libraryid,String department, java.lang.String designation,String select, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public ArrayList<LibrarySearchSubscriberVO> getMostWantedOthersListDetails(String location,String select,String academic_year, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
		ArrayList<LibrarySearchSubscriberVO> studentData = new ArrayList<LibrarySearchSubscriberVO>();
	...
	public String savejournalsubscriptiondetail(LibraryJournalSubscriptionVo obj, UserLoggingsPojo custdetails) {
		...
		try{
			String id = IDGenerator.getPrimaryKeyID("campus_library_journal_subscription",custdetails);
			conn=JDBCConnection.getSeparateConnection(custdetails);
			if(!obj.getEntryId().equalsIgnoreCase("") && obj.getEntryId()!=null){
				...
				count=pstmt.executeUpdate();
				if(count>0){
					//HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Journal Subscription","Update",pstmt.toString());
					result="success";
				}
				else{
					result="fail";
				...
				count=pstmt.executeUpdate();
				if(count>0){
					//HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Journal Subscription","Insert",pstmt.toString());
					result="addsuccess";
				}
				else{
					result="fail";
	...
	public ArrayList<LibrarySearchSubscriberVO> getAllBookDetails(LibrarySubsciberDetailsPojo pojo, UserLoggingsPojo custdetails)
	{
		...
		try {
			...
			if (pojo.getSelect().equalsIgnoreCase("all")) {
				...
				pstmt.setString(2, pojo.getLibLoc());
	...
	public List<LibrarySearchSubscriberVO> SearchBookSearchByaccNoandTitleAnyWhere(LibrarySubsciberDetailsPojo pojo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			if (pojo.getSearch().equalsIgnoreCase("anywhere"))
			{
				...
				pstmt.setString(6, pojo.getLocationName());
				pstmt.setString(7, pojo.getLibLoc());
	...
	public String deleteJournalSbscription(String[] deleteId,String log_audit_session, UserLoggingsPojo custdetails) {
		...
		try{
			...
			if (result > 0) {
				//HelperClass.recordLog_Activity(log_audit_session,"Library","Journal Subscription","Delete",pst.toString());
		...
		try {
			...
			if (pojo.getSelect().equalsIgnoreCase("all")) {
				if (pojo.getOrderBy().equalsIgnoreCase("publisher")) 
				{
					...
					value="GET_ALL_BOOK_DETAILS_BY_PUBLISHER";
				}
			}
			else if (pojo.getSelect().equalsIgnoreCase("issued")) 
			{
				if (pojo.getOrderBy().equalsIgnoreCase("publisher")) 
				{
					...
					value="GET_ISSUE_BOOK_DETAILS_BY_PUBLISHER";
				}
			}
			else if (pojo.getSelect().equalsIgnoreCase("available")) 
			{
				if (pojo.getOrderBy().equalsIgnoreCase("publisher")) 
				{
					...
					value="GET_AVAILABLE_BOOK_DETAILS_BY_PUBLISHER";
				}
			}
			else if (pojo.getSelect().equalsIgnoreCase("notavailable")) 
			{
				if (pojo.getOrderBy().equalsIgnoreCase("publisher")) 
				{
					...
					value="GET_NOT_AVAILABLE_BOOK_DETAILS_BY_PUBLISHER";
				}
			}
	...
	public List<LibraryStockEntryVO> getlocationlist(String locId, String itemId, String regdateId, 
			String booktitle, String authorId, String pubId, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			if (pojo.getSelect().equalsIgnoreCase("all")) {
				if (pojo.getOrderBy().equalsIgnoreCase("itemtype")) 
				{
					...
					value="GET_ALL_BOOK_DETAILS_BY_ITEMTYPE";
				}
			}
			else if (pojo.getSelect().equalsIgnoreCase("issued")) 
			{
				if (pojo.getOrderBy().equalsIgnoreCase("itemtype")) 
				{
					...
					value="GET_ISSUE_BOOK_DETAILS_BY_ITEMTYPE";
				}
			}
			else if (pojo.getSelect().equalsIgnoreCase("available")) 
			{
				if (pojo.getOrderBy().equalsIgnoreCase("itemtype")) 
				{
					...
					value="GET_AVAILABLE_BOOK_DETAILS_BY_ITEMTYPE";
				}
			}
			else if (pojo.getSelect().equalsIgnoreCase("notavailable")) 
			{
				if (pojo.getOrderBy().equalsIgnoreCase("itemtype")) 
				{
					...
					value="GET_NOT_AVAILABLE_BOOK_DETAILS_BY_ITEMTYPE";
				}
			}
			pstmt.setString(1, pojo.getLocationName());
			pstmt.setString(2, pojo.getLibLoc());
	...
	public List<LibraryStockEntryVO> getReservationListReport(String location, String accId, String subId, String accNo, String bookId,String fromdat, String todate,String date, UserLoggingsPojo custdetails) {
		...
		try{
			...
			if(date.equalsIgnoreCase("allfordate")){	 
                ...
                System.out.println("RESERVATION_DETAIL_REPORT -->>"+pstmt);
				...
				while(rs.next()){
					...
					from.setLibraryLocationName(rs.getString("library_location_name"));
				...
				System.out.println("RESERVATION_DETAIL_REPORT_DATE -->>"+pstmt);
	...
	public List<LibraryStockEntryDetailsForm> getReservationAccNo(String subtype,String accyear,
		...
		try{
			...
			pstmt.setString(2, locId);
			rs=pstmt.executeQuery();
			System.out.println("GET_ACCNO_RESERVATION -->>"+pstmt);
			while(rs.next()){
	...
	public ArrayList<LibrarySearchIssueDetailsVO> getOtherSubscriberDetailReport(
		...
		try{
			...
			pstmt = conn.prepareStatement("SELECT DISTINCT clsd.subscriberNumber, clsd.name,clsd.gender,clsd.contact_number,clsd.emailid,clsd.address,clsd.status FROM campus_library_subscriber_details clsd LEFT JOIN campus_library_location cll ON cll.library_loc_id = clsd.libraryid WHERE clsd.accyear_ID LIKE ?  AND cll.libraryid LIKE ? AND clsd.subscriberType ='others'");
			...
			while(rs.next()){
				...
				vo.setSubscriberno(rs.getString("subscriberNumber"));
				vo.setOthersName(rs.getString("name"));
				vo.setOthersGender(rs.getString("gender"));
				vo.setOthersContact(rs.getString("contact_number"));
				vo.setOthersMailId(rs.getString("emailid"));
				vo.setOthersAdress(rs.getString("address"));
				vo.setStatus(rs.getString("status"));
	...
	public LibraryStockEntryDetailsForm gotostockDetails(java.lang.String id, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public List<LibrarySubscribVO> getClassByLibraryLocation(java.lang.String locationid, UserLoggingsPojo custdetails) {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection conn = null;
	...
	public List<LibrarySubscribVO> getLibraryClassSection(String searchTerm, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
			...
			if(pojo.getSelect().equalsIgnoreCase("all")){
				...
				while(rs.next()){
					...
					else if(usertype.equalsIgnoreCase("others"))				
					{
						...
						{
							from.setSubscriberName(rs1.getString("name"));
							from.setDepartment(rs1.getString("contact_number"));
							from.setDesignation(rs1.getString("emailid"));
			...
			{	
              ...
              System.out.println("////////////////////"+pstmt);
				...
				while(rs.next()){
					...
					from.setLocname(rs.getString("library_location_name"));
					...
					else if(usertype.equalsIgnoreCase("others"))				
					{
						...
						while(rs1.next())
						{
							from.setSubname(rs1.getString("name"));
							from.setDepartment(rs1.getString("contact_number"));
							from.setDesigantion(rs1.getString("emailid"));
						}
					}
					ReservationList.add(from);
				}
				...
				pstmt.setString(3,pojo.getSectionId());
				 System.out.println("11111111111111111111"+pstmt);
				rs=pstmt.executeQuery();
				while(rs.next()){
					count++;
					LibrarySearchIssueDetailsVO from=new LibrarySearchIssueDetailsVO();
				...
				pstmt.setString(3,pojo.getDesignation());
				 System.out.println("222222222222222222"+pstmt);
				rs=pstmt.executeQuery();
				while(rs.next()){
					count++;
					LibrarySearchIssueDetailsVO from=new LibrarySearchIssueDetailsVO();
				...
				pstmt.setString(1,pojo.getLocationName());
				 System.out.println("333333333333333333333"+pstmt);
				rs=pstmt.executeQuery();
				while(rs.next()){
					count++;
					LibrarySearchIssueDetailsVO from=new LibrarySearchIssueDetailsVO();
					...
					from.setSubname(rs.getString("name"));
					from.setDepartment(rs.getString("contact_number"));
					from.setDesigantion(rs.getString("emailid"));
					from.setUsertype(rs.getString("subscriberType"));
					from.setLocname(rs.getString("library_location_name"));
					ReservationList.add(from);
				}
		...
		try {
			...
			if (pojo.getStatement().equalsIgnoreCase("issue")) 
			{
				if (pojo.getSelect().equalsIgnoreCase("all") &&!pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("student") &&!pojo.getSelect().equalsIgnoreCase("staff")) 
				{
					...
					while(rs.next()){
						...
						if(usertype.equalsIgnoreCase("teacher"))
						{
							...
							rs1=pstmt1.executeQuery();
							System.out.println("OVER_DUE_TEACHER -->>"+pstmt1);
							while(rs1.next())
							{
								from.setSubscriberName(rs1.getString("teacher"));
								from.setDepartment(rs1.getString("DEPT_NAME"));
						...
						else if(usertype.equalsIgnoreCase("student"))
						{
							...
							System.out.println("OVER_DUE_STUDENT -->>"+pstmt2);
							while(rs2.next())
							{
						...
						else if(usertype.equalsIgnoreCase("others"))				
						{
							...
							System.out.println("OVER_DUE_OTHERS -->>"+pstmt3);
							while(rs3.next())
							{
								from.setSubscriberName(rs3.getString("name"));
								from.setDepartment(rs3.getString("contact_number"));
								from.setDesignation(rs3.getString("emailid"));
							}
						}
						ReservationList.add(from);
					}
				...
				else if (pojo.getSelect().equalsIgnoreCase("Student") && !pojo.getSelect().equalsIgnoreCase("all") && !pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("staff")) 
				{
					...
					pstmt1.setString(2, pojo.getLibLoc());
					System.out.println(pstmt1);
					rs1=pstmt1.executeQuery();
					while(rs1.next()){
						count++;
						...
						from.setDepartment(rs1.getString("classdetails_name_var"));
						from.setDesignation(rs1.getString("classsection_name_var"));
						from.setLocationName(rs1.getString("library_location_name"));
						ReservationList.add(from);
					}
				}
				else if (pojo.getSelect().equalsIgnoreCase("staff")  && !pojo.getSelect().equalsIgnoreCase("all") && !pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("Student")) 
				{
					...
					pstmt3.setString(2, pojo.getLibLoc());
				...
				else if (pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("Student") && !pojo.getSelect().equalsIgnoreCase("staff")  && !pojo.getSelect().equalsIgnoreCase("all")) 
				{
					...
					pstmt5.setString(2, pojo.getLibLoc());
					...
					while(rs5.next()){
						...
						from.setSubscriberName(rs5.getString("name"));
						from.setDepartment(rs5.getString("contact_number"));
						from.setDesignation(rs5.getString("emailid"));
						from.setLocationName(rs5.getString("library_location_name"));
						ReservationList.add(from);
					}
				}
			}
			else if (pojo.getStatement().equalsIgnoreCase("return")) 
			{
				if (pojo.getSelect().equalsIgnoreCase("all") &&!pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("student") &&!pojo.getSelect().equalsIgnoreCase("staff")) 
				{
					...
					while(rs.next()){
						...
						from.setAuthor(rs.getString("author"));
						from.setBookTitle(rs.getString("Book_title"));
						from.setStudentId(rs.getString("subscriberId"));
						from.setStaffId(rs.getString("subscriberId"));
				...
				else if (pojo.getSelect().equalsIgnoreCase("Student") && !pojo.getSelect().equalsIgnoreCase("all") && !pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("staff")) 
				{
					...
					while(rs.next()){
						...
						from.setDepartment(rs.getString("classdetails_name_var"));
						from.setDesignation(rs.getString("classsection_name_var"));
						from.setLocationName(rs.getString("library_location_name"));
						ReservationList.add(from);
					}
				}
				else if (pojo.getSelect().equalsIgnoreCase("staff")  && !pojo.getSelect().equalsIgnoreCase("all") && !pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("Student")) 
				...
				else if (pojo.getSelect().equalsIgnoreCase("others") && !pojo.getSelect().equalsIgnoreCase("Student") && !pojo.getSelect().equalsIgnoreCase("staff")  && !pojo.getSelect().equalsIgnoreCase("all")) 
				{
					...
					while(rs.next()){
						...
						from.setFrom_date(HelperClass.convertDatabaseToUI(rs.getString("book_issued_date"))+"/"+HelperClass.convertDatabaseToUI(rs.getString("book_returned_date")));
						from.setSuscriberType(rs.getString("subscriberType"));
						from.setSubscriberName(rs.getString("name"));
						from.setDepartment(rs.getString("contact_number"));
						from.setDesignation(rs.getString("emailid"));
						from.setLocationName(rs.getString("library_location_name"));
						ReservationList.add(from);
					}
				}
	...
	public List<LibrarySubsciberDetailsPojo> IndividualSearchInIssueReturnStatement(LibrarySubsciberDetailsPojo pojo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			if (pojo.getStatement().equalsIgnoreCase("issue")) 
			{
				...
				pstmt.setString(1,pojo.getLocationName());
				pstmt.setString(2,"%"+pojo.getSearchTextVal()+"%");
				pstmt.setString(3, pojo.getLibLoc());
				...
				while(rs.next()){
					...
					else if(rs.getString("subscriberType").equalsIgnoreCase("others"))				
					{
						...
						while(rs3.next())
						{
							from.setSubscriberName(rs3.getString("subscriberNumber")+"-"+rs3.getString("name"));
	...
	public List<LibraryStockEntryVO> getBookIssueReturnDetailsByAccessionNo(LibraryStockEntryVO libVo, UserLoggingsPojo custdetails)
	{
		...
		try {
			...
			if (libVo.getStatement().equalsIgnoreCase("issue")) 
			{
				...
				pstmObj.setString(4, libVo.getLibLocId());
	...
	public List<LibraryStockEntryVO> getIssueReturnAccessionNo(LibraryStockEntryVO registrationVo, UserLoggingsPojo custdetails) {
		...
		try {
			...
			if(registrationVo.getStatement().equalsIgnoreCase("issue")){
				...
				pstmt.setString(2,registrationVo.getLibLocId());
				
				System.out.println("GET_ACCESSION_NUMBER -->>"+pstmt);
                ...
                System.out.println("GET_ACCESSION_NUMBER_BY_ISSUERETURN_RETURN -->>"+pstmt);
	...
	public List<LibraryStockEntryVO> getLibraryLocationBySchool(String id, UserLoggingsPojo custdetails) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
	...
	public ArrayList<LibraryItems> getLibItemsDetails(UserLoggingsPojo custdetails) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : getLibItemsDetails Starting");

		ArrayList<LibraryItems> libItems = new ArrayList<LibraryItems>();
		Connection conn = null;
		...
		try {
			conn = JDBCConnection.getSeparateConnection(custdetails);
			pstmt = conn.prepareStatement(LibrarySqlUtils.GET_LIBRARY_ITEM);

			rs = pstmt.executeQuery();
			while (rs.next()) {
				LibraryItems libvo = new LibraryItems();
				libvo.setId(rs.getString("id"));
				libvo.setItemtype(rs.getString("itemtype"));
				libvo.setName(rs.getString("name"));
				libvo.setDescription(rs.getString("description"));
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : getLibItemsDetails Ending");
		return libItems;
	}
	...
	public LibraryItems getSingleLibItemsDetails(String id, UserLoggingsPojo custdetails) {
		...
		try {
			...
			conn = JDBCConnection.getSeparateConnection(custdetails);
			pstmt = conn.prepareStatement(LibrarySqlUtils.GET_SINGLE_LIBRARY_ITEM);
			pstmt.setString(1, id);
	...
	public String InsertLibraryItem(LibraryItems obj, UserLoggingsPojo custdetails) {
		...
		try {
			conn = JDBCConnection.getSeparateConnection(custdetails);
			if(libraryItemDuplicateCheck(obj,conn)) {
				if(obj.getCraetedby() !=null) {
					transactionType="Insert";
					pstmt = conn.prepareStatement(LibrarySqlUtils.INSERT_LIBRARY_ITEM);
					pstmt.setString(1, obj.getName());
					pstmt.setString(2, obj.getName());
					pstmt.setString(3, obj.getDescription());
					pstmt.setString(4, obj.getStatus());
					pstmt.setString(5, obj.getCraetedby());

				}
				else {

					transactionType="Update";
					pstmt = conn.prepareStatement(LibrarySqlUtils.UPDATE_LIBRARY_ITEM);
					pstmt.setString(1, obj.getName());
					pstmt.setString(2, obj.getName());
					pstmt.setString(3, obj.getDescription());
					pstmt.setString(4, obj.getStatus());
					pstmt.setString(5, obj.getUpdateby());
			...
			if(count>0) {
				sts=transactionType;
				HelperClass.recordLog_Activity(obj.getLog_audit_session(),"Library","Library Item",transactionType,pstmt.toString(), custdetails);
			}
	...
	public boolean libraryItemDuplicateCheck(LibraryItems obj, Connection conn) {
		logger.setLevel(Level.DEBUG);
		...
		try {
			...
			pstmt = conn.prepareStatement(LibrarySqlUtils.CHECK_DUPLICATE_LIBRARY_ITEM);
			pstmt.setString(1, obj.getName());
			rs = pstmt.executeQuery();
			if(rs.next()) {
				if(obj.getId().equalsIgnoreCase(rs.getString("id"))) {
					if(obj.getName().equalsIgnoreCase(rs.getString("name"))) {
						sts=true;
					}
					else {
						sts=false;
	...
	public List<LibraryItems> getLibraryItemByJS(LibraryItems obj, UserLoggingsPojo custdetails) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : getLibraryItemByJS Starting");
		...
		try {
			conn = JDBCConnection.getSeparateConnection(custdetails);
			pstmt = conn.prepareStatement(LibrarySqlUtils.GET_LIBRARY_ITEMBY_JS);
			...
			while (rs.next()) {
				...
				libvo.setItemtype(rs.getString("itemtype"));
				libvo.setName(rs.getString("name"));
				libvo.setDescription("description");
				libvo.setStatus(rs.getString("status"));
				libItems.add(libvo);
			}
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : getLibraryItemByJS Ending");
		return libItems;
	}
	...
	public LibraryVO getCountSubscribers(UserLoggingsPojo userLoggingsVo, String accId, String currentLoc) {
		logger.setLevel(Level.DEBUG);

		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : getCountSubscribers Starting");

		ArrayList<LibraryItems> libItems = new ArrayList<LibraryItems>();
		Connection conn = null;

		PreparedStatement pstmt = null,pstmt1=null,pstmt2=null,pstmt3=null,pstmt4=null,pstmt5=null,pstmt7=null,
				pstmt8=null,pstmt9=null,pstmt10=null,pstmt11=null,pstmt12=null,pstmt13=null;

		ResultSet rs = null,rs1=null,rs2=null,rs3=null,rs4=null, rs5=null,rs6=null,rs7=null, rs8=null,rs9=null,
				rs10=null,rs11=null,rs12=null,rs13=null,rs14=null;

		LibraryVO vo = new LibraryVO();

		try {
			conn = JDBCConnection.getSeparateConnection(userLoggingsVo);
			pstmt = conn.prepareStatement("SELECT COUNT(s.`subscriberId`) FROM `campus_library_subscriber_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`libraryid` WHERE s.`subscriberType`='teacher' AND s.`status`='Active' AND s.`accyear_ID`=? AND l.`loc_id`=?");
			pstmt.setString(1, accId);
			pstmt.setString(2, currentLoc);
			pstmt.executeQuery();
			rs = pstmt.executeQuery();
			while(rs.next()) {
				vo.setTeacherCount(rs.getInt(1));
			}


			pstmt1 = conn.prepareStatement("SELECT COUNT(s.`subscriberId`) FROM `campus_library_subscriber_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`libraryid` WHERE s.`subscriberType`='student' AND s.`status`='Active' AND s.`accyear_ID`=? AND l.`loc_id`=?");
			pstmt1.setString(1, accId);
			pstmt1.setString(2, currentLoc);
			rs1=pstmt1.executeQuery();
			while(rs1.next()) {
				vo.setStudentCount(rs1.getInt(1));
			}
			pstmt2 = conn.prepareStatement("SELECT COUNT(s.`subscriberId`) FROM `campus_library_subscriber_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`libraryid` WHERE s.`subscriberType`='others' AND s.`status`='Active' AND s.`accyear_ID`=? AND l.`loc_id`=?");
			pstmt2.setString(1, accId);
			pstmt2.setString(2, currentLoc);
			pstmt2.executeQuery();
			rs2 = pstmt2.executeQuery();
			System.out.println(pstmt2);
			while(rs2.next()) {
				vo.setOthersCount(rs2.getInt(1));
			}

			pstmt3 = conn.prepareStatement("SELECT COUNT(s.`issued_id`) FROM `campus_library_book_issue_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`location_id` WHERE s.`status`='Issued' AND l.`loc_id`=?");
			pstmt3.setString(1, currentLoc);
			pstmt3.executeQuery();
			rs3 = pstmt3.executeQuery();
			System.out.println(pstmt3);
			while(rs3.next()) {
				vo.setIssueCount(rs3.getInt(1));
			}

			pstmt4 = conn.prepareStatement("SELECT COUNT(s.`return_id`) FROM `campus_library_book_return_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`location_id` WHERE s.`status`='Returned' AND l.`loc_id`=?");
			pstmt4.setString(1, currentLoc);
			pstmt4.executeQuery();
			rs4 = pstmt4.executeQuery();
			System.out.println(pstmt4);
			while(rs4.next()) {
				vo.setReturnCount(rs4.getInt(1));
			}

			pstmt5 = conn.prepareStatement("SELECT COUNT(s.`reservation_id`) FROM `campus_library_reservation_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`library_location` WHERE `accyear`=? AND l.`loc_id`=?");
			pstmt5.setString(1, accId);
			pstmt5.setString(2, currentLoc);
			pstmt5.executeQuery();
			rs5 = pstmt5.executeQuery();
			System.out.println(pstmt5);
			while(rs5.next()) {
				vo.setReservationCount(rs5.getInt(1));
			}

			pstmt7= conn.prepareStatement("SELECT COUNT(s.`issued_id`) FROM `campus_library_book_issue_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`location_id` WHERE `status`='Issued' AND l.`loc_id`=? AND `book_issued_date`=CURDATE();");
			pstmt7.setString(1, currentLoc);
			pstmt7.executeQuery();
			rs7 = pstmt7.executeQuery();
			System.out.println(pstmt7);
			while(rs7.next()) {
				vo.setTodayIssueCount(rs7.getInt(1));
			}

			pstmt8= conn.prepareStatement("SELECT COUNT(s.`return_id`) FROM `campus_library_book_return_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`location_id` WHERE s.`status`='Returned' AND l.`loc_id`=?  AND `book_returned_date`=CURDATE();");
			pstmt8.setString(1, currentLoc);
			pstmt8.executeQuery();
			rs8 = pstmt8.executeQuery();
			while(rs8.next()) {
				vo.setTodayReturnCount(rs8.getInt(1));
			}

			pstmt9= conn.prepareStatement("SELECT COUNT(s.`reservation_id`) FROM `campus_library_reservation_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`library_location` WHERE CURDATE() BETWEEN `from_date` AND `to_date` AND l.`loc_id`=?");
			pstmt9.setString(1, currentLoc);
			pstmt9.executeQuery();
			rs9 = pstmt9.executeQuery();
			while(rs9.next()) {
				vo.setTodayReservationCount(rs9.getInt(1));
			}
			//---- report dashboard.
			pstmt10= conn.prepareStatement("SELECT COUNT(s.`reservation_id`) FROM `campus_library_reservation_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`library_location` WHERE  l.`loc_id`=? AND s.`accyear`=?");
			pstmt10.setString(1, currentLoc);
			pstmt10.setString(2, accId);
			pstmt10.executeQuery();
			rs11 = pstmt10.executeQuery();
			while(rs11.next()) {
				vo.setReportReservations(rs11.getInt(1));
			}

			pstmt11= conn.prepareStatement("SELECT COUNT(s.`subscriberId`) FROM `campus_library_subscriber_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`libraryid` WHERE  l.`loc_id`=? AND s.`accyear_ID`=? AND s.`status`='Active'");
			pstmt11.setString(1, currentLoc);
			pstmt11.setString(2, accId);
			pstmt11.executeQuery();
			rs12 = pstmt11.executeQuery();
			while(rs12.next()) {
				vo.setReportSubscriber(rs12.getInt(1));
			}

			pstmt12= conn.prepareStatement("SELECT COUNT(s.`Entry_id`) FROM `campus_library_stock_entry` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`Library_location` WHERE  l.`loc_id`=? AND s.`accyearId`=?");
			pstmt12.setString(1, currentLoc);
			pstmt12.setString(2, accId);
			pstmt12.executeQuery();
			rs13= pstmt12.executeQuery();
			while(rs13.next()) {
				vo.setReportStock(rs13.getInt(1));
			}

			pstmt13= conn.prepareStatement("SELECT COUNT(s.`issued_id`) FROM `campus_library_book_issue_details` s LEFT JOIN `campus_library_location` l ON l.`library_loc_id`=s.`location_id` WHERE l.loc_id=? AND s.`to_date` > CURDATE();");
			pstmt13.setString(1, currentLoc);
			pstmt13.executeQuery();
			rs14= pstmt13.executeQuery();
			while(rs14.next()) {
				vo.setReportOverdue(rs14.getInt(1));
			}
			...
			try {
				...
				if (rs6 != null && (!rs6.isClosed())) {rs6.close();}
				if (rs7 != null && (!rs7.isClosed())) {rs7.close();}
				if (rs8 != null && (!rs8.isClosed())) {rs8.close();}
				if (rs9 != null && (!rs9.isClosed())) {rs9.close();}
				if (rs10!= null && (!rs10.isClosed())) {rs10.close();}
				if (rs11 != null && (!rs11.isClosed())) {rs11.close();}
				if (rs12 != null && (!rs12.isClosed())) {rs12.close();}
				if (rs13 != null && (!rs13.isClosed())) {rs13.close();}
				if (rs14 != null && (!rs14.isClosed())) {rs14.close();}
				if (pstmt != null && (!pstmt.isClosed())) {
					pstmt.close();
				}
				...
				pstmt3.close();pstmt4.close();pstmt5.close();pstmt7.close();pstmt8.close();pstmt9.close();
				pstmt10.close();pstmt11.close();pstmt12.close();pstmt13.close();
				if (conn != null && (!conn.isClosed())) {
					conn.close();
				}
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : getCountSubscribers Ending");
		return vo;

	}

	public String validateBillNo(LibraryStockEntryVO vo, UserLoggingsPojo custdetails) 
	{
		logger.setLevel(Level.DEBUG);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : validateBillNo Starting");
		...
		try {
			conn = JDBCConnection.getSeparateConnection(custdetails);
			pstmt = conn.prepareStatement("SELECT COUNT(*) FROM campus_library_stock_entry WHERE Bill_No=? and Library_location=? AND Entry_id!=?");
			pstmt.setString(1, vo.getBillNo());
			pstmt.setString(2, vo.getLibLocId());
			pstmt.setString(3, vo.getEntry_id());
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : validateBillNo Ending");
		return status;
	}

	public String validateISBNNo(LibraryStockEntryVO vo, UserLoggingsPojo custdetails) 
	{
		logger.setLevel(Level.DEBUG);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : validateISBNNo Starting");
		...
		try {
			conn = JDBCConnection.getSeparateConnection(custdetails);
			pstmt = conn.prepareStatement("SELECT COUNT(*) FROM campus_library_stock_entry WHERE ISBN_No=? and Library_location=? AND Entry_id!=?");
			pstmt.setString(1, vo.getiSBNNo());
			pstmt.setString(2, vo.getLibLocId());
			pstmt.setString(3, vo.getEntry_id());
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in LibraryDAOIMPL : validateISBNNo Ending");
		return status;
	}
