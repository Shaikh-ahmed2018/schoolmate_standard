...
public class TeacherAttendanceDaoImpl implements TeacherAttendanceDao {
	...
	public ArrayList<TeacherAttendanceStatusVo> getTeacherAttendanceByDate(
		...
		try {
			...
			preparedStatement = conn.prepareStatement(StaffAttendancePostingSqlUtil.GET_TEACHER_ATTENDANCE_BY_DATE);
	...
	public String updateTeacherAttendanceDetails(String teacherid[],
		...
		try {
			...
			preparedStatement.close();
			if (flag == true) {
				preparedStatement = conn.prepareStatement(StaffAttendancePostingSqlUtil.UPDATE_TEACHER_ATTENDANCE_DETAILS);
	...
	public String getTotalStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
	
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalStaffcount Starting");
		...
		try {
			...
			pst = conn
					.prepareStatement(StaffAttendancePostingSqlUtil.GET_ALL_TEACHER_COUNT);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalStaffcount Ending");
		return result;
	}

	public String getTotalPresentStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalPresentStaffcount Starting");
		...
		try {
			conn = JDBCConnection.getSeparateConnection(userLoggingsVo);
			pst = conn
					.prepareStatement(StaffAttendancePostingSqlUtil.GET_ALL_TEACHER_PRESENT_COUNT);
			
			
		
			
			pst.setDate(1,HelperClass.getCurrentSqlDate());
					rs = pst.executeQuery();
			//(pst);		
			while (rs.next()) {
				result = rs.getString("total");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalPresentStaffcount Ending");
		
		
		return result;
	}

	public String getTotalAbsentStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalAbsentStaffcount Starting");
		...
		try {
			conn = JDBCConnection.getSeparateConnection(userLoggingsVo);
			pst = conn
					.prepareStatement(StaffAttendancePostingSqlUtil.GET_ALL_TEACHER_ABSENT_COUNT);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalAbsentStaffcount Ending");
		
		
		return result;
	}

	public String getTotalLeaveStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalLeaveStaffcount Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in TeacherAttendanceDaoImpl: getTotalLeaveStaffcount Ending");
