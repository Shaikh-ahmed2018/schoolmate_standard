...
public class StaffEmployementDaoImpl implements StaffEmployementDao{
	...
	public StaffEmployementVo  getStaffEmployementEntry(String teachercode,String academic_year, UserLoggingsPojo userLoggingsVo) {
		...
		try {
				...
				while(rs_salary.next()){
					...
					empvo.setLocationId(rs_salary.getString("Loc_ID"));
					...
					empvo.setBranch(rs_salary.getString("BranchId"));
					...
					empvo.setTaxableTotalAmount(rs_salary.getDouble("curTDSCtc"));
					
					empvo.setPrevtaxableTotalAmount(rs_salary.getDouble("prevTDSCtc"));
					empvo.setPrevtdspt(rs_salary.getDouble("prevTDSPT"));
					empvo.setPrevtaxpayble(rs_salary.getDouble("prevTDSTaxPayble"));
					empvo.setPrevtaxableincome(rs_salary.getDouble("prevTDSTaxbleIncome"));
					empvo.setPrevtotalExemptions(rs_salary.getDouble("prevTDSExemption"));
					empvo.setPrevtotaltdsundervia(rs_salary.getDouble("prevTDSUnderChapterVIA"));
					empvo.setPrevTotalTDSIncomeFromOther(rs_salary.getDouble("prevTDSIncomeFromOther"));
					
					empvo.setTottaxableTotalAmount(rs_salary.getDouble("curTDSCtc"));
					empvo.setTottdspt(rs_salary.getDouble("curTDSPT"));
					empvo.setTottaxpayble(rs_salary.getDouble("curTDSTaxPayble"));
					empvo.setTottaxableincome(rs_salary.getDouble("curTDSTaxbleIncome"));
					empvo.setTottotalExemptions(rs_salary.getDouble("curTDSExemption"));
					empvo.setTottotaltdsundervia(rs_salary.getDouble("curTDSUnderChapterVIA"));
					empvo.setTotTotalTDSIncomeFromOther(rs_salary.getDouble("curTDSIncomeFromOther"));
					...
					empvo.setTaxablemonth(rs_salary.getString("taxablemonth"));
				}
	...
	@Override
	public String saveStaffSalaryDetails(StaffEmployementForm espojo,UserLoggingsPojo userLoggingsVo) {
		...
		int existCount=0;
		List<String> taxablemonth=new ArrayList<String>();
		if(espojo.getJanuary()!=null)
		taxablemonth.add(espojo.getJanuary());
		if(espojo.getFebruary()!=null)
		taxablemonth.add(espojo.getFebruary());
		if(espojo.getMarch()!=null)
		taxablemonth.add(espojo.getMarch());
		if(espojo.getApril()!=null)
		taxablemonth.add(espojo.getApril());
		if(espojo.getMay()!=null)
		taxablemonth.add(espojo.getMay());
		if(espojo.getJune()!=null)
		taxablemonth.add(espojo.getJune());
		if(espojo.getJuly()!=null)
		taxablemonth.add(espojo.getJuly());
		if(espojo.getAugust()!=null)
		taxablemonth.add(espojo.getAugust());
		if(espojo.getSeptember()!=null)
		taxablemonth.add(espojo.getSeptember());
		if(espojo.getOctober()!=null)
		taxablemonth.add(espojo.getOctober());
		if(espojo.getNovember()!=null)
		taxablemonth.add(espojo.getNovember());
		if(espojo.getDecember()!=null)
		taxablemonth.add(espojo.getDecember());
		espojo.setTaxablemonth(taxablemonth);
		
		System.out.println("taxablemomnth="+espojo.getTaxablemonth());
		try {
			conn = JDBCConnection.getSeparateConnection(userLoggingsVo);
			...
			if(existCount==0){
				...
				salarystatement.setDouble(42, espojo.getTaxableincomefromothers());
				
				salarystatement.setDouble(43, espojo.getPrevtdsctc());
				salarystatement.setDouble(44, espojo.getPrevstandarddedu());
				salarystatement.setDouble(45, espojo.getPrevtdsexmption());
				salarystatement.setDouble(46, espojo.getPrevtdspt());
				salarystatement.setDouble(47, espojo.getPrevtaxableincome());
				salarystatement.setDouble(48, espojo.getPrevtaxpayble());
				salarystatement.setDouble(49, espojo.getPrevtdsundervia());
				salarystatement.setDouble(50, espojo.getPrevtaxableincomefromothers());
				salarystatement.setDouble(51, espojo.getTottdsctc());
				salarystatement.setDouble(52, espojo.getTotstandarddedu());
				salarystatement.setDouble(53, espojo.getTottdsexmption());
				salarystatement.setDouble(54, espojo.getTottdspt());
				salarystatement.setDouble(55, espojo.getTottaxableincome());
				salarystatement.setDouble(56, espojo.getTottaxpayble());
				salarystatement.setDouble(57, espojo.getTottdsundervia());
				salarystatement.setDouble(58, espojo.getTottaxableincomefromothers());
				salarystatement.setString(59, espojo.getTaxablemonth().toString());
				System.out.println("insert pstmt :: "+salarystatement);

				count=salarystatement.executeUpdate();
				if(count >0){
					HelperClass.recordLog_Activity(espojo.getLog_audit_session(),"Staff","Insert","StaffRenumeration",salarystatement.toString(),espojo.getUserLoggingsvo());
					if ((espojo.getHemloyeeid() != null) && !(espojo.getHemloyeeid().equalsIgnoreCase("")) ) {
						uploadStatus = saveStaffTdsDetails(espojo,conn,userLoggingsVo);
						if(uploadStatus >0){
							conn.commit();
							status="true";	
						}else{
				...
				salarystatement.setDouble(41, espojo.getTaxableincomefromothers());
				
				salarystatement.setDouble(42, espojo.getPrevtdsctc());
				salarystatement.setDouble(43, espojo.getPrevstandarddedu());
				salarystatement.setDouble(44, espojo.getPrevtdsexmption());
				salarystatement.setDouble(45, espojo.getPrevtdspt());
				salarystatement.setDouble(46, espojo.getPrevtaxableincome());
				salarystatement.setDouble(47, espojo.getPrevtaxpayble());
				salarystatement.setDouble(48, espojo.getPrevtdsundervia());
				salarystatement.setDouble(49, espojo.getPrevtaxableincomefromothers());
				salarystatement.setDouble(50, espojo.getTottdsctc());
				salarystatement.setDouble(51, espojo.getTotstandarddedu());
				salarystatement.setDouble(52, espojo.getTottdsexmption());
				salarystatement.setDouble(53, espojo.getTottdspt());
				salarystatement.setDouble(54, espojo.getTottaxableincome());
				salarystatement.setDouble(55, espojo.getTottaxpayble());
				salarystatement.setDouble(56, espojo.getTottdsundervia());
				salarystatement.setDouble(57, espojo.getTottaxableincomefromothers());
				salarystatement.setString(58, espojo.getTaxablemonth().toString());
				salarystatement.setString(59, espojo.getHemloyeeid());
				...
				if(count >0){
					HelperClass.recordLog_Activity(espojo.getLog_audit_session(),"Staff","Update","StaffRenumeration",salarystatement.toString(),espojo.getUserLoggingsvo());
					if ((espojo.getHemloyeeid() != null) && !(espojo.getHemloyeeid().equalsIgnoreCase("")) ) {
						uploadStatus = updateStaffTdsDetails(espojo, conn,userLoggingsVo);
						conn.commit();
						status="true";
					}else {
						try {
	...
	private int saveStaffTdsDetails(StaffEmployementForm espojo, Connection conn,UserLoggingsPojo userLoggingsVo) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			if(status > 0) {
				HelperClass.recordLog_Activity(espojo.getLog_audit_session(),"Staff","IT Declaration","Insert",salarystatement.toString(),userLoggingsVo);
			}
			...
			try {
				...
				//DONT CLOSE CONNECTION HERE BCS CONNECTION IS USING SOME OTHER METHOD
			}catch (SQLException e) {
				logger.error(e.getMessage(), e);
				e.printStackTrace();
			}catch (Exception e) {
	...
	private int updateStaffTdsDetails(StaffEmployementForm espojo, Connection conn,UserLoggingsPojo userLoggingsVo) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			status=salarystatement.executeUpdate();
			if(status>0) {
				HelperClass.recordLog_Activity(espojo.getLog_audit_session(),"Staff","IT Declaration","Update",salarystatement.toString(),userLoggingsVo);
			}
	...
	public String saveStaffIncomeTaxTDSDeductionDetails(StaffEmployementForm staffForm) {
		...
		try {
			conn = JDBCConnection.getSeparateConnection(staffForm.getUserLoggingsvo());
			conn.setAutoCommit(false);
			...
			if(staffcount == 0){
				...
				count=salarystatement.executeUpdate();
				if(count >0){
					//HelperClass.recordLog_Activity(staffForm.getLog_audit_session(),"Staff","IT Declaration","Insert",salarystatement.toString());
				...
				count=salarystatement.executeUpdate();
				if(count >0){
					//HelperClass.recordLog_Activity(staffForm.getLog_audit_session(),"Staff","IT Declaration","Update",salarystatement.toString());
	...
	private int saveHouseRentDetails(StaffEmployementForm staffForm, Connection conn) {
		...
		try {
			...
			if(status>0) {
				//HelperClass.recordLog_Activity(staffForm.getLog_audit_session(),"Staff","IT Declaration","Insert",pstmt.toString());
			}
	...
	private int updateHouseRentDetails(StaffEmployementForm staffForm, Connection conn) {
		...
		try {
			...
			status=pstmt.executeUpdate();
             if(status>0) {
            	 //HelperClass.recordLog_Activity(staffForm.getLog_audit_session(),"Staff","IT Declaration","Update",pstmt.toString());
             }
	...
	public double getPTdetails(String location,String monthlyamount,UserLoggingsPojo userLoggingsVo) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StaffEmploymentDaoImpl : getPTdetails Starting");

		PreparedStatement pstmt = null;
		Connection con = null;
		ResultSet rs=null;
		double  profeesionaltax = 0;
		
		try {
			con = JDBCConnection.getSeparateConnection(userLoggingsVo);
			
			
			System.out.println("monthlyamount="+monthlyamount);
			pstmt = con.prepareStatement(StaffEmployementUtil.GET_PT_SALARY_WISE);
			pstmt.setString(1, location);
			pstmt.setDouble(2, Double.parseDouble(monthlyamount));
			System.out.println("pstmt "+pstmt);
			rs=pstmt.executeQuery();
           if(rs.next()) {
        	   profeesionaltax=rs.getDouble(1);
           }
           else {
        	   profeesionaltax=0.0;
           }
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StaffEmploymentDaoImpl : getPTdetails Ending");
		return profeesionaltax;
	}

	public double getCalculationMonth(String emloyeeid,String academicyaer,UserLoggingsPojo userLoggingsVo) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StaffEmploymentDaoImpl : getCalculationMonth Starting");

		PreparedStatement pstmt = null;
		Connection con = null;
		ResultSet rs=null;
		double  employeecurrenttaxablemonth = 0;
		
		try {
			con = JDBCConnection.getSeparateConnection(userLoggingsVo);
			
			
			pstmt = con.prepareStatement(StaffEmployementUtil.GET_TAXABLEMONTH);
			pstmt.setString(1, emloyeeid);
			pstmt.setString(2, academicyaer);
			System.out.println("pstmt "+pstmt);
			rs=pstmt.executeQuery();
           if(rs.next()) {
        	   employeecurrenttaxablemonth=(rs.getInt(1)+1);
           }
           else {
        	   employeecurrenttaxablemonth=0.0;
           }
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			e.printStackTrace();
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StaffEmploymentDaoImpl : getCalculationMonth Ending");
