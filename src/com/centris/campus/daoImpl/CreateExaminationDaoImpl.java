...
public class CreateExaminationDaoImpl {
	...
	public ArrayList<LstmsAccadamicYear> getAccadamicYearsDaoImpl(UserLoggingsPojo custdetails) {
	...
	public List getAllExamNames(CreateExaminationForm examform, UserLoggingsPojo custdetails) {
	...
	public int createExamination(LstmsExaminationPOJO exam) {
		...
		/*try {
			...
			//("examid is "+exam.getExamId());
			//("examid is "+exam.getExamName());
			//("examid is "+exam.getDescription());
			//("examid is "+ exam.getAccadamicyear());
			//("examid is "+exam.getExamdate());
			//("examid is "+exam.getEnddate());
			//("examid is "+exam.getCreateuser());
...
public ExaminationDetailsVo editExamination(ExaminationDetailsVo examvo) {
	...
	public int UpdateExamination(LstmsExaminationPOJO exam) {
		...
		//("getExamId"+exam.getExamId());
			try {
				
				conn = JDBCConnection.getSeparateConnection();
				pstmt = conn.prepareStatement(ExamSqlUtils.UPDATE_EXAM_DETAILS);
