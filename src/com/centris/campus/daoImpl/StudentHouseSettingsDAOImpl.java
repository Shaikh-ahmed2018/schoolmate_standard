...
public class StudentHouseSettingsDAOImpl implements StudentHouseSettingsDAO {
	...
	public String savehouseSettings(StudentHouseSettingsPOJO pojo,UserLoggingsPojo custdetails) {
		...
		try{
			...
			pstmt.setString(1,IDGenerator.getPrimaryKeyID("campus_house_settings",custdetails));
			...
			if(count > 0){
				HelperClass.recordLog_Activity(pojo.getLog_activity_session(),"Student","House Setting","Insert",pstmt.toString(),custdetails);
				status = "true";
			}else{
				status = "false";
			}
	...
	@Override
	public ArrayList<StudentHouseSettingsVO> gethouseSettings(String loc,String accyear,UserLoggingsPojo custdetails) {
	...
	public String edithouseSettings(StudentHouseSettingsPOJO pojo,UserLoggingsPojo custdetails) {
		...
		try{
			...
			count = pstmt.executeUpdate();
			if(count > 0){
				HelperClass.recordLog_Activity(pojo.getLog_activity_session(),"Student","House Setting","Update",pstmt.toString(),custdetails);
				status = "true";
			}else{
				status = "false";
			}
	...
	public String deletehouseSettings(StudentHouseSettingsPOJO pojo,UserLoggingsPojo custdetails) {
		...
		try{
			...
			//ln("GET_COUNT_FROM_campus_student_house -->>"+pstmt1);
			while(rs.next()){
				count = rs.getInt(1);
			} 
			rs.close();
			...
			pstmt1 = conn.prepareStatement("SELECT COUNT(*) FROM campus_student_classdetails WHERE student_house=? AND fms_acadamicyear_id_int=? AND locationId=?");
			pstmt1.setString(1,pojo.getHouseid());
			pstmt1.setString(2,pojo.getAccid());
			pstmt1.setString(3,pojo.getLocid());
			rs = pstmt1.executeQuery();
			//ln("GET_house_COUNT_FROM_campus_student_classdetails -->> "+pstmt1);
			while(rs.next()){
				count2 = rs.getInt(1);
			} 
			...
			if(count == 0 && count2 == 0){
				...
				pstmt2 = conn.prepareStatement(SQLUtilConstants.GET_COUNT_FROM_campus_student_classdetails);
				pstmt2.setString(1,pojo.getHouseid());
				pstmt2.setString(2,pojo.getAccid());
				pstmt2.setString(3,pojo.getLocid());
				...
				if(count == 0){
					...
					pstmt = conn.prepareStatement("UPDATE campus_house_settings SET STATUS=? WHERE house_id=? AND accyear_id =? AND loc_id =?");
					pstmt.setString(1,"deleted");
					pstmt.setString(2,pojo.getHouseid());
					pstmt.setString(3,pojo.getAccid());
					pstmt.setString(4,pojo.getLocid());
			...
			if(count1 == 1){
				HelperClass.recordLog_Activity(pojo.getLog_activity_session(),"Student","House Setting","Delete",pstmt.toString(),custdetails);
				status = "true";
			}else{
				status = "false";
			}
	...
	@Override
	public ArrayList<StudentHouseSettingsVO> getHouseSettingStudentWise(String locid, String classid,String classname,String accid,
	...
	public ArrayList<StudentHouseSettingsVO> generateHousing(StudentHouseSettingsPOJO pojo,UserLoggingsPojo userLoggingsVo) {
		...
		try{
			conn = JDBCConnection.getSeparateConnection(userLoggingsVo);
			pstmt = conn.prepareStatement("select count(*) from campus_house_settings where accyear_id=? and loc_id =? and status='active'");
			...
			//ln("classgrem"+classgrem);
			//ln("classbrem"+classbrem);
			
			PreparedStatement rempstmt = conn.prepareStatement("select count(*) from campus_house_settings where accyear_id=? and loc_id =? and status='active'");
			rempstmt.setString(1,pojo.getAccid());
			rempstmt.setString(2,pojo.getLocid());
			ResultSet remrs = rempstmt.executeQuery();
			while(remrs.next()){
			...
			PreparedStatement housepstmt = conn.prepareStatement("select house_id,housename from campus_house_settings where accyear_id = ? and loc_id = ? and status='active' order by housename");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : generateHousing : Ending");
		return list;
	}
	...
	public String savegenerateHouseDetails(StudentHouseSettingsPOJO pojo, String[] houseid,
		...
		try{
			...
			pstmt.setString(1,IDGenerator.getPrimaryKeyID("campus_generate_house",custdetails));
			pstmt.setString(2,pojo.getAccid());
			pstmt.setString(3,pojo.getLocid());
			...
			//ln("savegenerateHouseDetails  count="+count+"-->>"+pstmt);
			count = pstmt.executeUpdate();
			//ln("campus_generate_house  count="+count+"-->>"+pstmt);
			if(count >0){
				HelperClass.recordLog_Activity(log_audit_session,"Student","Generate House","Insert",pstmt.toString(),custdetails);
				for(int i=0;i<studid.length;i++){
					...
					//ln("campus_student_house  count1="+count1+"-->>"+pstmt1);
					if(count1 >0){
						HelperClass.recordLog_Activity(log_audit_session,"Student","Generate House","Insert",pstmt1.toString(),custdetails);
					}
				}
				for(int i=0;i<studid.length;i++){
					...
					//ln("campus_student_classdetails  count2="+count2+"-->>"+pstmt2);
					if(count2>0){
						//ln("count2 -->>"+count2);
						HelperClass.recordLog_Activity(log_audit_session,"Studetn","Generate House","Update",pstmt2.toString(),custdetails);
					}
					pstmt2.close();
				}
				status = "success";
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : savegenerateHouseDetails : Ending");
		return status;
	}
	...
	public String checkHousing(String accyear, String locid,UserLoggingsPojo custdetails) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : checkHousing : Ending");
		return status;
	}
	...
	public ArrayList<StudentHouseSettingsVO> displayHouseSettingStudentWise(StudentHouseSettingsPOJO pojo,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in displayHouseSettingStudentWise: displayHouseSettingStudentWise : Starting");
		...
		try{
			...
			//ln("GET_HOUSE_SETTING_STUDENT -->>"+pstmt);
			rs = pstmt.executeQuery();
			while(rs.next()){
				slno ++;
				StudentHouseSettingsVO obj = new StudentHouseSettingsVO();
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : displayHouseSettingStudentWise : Ending");
		return list;
	}
	...
	public ArrayList<StudentHouseSettingsVO> generateaddmiHousing(StudentHouseSettingsPOJO pojo,UserLoggingsPojo userLoggingsVo) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in StudentHouseSettingsDAOImpl: generateaddmiHousing : Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : generateaddmiHousing : Ending");
		return list;
	}
	...
	public ArrayList<StudentHouseSettingsVO> getHouseSettingAdminoWise(String locid, String classid, String classname,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in getHouseSettingAdminoWise: getHouseSettingAdminoWise : Starting");
		...
		try{
			...
			pstmt.setString(2,locid);
			pstmt.setString(3,classid);
			////ln("GET_STUDENT_DETAILS_ORDERBY_STUDENT_SECTION_AND_GENDER -->>"+pstmt);
			rs = pstmt.executeQuery();
			while(rs.next()){
				slno ++;
				StudentHouseSettingsVO obj = new StudentHouseSettingsVO();
	...
	public ArrayList<StudentHouseSettingsVO> byadminodescHousing(StudentHouseSettingsPOJO pojo,UserLoggingsPojo userLoggingsVo) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : byadminodescHousing : Ending");
		return list;
	}
	...
	public ArrayList<StudentHouseSettingsVO> getHouseSettingAdminodescWise(String locid, String classid,
		...
		try{
			...
			pstmt.setString(2,locid);
			pstmt.setString(3,classid);
			////ln("GET_STUDENT_DETAILS_BY_ADMINNO_WISE -->>"+pstmt);
			rs = pstmt.executeQuery();
			while(rs.next()){
				slno ++;
				StudentHouseSettingsVO obj = new StudentHouseSettingsVO();
	...
	public ArrayList<StudentHouseSettingsVO> byadminoevenHousing(StudentHouseSettingsPOJO pojo,UserLoggingsPojo userLoggingsVo) {
		...
		try{
			...
			while(stusecrs.next()){
					...
					/*secstupstmt.setString(1,stusecrs.getString("classsection_id_int"));*/
					secstupstmt.setString(1,pojo.getAccid());
					secstupstmt.setString(2,pojo.getLocid());
					secstupstmt.setString(3,pojo.getClassid());
					//ln("secstupstmt"+secstupstmt);
					ResultSet secstupstmtrs = secstupstmt.executeQuery();
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : byadminoevenHousing : Ending");
		return list;
	}
	...
	public ArrayList<StudentHouseSettingsVO> getHouseSettingAdminoevenWise(String locid, String classid,
		...
		try{
			...
			value="GET_STUDENT_DETAIL_ORDERBY_EVEN_ADMISSIONNO";
				...
				value="GET_STUDENT_DETAIL_ORDERBY_ODD_ADMISSIONNO";
			}
	...
	public ArrayList<StudentHouseSettingsVO> byadminooddHousing(StudentHouseSettingsPOJO pojo,UserLoggingsPojo userLoggingsVo) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in StudentHouseSettingsDAOImpl: byadminooddHousing : Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : byadminooddHousing : Ending");
		return list;
	}
	...
	public ArrayList<StudentHouseSettingsVO> bystudentdescHousing(StudentHouseSettingsPOJO pojo,UserLoggingsPojo userLoggingsVo) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in StudentHouseSettingsDAOImpl: bystudentdescHousing : Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : bystudentdescHousing : Ending");
		return list;
	}
	...
	public String checkselection(String accyear, String locid,UserLoggingsPojo custdetails) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : checkselection : Ending");
		return result;
	}
	...
	public ArrayList<StudentHouseSettingsVO> displayHouseSettingAdminoWise(StudentHouseSettingsPOJO pojo,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in displayHouseSettingAdminoWise: displayHouseSettingAdminoWise : Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : displayHouseSettingAdminoWise : Ending");
		return list;
	}
	...
	public ArrayList<StudentHouseSettingsVO> displayHouseSettingAdminoEven(StudentHouseSettingsPOJO pojo,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())+ " Control in displayHouseSettingAdminoEven: displayHouseSettingAdminoEven : Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : displayHouseSettingAdminoEven : Ending");
		return list;
	}
	...
	public String regenerateHousedetails(String accyear, String locid, String genhouid,UserLoggingsPojo userLoggingsVo) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentHouseSettingsDAOImpl : regenerateHousedetails : Ending");
		return result;
	}
