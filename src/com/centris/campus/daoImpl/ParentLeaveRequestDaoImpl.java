...
public class ParentLeaveRequestDaoImpl implements ParentLeaveRequestDao {
	...
	private static final Logger logger = Logger.getLogger(ParentLeaveRequestDaoImpl.class);
	...
	public ArrayList<RemainderMasterVO> getRemainderlistDao(UserLoggingsPojo custdetails) {
