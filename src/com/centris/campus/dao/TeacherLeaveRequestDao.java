...
public interface TeacherLeaveRequestDao {
	...
	ArrayList<TimeTableVo> getTeacherTimetableListDao(String userid,UserLoggingsPojo userLoggingsVo);

	String leaveRequestEntryDao(LeaveRequestVo leavevo, UserLoggingsPojo custdetails);

	String updateleaveRequestEntryDao(LeaveRequestVo leavevo, UserLoggingsPojo custdetails);
