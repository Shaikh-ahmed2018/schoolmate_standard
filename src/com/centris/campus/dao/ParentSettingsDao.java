...
public interface ParentSettingsDao {
	...
	ArrayList<ParentFeedbackVo> getFeedBackDetailsDao(ParentFeedbackVo fbvo, UserLoggingsPojo custdetails);
	...
	String getsubjectfilepathDao(String subid, UserLoggingsPojo custdetails);
	...
	String deleteRequestLeaveDao(String[] sno, String userid, String academic_year, LeaveRequestVo leavevo);

	ArrayList<TimeTableVo> getStudentTimetableDao(String studentid, UserLoggingsPojo custdetails);
