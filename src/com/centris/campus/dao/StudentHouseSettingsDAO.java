...
public interface StudentHouseSettingsDAO {
	...
	int gettotalstudentcount(String accyear, String locid, UserLoggingsPojo custdetails);

	int gettotalallostudent(String accyear, String locid, UserLoggingsPojo custdetails);
