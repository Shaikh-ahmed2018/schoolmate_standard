...
public class SendMail {
	...
	String FROM_ADDRESS = "donotreply@cerpsoft.in";
	String SENDER_PASSWORD = "Donotreply@123";
	public static String senderName = "eCampusPro"; 
	public static String hostName = "mail.cerpsoft.in";    
	...
	public synchronized String sendMail(String toAddress,InternetAddress[] ccList, String subject, String Bodymess)
		...
		String senderName = JPropertyReader.getProperty("MAIL.SENDER.NAME");
		...
		try {
			...
			message.setFrom(new InternetAddress(senderName + "<" + FROM_ADDRESS	+ ">"));
