...
public class AuthuFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		System.out
				.println("----------------------------------------------------------------------");
		if (wrappedRequest.getRequestURI().contains("/schoolmate/login.html")
				|| wrappedRequest.getRequestURI().contains(
						"/schoolmate/forgotPassword.html")) {
		...
		//parent requires appointment
				...
				"/schoolmate/parentrequiresappointment.html")) {
		...
		//New Registration Of Users
			...
			try {
				...
				"/schoolmate/studentRegistration.html")) {
			...
			try {
				...
				"/schoolmate/newregistration.html")) {
			...
			try {
				...
				pw.println("<html><head><script language='javascript'>"
						...
						+ "<form action='/schoolmate/' method='post' accept-charset='utf-8'><input type='submit' value='OK'/></form>"
						+ "</center></body></html>");
			}
		}
		if (problem != null) {
