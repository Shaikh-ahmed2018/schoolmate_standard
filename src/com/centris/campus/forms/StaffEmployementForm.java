...
public class StaffEmployementForm extends ActionForm {
	...
	private double prevtdsexmption;
	private double tottdsexmption;
	private double prevtdsundervia;
	private double tottdsundervia;
	private double taxableincomefromothers;
	private double prevtaxableincomefromothers;
	private double tottaxableincomefromothers;
	private UserLoggingsPojo userLoggingsvo;
	private List<String> taxablemonth;
	...
	public List<String> getTaxablemonth() {
		return taxablemonth;
	}
	public void setTaxablemonth(List<String> taxablemonth) {
	...
	public UserLoggingsPojo getUserLoggingsvo() {
		return userLoggingsvo;
	}
	public void setUserLoggingsvo(UserLoggingsPojo userLoggingsvo) {
		this.userLoggingsvo = userLoggingsvo;
	}
	public double getPrevtdsundervia() {
		return prevtdsundervia;
	}
	public double getTaxableincomefromothers() {
		return taxableincomefromothers;
	}
	public void setTaxableincomefromothers(double taxableincomefromothers) {
		this.taxableincomefromothers = taxableincomefromothers;
	}
	public double getPrevtaxableincomefromothers() {
		return prevtaxableincomefromothers;
	}
	public void setPrevtaxableincomefromothers(double prevtaxableincomefromothers) {
		this.prevtaxableincomefromothers = prevtaxableincomefromothers;
	}
	public double getTottaxableincomefromothers() {
		return tottaxableincomefromothers;
	}
	public void setTottaxableincomefromothers(double tottaxableincomefromothers) {
		this.tottaxableincomefromothers = tottaxableincomefromothers;
	}
	public void setPrevtdsundervia(double prevtdsundervia) {
		this.prevtdsundervia = prevtdsundervia;
	}
	public double getTottdsundervia() {
		return tottdsundervia;
	}
	public void setTottdsundervia(double tottdsundervia) {
		this.tottdsundervia = tottdsundervia;
	}
	public double getPrevtdsexmption() {
		return prevtdsexmption;
	}
	public void setPrevtdsexmption(double prevtdsexmption) {
		this.prevtdsexmption = prevtdsexmption;
	}
	public double getTottdsexmption() {
		return tottdsexmption;
	}
	public void setTottdsexmption(double tottdsexmption) {
		this.tottdsexmption = tottdsexmption;
	}
