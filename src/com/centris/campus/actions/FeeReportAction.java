...
public class FeeReportAction extends DispatchAction{
	...
	public ActionForward feeReportMainPage(ActionMapping mapping, ActionForm form,
		 ...
		 logger.setLevel(Level.DEBUG);
			...
			logger.info(JDate.getTimeString(new Date())
					+ " Control in FeeReportAction: feeReportMainPage Starting");
			...
			logger.info(JDate.getTimeString(new Date())
					+ " Control in FeeReportAction : feeReportMainPage Ending");
	...
	public ActionForward AccYearwiseDate(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in FeeReportAction : AccYearwiseDate Starting");
		...
		request.setAttribute(MessageConstants.MODULE_NAME,
			...
			obj.put("enddate", HelperClass.getForDateofAcademicYear(accyearid,custdetails));
			obj.put("startdate", HelperClass.getPastDateofAcademicYear(accyearid,custdetails));
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.END_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in FeeReportAction : AccYearwiseDate Ending");
	...
	public ActionForward getFeeReport(ActionMapping mapping, ActionForm form, 
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in FeeReportAction : getFeeReport Starting");
			...
			//("academic year id action================ "+list.get(0).getAccyear());
			//("academic year id action ================ "+list.get(0).getClassname());
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.END_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in FeeReportAction : getFeeReport Ending");
	...
	public ActionForward FeeExcelReport(ActionMapping mapping,ActionForm form, HttpServletRequest request,HttpServletResponse response) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in FeeReportAction : FeeExcelReport Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in FeeReportAction : FeeExcelReport Ending");
	...
	public ActionForward FeePDFReport(ActionMapping mapping,
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.START_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in FeeReportAction : FeePDFReport  Starting");
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.END_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in FeeReportAction : FeePDFReport  Ending");
			return null;
		}
