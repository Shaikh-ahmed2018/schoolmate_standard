...
public class StudentPramotionAction extends DispatchAction {
	...
	public ActionForward getAcadamicYear(ActionMapping mapping,
		...
		try {
			...
			yeardetailslist = new StudentPramotionBD().getAcadamicYear(pojo);
	...
	public ActionForward searchStudent(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			studentlist = new StudentPramotionBD().getStudentData(acadamicYear,section,userLoggingsVo);
			/*System.out
					.println("studentlist::::::::::::::::::::::::::::::::::::::: "
							+ studentlist.size());*/
			JSONObject jsonobject = new JSONObject();
						...
						for (int l = k; l <= k; l++) {
							for (int m = l; m <= l; m++) {
								for (int n = m; n <= m; n++) {
									...
									studentPramotionPOJO.setCreateuser(createUser);
	...
	public ActionForward downloadStudentDetailsXLS(ActionMapping mapping,
		...
		try {
			...
			.getpromotionslist(userLoggingsVo);
	...
	public ActionForward studentPromotionList(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentPramotionAction : studentPromotionList Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentPramotionAction : studentPromotionList Ending");
