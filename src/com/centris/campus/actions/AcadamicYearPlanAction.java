...
public class AcadamicYearPlanAction extends DispatchAction{
	...
	public synchronized ActionForward getAcadamicYearPlanEntry(ActionMapping mapping,
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : getAcadamicYearPlanEntry Starting");
		try {
			
			UserLoggingsPojo dbdetails = (UserLoggingsPojo) request.getSession(false).getAttribute("token_information");
			
			String title = "Add New Activities Plan";
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : getAcadamicYearPlanEntry Ending");
	...
	public synchronized ActionForward insertAcadamicYearPlan(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : insertAcadamicYearPlan Starting");
		//ln("Inside Action Loop");
		String path = null;
		...
		try {
			...
			acadamicYearPlanPOJO.setCustid(userLoggingsVo);
			if(acadamicYearPlanForm.getHeventId().length()!=0){
				...
				acadamicYearPlanPOJO.setLog_audit_session(log_audit_session);
				...
				acadamicYearPlanPOJO.setVenue(acadamicYearPlanForm.getVenue());
				acadamicYearPlanPOJO.setLocationId(acadamicYearPlanForm.getLocationId());
				
				
				//ln("Going To UPDATE OPERATION");
				...
				String planId= IDGenerator.getPrimaryKeyID("campus_accyearplan",acadamicYearPlanPOJO.getCustid());
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : insertAcadamicYearPlan Ending");
	...
	public synchronized ActionForward editAcadamicYearPlan(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : editAcadamicYearPlan Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : editAcadamicYearPlan Ending");
	...
	public synchronized ActionForward deleteAcadamicYearPlan(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : deleteAcadamicYearPlan Starting");

		try {
			
			String event_code[] = request.getParameter("event_list").split(",");
			
			//ln("event_code::::"+event_code.length);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : deleteAcadamicYearPlan Ending");
	...
	public synchronized ActionForward validateAcadamicYearPlan(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : validateAcadamicYearPlan Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : validateAcadamicYearPlan Ending");
	...
	public synchronized ActionForward validateAcadamicYearPlanUpdate(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : validateAcadamicYearPlanUpdate Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : validateAcadamicYearPlanUpdate Ending");
    ...
    public synchronized ActionForward download(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : download Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : download Ending");
    ...
    public ActionForward AcadamicYearPlanXLS(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : AcadamicYearPlanXLS  Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in AcadamicYearPlanAction : AcadamicYearPlanXLS   Ending");
				return null;
	...
	public ActionForward AcadamicYearPlanPDF(ActionMapping mapping,
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.START_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in AcadamicYearPlanAction : AcadamicYearPlanPDF  Starting");
			...
			try {
				...
				if (searchTerm != null) {
					...
					//ln("ACADEMICYEAR:::"+request.getSession(false)
							.getAttribute("current_academicYear").toString());
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.END_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in AcadamicYearPlanAction : AcadamicYearPlanPDF  Ending");
			return null;
	...
	public ActionForward getAcadamicYearPlanFilePath(ActionMapping mapping,
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.START_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in AcadamicYearPlanAction : getAcadamicYearPlanFilePath  Starting");
			...
			JLogger.log(0, JDate.getTimeString(new Date())
					+ MessageConstants.END_POINT);
			logger.info(JDate.getTimeString(new Date())
					+ " Control in AcadamicYearPlanAction : getAcadamicYearPlanFilePath  Ending");
