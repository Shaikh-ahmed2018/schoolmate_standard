...
public class StudentTransferCertificateReportAction extends DispatchAction{
	...
	public ActionForward studentTransferCertifivateReportAction(ActionMapping mapping, ActionForm form,
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentTransferCertificateReportAction : studentTransferCertifivateReportAction Starting");
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentTransferCertificateReportAction : studentTransferCertifivateReportAction Ending");
	...
	public ActionForward getSectionList(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			List<SectionPojo> seclist=new StudentTransferCertifivateReportBD().getSectionList(classname,location,userLoggingsVo);
