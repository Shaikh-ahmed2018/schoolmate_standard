...
public class StaffPayrollAction extends DispatchAction {
	...
	public ActionForward getPayrolEntry(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			ArrayList<PayRollVo> payroll_list = new StaffPayrollBD().getFlatpayRollProcess(year, month, userId,userLoggingsVo);
	...
	public ActionForward downloadpayrolllistingXLS(ActionMapping mapping,
		...
		try {
			...
			String month = null;
			String year = null;
			ArrayList<StaffPayrollListVo> list = new StaffPayrollBD().getPayrollList(year, month,userLoggingsVo);
	...
	public ActionForward downloadpayrolllistingPDF(ActionMapping mapping,
		...
		try {
			...
			String month = null;
			String year = null;
			ArrayList<StaffPayrollListVo> Details = new StaffPayrollBD().getPayrollList(year, month,userLoggingsVo);
