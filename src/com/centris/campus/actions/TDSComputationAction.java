	...
	public ActionForward AddTdsComputationDetails(ActionMapping mapping,
		...
		try {
			...
			if (academic_year == null || academic_year == "" || academic_year.equalsIgnoreCase("")) {
				System.out.println("HelperClass.getCurrentYearID()"	+ HelperClass.getCurrentYearID(userLoggingsVo));
			...
			list = new TDSComputationBD().getEmployeeDetails(User,currentUserId,academic_year,userLoggingsVo);
