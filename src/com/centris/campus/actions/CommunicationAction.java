...
public class CommunicationAction extends DispatchAction {
	...
	public ActionForward sendRemarkAction(ActionMapping mapping,
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in CommunicationAction : sendRemarkAction Starting");
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in CommunicationAction :sendRemarkAction Ending");
	...
	public ActionForward createMeetingAction(ActionMapping mapping,
		...
		try {
			...
			List<LstmsUpcomingMeetingVO> meetinglist =new CommunicationSettingsBD().getMeetingListDetails(custdetails);
...
try {
	...
	try {
		...
		if(hremarksid != "" && hfromdateid != "" && htodateid != ""){
			 ...
			 remarkslist = new CommunicationSettingsBD().searchRemarkDetails(remrakvo,userLoggingsVo);
			
		}
		else{
			
			remarkslist = new CommunicationSettingsBD().getRemarksListDetails(userLoggingsVo);
	...
	public ActionForward meetingDownloadXLS(ActionMapping mapping,
		...
		try {
			...
			if(hmeetingid != "" && hfromdateid != "" && htodateid != ""){
				 ...
				 meetinglist = new CommunicationSettingsBD().searchMeetingDetails(meetingvo,userLoggingsVo);
				
			}
			else{
 
				 meetinglist = new CommunicationSettingsBD().getMeetingListDetails(userLoggingsVo);
	...
	public ActionForward bdayWishDownloadXLS(ActionMapping mapping,
		...
		try {
	    	...
	    	if(hbdayid !="" && hfromdateid !="" && htodateid !=""){
				...
				bdaylist = new CommunicationSettingsBD().searchBdayDetails(bdayvo,userLoggingsVo);
				
			}
			
			else{
				
				 bdaylist = new CommunicationSettingsBD().getBdayListDetails(userLoggingsVo);
