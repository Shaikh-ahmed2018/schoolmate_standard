...
public class SendBirthdayWishesSMS {
	...
	public void SendBday() throws Exception {
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control in SendBirthdayWishesSMS : SendBday  Starting");
			...
			logger.info(JDate.getTimeString(new Date())
					+ " Control in SendBirthdayWishesSMS :SendBday Ending");
	...
	public synchronized String sendSMS(String phoneNo, String content) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in SendBirthdayWishesSMS : sendSMS  Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in SendBirthdayWishesSMS :sendSMS Ending");
		return urlResponse;
	}
