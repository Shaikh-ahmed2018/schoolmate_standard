...
public class ElectionAction extends DispatchAction{
	...
	public ActionForward UpdateGroupDetails(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			ArrayList<ReportMenuVo> locationList = new ReportsMenuBD().getlocationList(userLoggingsVo);//for dropdown of school names
			request.setAttribute("locationList", locationList);
	...
	public ActionForward updateElectionGroup(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			//("acchhhh====="+acch);
			//("grphidden====="+grph);
			//("school hidden==========="+schoolHiddenval.length);
...
try{
	...
	//("accheckkkkkkkkkkkkkkkGtrouppppppppppppp"+academicYear);
	//("accheckkkkkkkkkkkkkkk"+groupName);
	//("accheckkkkkkkkkkkkkkkGtrouppppppppppppp"+electionTitle);
...
public ActionForward saveApproval(ActionMapping mapping, ActionForm form,
	...
	try {
		...
		//("admissionId "+admissionId.length);
		
		ElectionPojo pojo = new ElectionPojo();

		pojo.setAdmissionNoArray(admissionId);

		//("pojolength "+pojo.getAdmissionNoArray().length);
...
try{
	...
	public ActionForward MachicneActivation(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			object.setCentralSystemIp(localIp);
	...
	public ActionForward voteCount(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			String status=new ElectionDaoImpl().voteCount(localIp,admissionNo,count);
	...
	public ActionForward getCategoryList(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			String group =request.getParameter("group");
			String titleID =request.getParameter("titleID");
			categoryList=new ElectionDaoImpl().getCategoryList(classId,accyear,group,titleID);
