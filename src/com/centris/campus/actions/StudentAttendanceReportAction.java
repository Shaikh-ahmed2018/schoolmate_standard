...
public class StudentAttendanceReportAction extends DispatchAction{
	...
	public ActionForward studentAttendanceReport(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			List<StreamDetailsVO> streamvo =new CommunicationSettingsBD().getStreamListDetails(custdetails);
	...
	public ActionForward getAllStudentName(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			String classVal = request.getParameter("classid").trim();
			String sectionVal = request.getParameter("sectionid").trim();
			String locationid = request.getParameter("locationid").trim();
			
		List<ParentVO> parentVOList = new StudentAttendanceBD().getAllStudent(classVal,sectionVal,locationid,custdetails);
	...
	public ActionForward studentAttendanceExcelReport(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			stuvo.setCustid(custdetails.getCustId());
			
			/*
			ArrayList<StudentAttendanceReportVo> MasterList = new StudentAttendanceBD().getStudentAttendanceReportBD(vo);
*/
			ArrayList<StudentAttendanceReportVo> MasterList = new StudentAttendanceBD().getStudentAttendanceListReportBD(stuvo,custdetails);	
...
*/
	...
	public ActionForward getStudentAttendanceAction(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			stuvo.setCustid(userLoggingsVo.getCustId());
		 ...
		 request.setAttribute("accyearitem", selectedItems);
		         ...
		         StreamDetailsVO streamitem = new StudentAttendanceBD().getStreamNameBD(stream,userLoggingsVo);
				 List<StreamDetailsVO> streamvo =new CommunicationSettingsBD().getStreamListDetails(userLoggingsVo);
				 request.setAttribute("streamlist", streamvo);
			     request.setAttribute("streamitem", streamitem);
			
			
			     String classname = stuform.getClassname();
			     ClassPojo classitem = new StudentAttendanceBD().getClassNameBD(classname,userLoggingsVo);
			     request.setAttribute("classitem", classitem);
			     
			     
			     String sectionname = stuform.getSectionname();
			     SectionPojo sectionitem = new StudentAttendanceBD().getSectionNameBD(sectionname,userLoggingsVo);
			     ...
			     ParentVO studentitem = new StudentAttendanceBD().getStudentNameBD(student,userLoggingsVo);
			...
			ArrayList<StudentAttendanceReportVo> MasterList = new StudentAttendanceBD().getStudentAttendanceListReportBD(stuvo,userLoggingsVo);
