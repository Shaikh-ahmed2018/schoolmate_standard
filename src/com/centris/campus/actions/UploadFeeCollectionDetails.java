...
public class UploadFeeCollectionDetails extends DispatchAction{
	...
	public ActionForward downloadfileformat(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
		...
		try{
			  ...
			  String filePath = request.getRealPath("/") +"FIles/FeeCollectionFileUpload/FeeCollectionForm.xls"; 
			  ...
			  response.addHeader("content-disposition", "attachment; filename="+"FeeCollectionForm.xls");
	...
	public ActionForward insertFeeXSL(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
		...
		try{
			...
			if (file != null) {
				...
				Map<String, Object> studentMap = new FeeExcelUploadUtil().getExcelData(fileURL,file,extension);
				...
				classXLSList = classXSLBD.insertStudentXSL((List<ClassFeeSetupPojo>) studentMap.get("List"),username,demo,log_audit_session,userLoggingsVo,branchName);
	...
	public ActionForward insertTransportFeeXSL(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
		...
		try{
			...
			if (file != null) {
				...
				Set<ClassFeeSetupVo> classXLSList = new HashSet<ClassFeeSetupVo>();
				String demo = (String) studentMap.get("Error");
				classXLSList = classXSLBD.insertTransportStudentXSL((List<ClassFeeSetupPojo>) studentMap.get("List"),username,demo,log_audit_session,userLoggingsVo);
