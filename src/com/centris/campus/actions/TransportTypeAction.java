	...
	public synchronized ActionForward downloadTransportTypeXLS(ActionMapping mapping,
		...
		try {
			...
			if (searchTerm != null) {
				...
				transporttypelist = new TransportTypeBD().getSearchDetails(transportTypePOJO,custdetails);
				request.setAttribute("searchtransporttype", searchTerm);

			} else {

				transporttypelist = new TransportTypeBD().getAllTransportypeDetails(custdetails);
			}
