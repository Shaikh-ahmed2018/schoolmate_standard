...
public class EventsAction extends DispatchAction{
	...
	try{
		...
		request.setAttribute("AccYearList", HelperClass.getAllAcademicYear(dbdetails));
		request.setAttribute("locationList", HelperClass.getAllLocation(dbdetails));
...
public ActionForward VolunteerReg(ActionMapping mapping, ActionForm from, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		try{
			...
			request.setAttribute("AccYearList", HelperClass.getAllAcademicYear(custdetails));
...
public ActionForward deleteEventStudReg(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		...
		String id=request.getParameter("id");
		String data =new eventBD().deleteEventStudReg(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward deleteEventRegistration(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String id=request.getParameter("id");
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String data =new eventBD().deleteEventRegistration(id,log_audit_session);
		//(data);
		JSONObject obj =new JSONObject();
		obj.put("status",data);
		response.getWriter().print(obj);
...
public ActionForward deleteCategory(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String id=request.getParameter("id");
		String data =new eventBD().deleteCategory(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward getstageList(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String id = request.getParameter("id");
		//("iddddddddddddddddddddddddddddddddddddddddddddd"+id);
...
public ActionForward deleteStage(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String id=request.getParameter("id");
		String data =new eventBD().deleteStage(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward deleteCriteria(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		...
		String id=request.getParameter("id");
		//("id to delete>>>>>"+id);
		String data =new eventBD().deleteCriteria(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward validateCriteria(ActionMapping mapping,
	...
	logger.info(JDate.getTimeString(new Date())
           ...
           //("whether it is coming inside the event action:");
	try {
		//("<<<<<<<<<<>>>>>>>>>>>---------Inside the Action ----");
		String eventName = request.getParameter("eventName");
...
public ActionForward saveGreenRoom(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception{
	...
	try{
		...
		//("eventid hidden"+greenRoomIdHidden);
...
public ActionForward deleteGreenRoom(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String id=request.getParameter("id");
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String data =new eventBD().deleteGreenRoom(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward deleteProgram(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String id=request.getParameter("id");
		String data =new eventBD().deleteProgram(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward deletePrize(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String id=request.getParameter("id");
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String data =new eventBD().deletePrize(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward deleteProgramScheduling(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String id=request.getParameter("id");
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String data =new eventBD().deleteProgramScheduling(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward getEventIdList(ActionMapping mapping, ActionForm form,
	...
	try {
		...
		//("vvvvvvvvv"+eventList+" "+eventcategory+" "+eventprogramname);
...
public ActionForward newEventIdCardPrintTemplate(ActionMapping mapping, ActionForm form,
	...
	String evntcatname=request.getParameter("evntcatname");
	String evntproname=request.getParameter("evntproname");
	
	//("checkingggg="+evntname+evntcatname+evntproname);
	...
	try {
		...
		list = new EventsDaoImpl().newEventIdCardPrint(filterpojo);
		//("eventList"+eventList);
		request.setAttribute("event", list);
		
		request.setAttribute("eventname", list.get(0).getEventName());
		request.setAttribute("categoryname", list.get(0).getCategory());
		request.setAttribute("programname",list.get(0).getProgrammeName()) ;
		/*request.setAttribute("templateClass",evntname+evntcatname+evntproname);*/
		request.setAttribute("templateClass",eventList+eventcategory+eventprogramname);
		
		//(list.get(0).getEventName());
		//(list.get(0).getCategory());
		//(list.get(0).getProgrammeName());
...
public ActionForward getEventIdPrintList(ActionMapping mapping, ActionForm form,
	...
	logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			if(evId.equalsIgnoreCase("all")){
				evId="%%";	
			}
			if(catId.equalsIgnoreCase("all")){
				catId="%%";	
			}
			if(regNo.equalsIgnoreCase("all")){
				evId="%%";	
				}
			
			ArrayList<eventRegVo> mainList = new eventBD().getEventIdPrintList(evId,catId,regNo,accyear);
...
public ActionForward PrintPreviewEventMultipleIDCard(ActionMapping mapping, ActionForm form,
	...
	String admno[]=request.getParameter("admno").split(",");
	String prognm[]=request.getParameter("prognm").split(",");
	String stunm[]=request.getParameter("stunm").split(",");
	String cls[]=request.getParameter("cls").split(",");
	String rolno[]=request.getParameter("rolno").split(",");
	String evenm[]=request.getParameter("evenm").split(",");
	String evecat[]=request.getParameter("evecat").split(",");
	String schlnm[]=request.getParameter("schlnm").split(",");
	String img[]=request.getParameter("img").split(",");
	
	
	for(int i = 0; i < admno.length; i++)
	{
		eventRegPojo reg = new eventRegPojo();
		reg.setAdmissionNo(admno[i]);
		reg.setProgrammeName(prognm[i]);
		reg.setStudentname(stunm[i]);
		reg.setClassName(cls[i]);
		reg.setRollNo(rolno[i]);
		reg.setEventName(evenm[i]);
		reg.setCategoryName(evecat[i]);
		reg.setLocation(schlnm[i]);
		reg.setImageUrl(img[i]);		
		list.add(reg);
	}
	request.setAttribute("template", evenm[0]+evecat[0]+prognm[0]);
...
public ActionForward saveProgramNumberingDetails(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception{
	...
	try{
		...
		//("category>>>"+category);
		//("progparticipant>>>"+progparticipant);
...
public ActionForward deleteProgramNumber(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		...
		//("id to delete in program numbering >>>>>"+id[0]);
		String data =new eventBD().deleteProgramNumber(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward EvntIdDesign(ActionMapping mapping, ActionForm form,
	...
	//("imgurl"+imgUrl);
	String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
	//("realimgurl"+request.getRealPath("/")+imgUrl);
	...
	try {
		...
		HelperClass.recordLog_Activity(log_audit_session,"Event","Event ID Design","Design",absolutePath,custdetails);
...
public ActionForward saveMarksEntry(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)throws Exception{
	...
	try{
		...
		String status = new EventsDaoImpl().saveMarksEntry(accId,catId,progId,evId,marksObtained,chestNo,criteriaName,criteriaMarks,userId,log_audit_session);
...
public ActionForward getProgramSchedulingExcelReport(ActionMapping mapping,
	...
	try {
		...
		ArrayList<ReportMenuVo> datalist = new ReportsMenuBD().getAccYears(userLoggingsVo);
...
public ActionForward deletevolanteer(ActionMapping mapping, ActionForm from, HttpServletRequest request,HttpServletResponse response)throws Exception{
	...
	try{
		String log_audit_session = (String) request.getSession(false).getAttribute("log_audit_session");
		String id=request.getParameter("id");
		String data =new eventBD().deletevolanteer(id,log_audit_session);
		JSONObject obj =new JSONObject();
		obj.put("status", data);
		response.getWriter().print(obj);
	}catch(Exception e){
...
public ActionForward getProgramNumberingPdfReport(ActionMapping mapping,
		...
		try {
///schoolmate/WebContent/Reports/ProgramNumberingPdfList.jrxml
			String event=request.getParameter("event");
			if(event.equalsIgnoreCase("all")||event.equalsIgnoreCase(""))
			{
				event="%%";
...
public ActionForward getStageAllocatedPdfReport(ActionMapping mapping,
		...
		try {
			...
			///schoolmate/src/com/centris/campus/vo/eventRegVo.java
...
public ActionForward getEventStudentMeritListByProgramme(ActionMapping mapping, ActionForm form,
	...
	logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			ArrayList<eventRegVo> mainList = new eventBD().getEventStudentMeritListByProgramme(evId,progId,catId,houseId,accId,place);
...
public ActionForward getEventStudentOverallResult(ActionMapping mapping, ActionForm form,
	...
	logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			ArrayList<eventRegVo> mainList = new eventBD().getEventStudentOverallResult(evId,progId,catId,houseId,accId);
...
public ActionForward EventOverallResultDownloadPDF(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response)
				throws Exception {
	logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
	...
	logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			String sourceFileName = request.getRealPath("Reports/EventOverallResult.jrxml");
			JasperDesign design = JRXmlLoader.load(sourceFileName);
...
public ActionForward EventOverallResultPrint(ActionMapping mapping, ActionForm form,
		HttpServletRequest request, HttpServletResponse response)
				throws Exception {
	logger.setLevel(Level.DEBUG);
	JLogger.log(0, JDate.getTimeString(new Date())
...
public ActionForward getHouseNamebyCategoryId(ActionMapping mapping,
	...
	try {
		String catId = request.getParameter("catId");
		ArrayList<eventRegVo> housewise = new EventsDaoImpl().getHouseNamebyCategoryId(catId);
		JSONObject obj1= new JSONObject();
		obj1.put("data", housewise);
		response.getWriter().print(obj1);
