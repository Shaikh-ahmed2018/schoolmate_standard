...
public class InventoryMenuAction extends DispatchAction {
	...
	public ActionForward DeleteInventoryType(ActionMapping mapping,
		...
		try {
			...
			list = new Inventory_Delegate().InventoryTypesList(userLoggingsVo);
	...
	public ActionForward InventoryTypeXLS (ActionMapping mapping,
		...
		try {
			...
			if(SearchName != null){
				...
				list=obj.searchInventoryTypeList(SearchName,userLoggingsVo);
				
			}
			else{
				
			 list =obj.InventoryTypesList(userLoggingsVo);
	...
	public ActionForward InventoryTypePDF (ActionMapping mapping,
		...
		try {
			...
			if(SearchName != null){
				...
				list= new Inventory_Delegate().searchInventoryTypeList(SearchName,userLoggingsVo);
	...
	public ActionForward CreatingAddorModifyorDelete(ActionMapping mapping,
		...
		try {
			...
			String currentuser = HelperClass.getCurrentUserID(request);
			form1.setCurrent_user(currentuser);
			//("Purchase Id::::"+form1.getPurchase_id());
			...
			Inventory_Delegate obj = new Inventory_Delegate();
			list = new Inventory_Delegate().AddorModifyorDeleteList(userLoggingsVo);
	...
	public ActionForward EditAddorModifyorDelete(ActionMapping mapping,
		...
		try {
			...
			List<InventoryVO> list = new Inventory_Delegate().InventoryTypesList(custdetails);
	...
	public ActionForward DeleteAddorModifyorDelete(ActionMapping mapping,
		...
		try {
			...
			List<AddorModifyorDeleteVO> list = new Inventory_Delegate().AddorModifyorDeleteList(userLoggingsVo);
			request.setAttribute("list", list);
	...
	public ActionForward AddorModifyorDeleteXLS (ActionMapping mapping,
		...
		try {
			...
			if(SearchName != null){
				...
				list=obj.SearchAddorModifyorDeleteList(SearchName,userLoggingsVo);
	...
	public ActionForward CreateTransactionDetails(ActionMapping mapping,
		...
		try {
			...
			//("Action class itetype: "+form1.getItem_type());
			//("Action class itemName: "+form1.getItem_type_id());
	...
	public ActionForward returnInventoryItem(ActionMapping mapping,
		...
		try {
			...
			list = obj.InventoryList(userLoggingsVo.getCustId());
