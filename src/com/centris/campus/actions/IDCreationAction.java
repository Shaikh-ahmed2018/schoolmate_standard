...
public class IDCreationAction extends DispatchAction{
	...
	public ActionForward getStudentDetailsReport(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : getStudentDetailsReport Starting");
		try {
			UserLoggingsPojo userLoggingsVo = (UserLoggingsPojo) request.getSession(false).getAttribute("token_information");
			CustomerDBDetails dbdetails = (CustomerDBDetails) request.getSession(false).getAttribute("CustDBDetails");
			...
			ArrayList<StudentInfoVO> studentInfoList = new ReportsMenuBD()
					.getStudentDetailsReport(reform,userLoggingsVo);

			ReportMenuVo selectedItems = new ReportsMenuBD()
					.getSelectedItems(reform,userLoggingsVo);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : getStudentDetailsReport Ending");
	...
	public ActionForward NewstaffIdCardDesignList(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : NewstaffIdCardDesignList Starting");
		boolean bool = false;
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : NewstaffIdCardDesignList Ending");
	...
	public ActionForward staffDesignSingle(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : staffDesignSingle Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : staffDesignSingle Ending");
	...
	public ActionForward staffSingleIDCard(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : staffSingleIDCard Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : staffSingleIDCard Ending");
	...
	public ActionForward SingleStaffIDCardDesignList(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : SingleStaffIDCardDesignList Starting");
...
/*	filterpojo.setDesignationId(department);
	filterpojo.setDesignationId(designation);*/
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : SingleStaffIDCardDesignList Ending");
	...
	public ActionForward IdDesign(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : IdDesign Starting");
		...
		try {
			...
			HelperClass.recordLog_Activity(log_audit_session,"Settings","Design Staff ID Card","Design",absolutePath,custdetails);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : IdDesign Ending");
		return null;
	...
	public ActionForward saveLayoutImage(ActionMapping mapping,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : saveLayoutImage Starting");

		try {
			//("Inside the changeImage");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : saveLayoutImage Ending");
	...
	public ActionForward StaffSingleIDCardDesignNew(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : StaffSingleIDCardDesignNew Starting");
		...
		try {
			...
			//list = new StudentRegistrationDelegate().getIDCard(studentId,accYear,locationId); 
			//List<StudentRegistrationVo> list = new StudentRegistrationDelegate().getIDCard(studentId,accYear,locationId);
			list = new StudentRegistrationDelegate().getIDCardStaff(filterpojo,userLoggingsVo);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : StaffSingleIDCardDesignNew Ending");
...
/*	holdit*/
	public ActionForward getStudentSearchByList(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : getStudentSearchByList Starting");
...
/*	if(locationId.equalsIgnoreCase("all") && academicYear.equalsIgnoreCase("all")){
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : getStudentSearchByList Ending");
	...
	public ActionForward PrintPreviewStaffMultipleIDCard(ActionMapping mapping, ActionForm form,
		...
		logger.info(JDate.getTimeString(new Date())
			...
			try {
				...
				List<PageFilterVo> filterVo = new StudentIDDaoImpl().getstaffIDPDFReport(locationId,teacherID,userLoggingsVo);
				List<PageFilterVo> list=new ArrayList<PageFilterVo>();

				int AccYearVal=Integer.parseInt(HelperClass.getAcademicYearFace(academicyear[0],userLoggingsVo).split("-")[0]);
				...
				for (int i = 0; i < filterVo.size(); i++) {
					...
					vo.setLocationName(filterVo.get(i).getSchoolName());
					vo.setSchoollogourl(filterVo.get(i).getSchoollogourl());
					list.add(vo);
				}
				...
				request.setAttribute("historyacademicId", academicyear[0]);
				...
				request.setAttribute("historydepartId", request.getParameter("departId"));
				request.setAttribute("historydesigId", request.getParameter("desigId"));
	...
	public ActionForward getStaffSearchByList(ActionMapping mapping, ActionForm form,
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : getStaffSearchByList Starting");
		...
		try {
			...
			list=new  IDGenerator().getstaffSearchByAll(searchTerm,locationId,academicYear,department,designation,userLoggingsVo);
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in IDCreationAction : getStaffSearchByList Ending");
