...
private static Logger logger = Logger.getLogger(AssignmentUploadAction.class);
	...
	public synchronized ActionForward insertAssignment(ActionMapping mapping,
		...
		try {
			...
			viewVo.setLog_audit_session(log_audit_session);
			viewVo.setCustid(userLoggingsVo.getCustId());
			
			String statuss=new AssignmentUploadBD().insertAssignment(viewVo,userLoggingsVo);
	...
	public synchronized ActionForward updateAssignmentDetails(ActionMapping mapping,
		...
		try {
			...
			AssignmentUploadVo assignmentVo=new AssignmentUploadVo();
			 ...
			 assignmentVo.setLog_audit_session(log_audit_session);
			 assignmentVo.setCustid(userLoggingsVo.getCustId());
			 
			String status=new AssignmentUploadBD().updateAssignmentDetails(assignmentVo,userLoggingsVo);
	...
	public synchronized ActionForward deleteAssignment(ActionMapping mapping,
		...
		try {
			...
			assignmentCode.setLog_audit_session(log_audit_session);
			assignmentCode.setCustid(userLoggingsVo.getCustId());
			
			String status=new AssignmentUploadBD().deleteAssignment(assignmentCode,userLoggingsVo);
	...
	public synchronized ActionForward addnewProject(ActionMapping mapping,
		...
		try {
			...
			viewVo.setAccYear(accYearString);
			viewVo.setLog_audit_session(log_audit_session);
			String statuss=new AssignmentUploadBD().addProject(viewVo,userLoggingsVo);
	...
	public synchronized ActionForward updateProjectDetails(ActionMapping mapping,
		...
		try {
			...
			projectvo.setLog_audit_session(log_audit_session);
			String status=new AssignmentUploadBD().updateProjectDetails(projectvo,userLoggingsVo);
	...
	public synchronized ActionForward deleteProject(ActionMapping mapping,
		...
		try {
			...
			project.setLog_audit_session(log_audit_session);
			
			String status=new AssignmentUploadBD().deleteProject(project,userLoggingsVo);
