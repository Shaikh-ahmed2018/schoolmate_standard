...
public class TeacherLeaveModuleBD {
	...
	public ArrayList<TimeTableVo> getTeacherTimetable(String userid,UserLoggingsPojo userLoggingsVo) {
	
		return service.getTeacherTimetableListService(userid,userLoggingsVo);
	}



	public String leaveRequestEntryBD(LeaveRequestVo leavevo, UserLoggingsPojo custdetails) {
		
		return service.leaveRequestEntryService(leavevo,custdetails);
	}
