...
public class ParentExamdetailsBD {
	...
	public ArrayList<ParentFeedbackVo> getFeedBackDetailsBD(
		...
		return service.getFeedBackDetailsService(fbvo,custdetails);
	}
	...
	public String getsubjectfilepath(String subid, UserLoggingsPojo custdetails) {

		return service.getsubjectfilepathService(subid,custdetails);
	}
	...
	public String deleteRequestLeaveBD(String[] list, String userid, String academic_year, LeaveRequestVo leavevo) {

		return service.deleteRequestLeaveBDService(list,userid,academic_year,leavevo);
	}

	public ArrayList<TimeTableVo> getStudentTimetable(String studentid,UserLoggingsPojo custdetails) {

		return service.getStudentTimetableService(studentid,custdetails);
	}
	...
	public List<ViewallSubjectsVo> getLabDetails(ViewallSubjectsVo subvo) {
		return service.getLabDetails(subvo);
	}

	public ArrayList<ParentVO> getStudentAnalyticalPerformanceForParent(ParentVO vo) {
		return service.getStudentAnalyticalPerformanceForParent(vo);
	}

	public String SaveStudentAnalyticalPerformanceByParent(ParentVO obj) {
		return service.SaveStudentAnalyticalPerformanceByParent(obj);
	}
