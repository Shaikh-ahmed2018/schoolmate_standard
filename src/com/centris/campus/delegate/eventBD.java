...
public class eventBD  {
	...
	public String deleteEventRegistration(String id,String log_audit_session) {
		return new eventsServiceIMPL().deleteEventRegistration(id,log_audit_session);
	}
	...
	return new eventsServiceIMPL().deleteCategory(id,log_audit_session);
	}
	...
	public String deleteStage(String id,String log_audit_session) {
		return new eventsServiceIMPL().deleteStage(id,log_audit_session);
	}
	...
	public String deleteCriteria(String id,String log_audit_session) {
		return new eventsServiceIMPL().deleteCriteria(id,log_audit_session);
	}
	...
	public String deleteGreenRoom(String id,String log_audit_session) {
		return new eventsServiceIMPL().deleteGreenRoom(id,log_audit_session);
	}
...
/*	public ArrayList<eventRegVo> getprogramName(String evId, String catId, String group) {
	...
	return new eventsServiceIMPL().deleteProgram(id,log_audit_session);
	}
	...
	public String deletePrize(String id,String log_audit_session) {
		return new eventsServiceIMPL().deletePrize(id,log_audit_session);
	}
	...
	public String deleteEventStudReg(String id,String log_audit_session) {
		return new eventsServiceIMPL().deleteEventStudReg(id,log_audit_session);
	}
	...
	public String deleteProgramScheduling(String id,String log_audit_session) {
		return new eventsServiceIMPL().deleteProgramScheduling(id,log_audit_session);
	}
	...
	public String deleteProgramNumber(String[] id,String log_audit_session) {
		return new eventsServiceIMPL().deleteProgramNumber(id,log_audit_session);
	}
	...
	public String deletevolanteer(String id,String log_audit_session) {
		return new eventsServiceIMPL().deletevolanteer(id,log_audit_session);
	}
	...
	public ArrayList<eventRegVo> getEventStudentMeritListByProgramme(
			String evId, String progId, String catId, String houseId,
			String accId, int place) {
		return new eventsServiceIMPL().getEventStudentMeritListByProgramme(evId,progId,catId,houseId,accId,place);
		}
	...
	public ArrayList<eventRegVo> getEventStudentOverallResult(String evId,
			String progId, String catId, String houseId, String accId) {
		return new eventsServiceIMPL().getEventStudentOverallResult(evId,progId,catId,houseId,accId);
		}
