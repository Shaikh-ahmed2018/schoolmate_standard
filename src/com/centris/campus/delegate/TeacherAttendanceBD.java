...
public class TeacherAttendanceBD {
	...
	public String getTotalStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		...
		return new TeacherAttendanceServiceImpl().getTotalStaffcount( userLoggingsVo ,  location_id);
	}

	public String getTotalPresentStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		
		return new TeacherAttendanceServiceImpl().getTotalPresentStaffcount( userLoggingsVo ,  location_id);
	}

	public String getTotalAbsentStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		
		return new TeacherAttendanceServiceImpl().getTotalAbsentStaffcount( userLoggingsVo ,  location_id);
	}

	public String getTotalLeaveStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		return new TeacherAttendanceServiceImpl().getTotalLeaveStaffcount(userLoggingsVo ,  location_id);
	}
