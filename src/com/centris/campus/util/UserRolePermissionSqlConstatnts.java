...
//	public static final String GET_PERMISSION = "select PermissionCode,permission,shortName from campus_permissions";
	...
	public static final String GET_PERMISSION ="select * from campus_permissions where `isApplicable` = 'Y' order by Module";
	public static final String UPDATE_ROLE_PERMISSION_MAPPING = "UPDATE campus_role_permissions_mapping SET isApplicable=? WHERE permissionCode=? AND roleCode=? AND shortName=?";
}
