...
public class AcademicYearSQLUtilConstants {
	public static final String GET_ALL_ACADEMICYEAR = "select isActive,remarks,acadamic_id,acadamic_year,startDate,endDate,Description from campus_acadamicyear where isActive='Y' order by acadamic_year";
	...
	public static final String CHECK_ACADEMICYEAR_NAME = "select count(*)Acdname,isActive from campus_acadamicyear where acadamic_year = ? and (? between startDate and endDate or ? between startDate and endDate)";
	public static final String CHECK_ACADEMICYEAR_DATES = "select count(*)datescount,isActive from campus_acadamicyear where ? between startDate and endDate or ? between startDate and endDate";
	...
	public static final String CHECK_ACADEMICYEAR_NAME_WHILE_UPATE="select count(*)Acdname,isActive from campus_acadamicyear where acadamic_year = ? and (? between startDate and endDate or ? between startDate and endDate) and acadamic_id != ?";

	
	public static final String CHECK_ACADEMICYEAR_DATES_WHILE_UPATE="select count(*)datescount,isActive from campus_acadamicyear where (? between startDate and endDate or ? between startDate and endDate)and acadamic_id != ?";
	...
	public static final String GET_ACADEMICYEAR_BY_STATUS = "SELECT remarks,isActive,acadamic_id,acadamic_year,startDate,endDate,Description FROM campus_acadamicyear WHERE isActive=? ORDER BY acadamic_year";
	public static final String ACTIVE_INACTIVE_ACADEMIC_YEAR_BY_STATUS = "UPDATE campus_acadamicyear SET isActive=?,remarks=? WHERE  acadamic_id=?";
}
