...
public class StaffAttendancePostingSqlUtil {
	...
	public static final String GET_ALL_TEACHER_COUNT = "SELECT  COUNT(*) AS total FROM `campus_teachers`  WHERE  Loc_ID = ? ";
	public static final String GET_ALL_TEACHER_PRESENT_COUNT = " SELECT DISTINCT COUNT(*) as total FROM `campus_teacher_attendence` WHERE `AttendenceStatus` = 'Present' AND  `AttendenceDate` = ? ";
	public static final String GET_ALL_TEACHER_ABSENT_COUNT = " SELECT DISTINCT COUNT(*) as total FROM `campus_teacher_attendence` WHERE `AttendenceStatus` = 'Absent' AND  `AttendenceDate` = ? ";
	public static final String GET_ALL_TEACHER_LEAVE_COUNT = " SELECT DISTINCT COUNT(*) as total FROM `campus_teacher_attendence` WHERE `AttendenceStatus` = 'Absent' AND  `AttendenceDate` = ? ";
