...
public class CustomizableStudentReportExcell {
    ...
    public void download(ArrayList<HashMap<String, String>> fullstudentList, String[] fielldArray, String path, String[] labelArray, UserLoggingsPojo custdetails) throws Exception{
    	try{
