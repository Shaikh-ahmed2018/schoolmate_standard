...
public class UploadDriverXLSqlUtil {
	...
	public static final String INSERT_DRIVER = "insert into transport_driver(DriverCode,type,Name,FatherName,DOB,MobileNo,EmergencyContactNo,Experience,Address,DOJ,Age,Gender,DLExpirayDate,LicencetoDrive,CreateDate,CreateUser,DLNo,locId) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
