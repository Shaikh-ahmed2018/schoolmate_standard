...
public class LeaveReportSqlUtils {
	...
	public static final String GET_TEACHERS="select TeacherID,concat(FirstName,' ',LastName) as teacherName from campus_teachers where teachingType like ? and department like ? and isActive='Y'";
}
