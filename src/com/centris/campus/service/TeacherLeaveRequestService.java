...
public interface TeacherLeaveRequestService {
	...
	ArrayList<TimeTableVo> getTeacherTimetableListService(String userid,UserLoggingsPojo userLoggingsVo);

	String leaveRequestEntryService(LeaveRequestVo leavevo, UserLoggingsPojo custdetails);
