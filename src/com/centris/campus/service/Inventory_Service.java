...
public interface Inventory_Service {
	...
	List<InventoryVO> InventoryTypesList(UserLoggingsPojo custdetails);

	List<InventoryVO> searchInventoryTypeList(String searchName, UserLoggingsPojo userLoggingsVo);
	...
	List<AddorModifyorDeleteVO> AddorModifyorDeleteList(UserLoggingsPojo userLoggingsVo);
	...
	List<AddorModifyorDeleteVO> SearchAddorModifyorDeleteList(String searchName, UserLoggingsPojo userLoggingsVo);

	List<AddorModifyorDeleteVO> InventoryList(String custid);
	
	List<AddorModifyorDeleteVO> SearchInventoryList(String searchName, UserLoggingsPojo userLoggingsVo);
	...
	List<InventoryTransactionVO> usageReportList(InventoryTransactionForm invenTranForm,UserLoggingsPojo userLoggingsVo);
