...
public interface ParentSettingsService {
	...
	ArrayList<ParentFeedbackVo> getFeedBackDetailsService(ParentFeedbackVo fbvo, UserLoggingsPojo custdetails);
	...
	String getsubjectfilepathService(String subid, UserLoggingsPojo custdetails);
	...
	String deleteRequestLeaveBDService(String[] list, String userid, String academic_year, LeaveRequestVo leavevo);

	ArrayList<TimeTableVo> getStudentTimetableService(String studentid, UserLoggingsPojo custdetails);
	...
	List<ViewallSubjectsVo> getLabDetails(ViewallSubjectsVo subvo);

	ArrayList<ParentVO> getStudentAnalyticalPerformanceForParent(ParentVO vo);

	String SaveStudentAnalyticalPerformanceByParent(ParentVO obj);
