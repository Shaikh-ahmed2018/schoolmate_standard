...
public class ExaminationDetailsVo {
	...
	private String specializationId;
 	...
 	private ArrayList<ExaminationDetailsVo> practicallist;
 	private String searchText;
 	private String reportstatus;
 	private String theoryMarks;
 	private String practicalMarks;
 	private String periodicmark;
 	private String markId;
 	private String maxLimit;
 	private String reporttype;
 	private String setupId;
 	private String periodicmark1;
 	private String notebookmark;
 	private String subenrichmentmark;
 	private String periodicexam;
 	private String periodicexam1;
 	private String halfyearlyexam;
 	private String finalexam;
 	private String termname;
 	private String halfyearlymark;
 	private String nonpracticalmark;
 	
 	
	public String getNonpracticalmark() {
		return nonpracticalmark;
	}
	public void setNonpracticalmark(String nonpracticalmark) {
		this.nonpracticalmark = nonpracticalmark;
	}
	public String getHalfyearlymark() {
		return halfyearlymark;
	}
	public void setHalfyearlymark(String halfyearlymark) {
	...
	public String getPeriodicmark1() {
		return periodicmark1;
	}
	public void setPeriodicmark1(String periodicmark1) {
		this.periodicmark1 = periodicmark1;
	}
	public String getNotebookmark() {
		return notebookmark;
	}
	public void setNotebookmark(String notebookmark) {
		this.notebookmark = notebookmark;
	}
	public String getSubenrichmentmark() {
		return subenrichmentmark;
	}
	public void setSubenrichmentmark(String subenrichmentmark) {
		this.subenrichmentmark = subenrichmentmark;
	}
	public String getPeriodicexam() {
		return periodicexam;
	}
	public void setPeriodicexam(String periodicexam) {
		this.periodicexam = periodicexam;
	}
	public String getPeriodicexam1() {
		return periodicexam1;
	}
	public void setPeriodicexam1(String periodicexam1) {
		this.periodicexam1 = periodicexam1;
	}
	...
	public String getPeriodicmark() {
		return periodicmark;
	}
	public void setPeriodicmark(String periodicmark) {
		this.periodicmark = periodicmark;
	}
	...
	public ArrayList<ExaminationDetailsVo> getPracticallist() {
		return practicallist;
	}
	public void setPracticallist(ArrayList<ExaminationDetailsVo> practicallist) {
	...
	private ArrayList<String> totscoredmarks;
	...
	public ArrayList<String> getTotscoredmarks() {
		return totscoredmarks;
	}
	public void setTotscoredmarks(ArrayList<String> totscoredmarks) {
		this.totscoredmarks = totscoredmarks;
	}
