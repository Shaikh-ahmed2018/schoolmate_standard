...
public class StaffEmployementVo {
	...
	private double prevtdsctc;
	private double prevstandarddedu;
	private double prevtaxbleincomestatury;
	private double prevtdspf;
	private double prevtdspt;
	private double prevtaxpayble;
	private double prevtaxableincome;
	private double tottdsctc;
	private double totstandarddedu;
	private double tottaxbleincomestatury;
	private double tottdspf;
	private double tottdspt;
	private double tottaxpayble;
	private double tottaxableincome;
	...
	private double prevTotalTDSIncomeFromOther;
	private double totTotalTDSIncomeFromOther;
	private double prevtotalExemptions;
	private double prevtdspayabletax;
	private double prevtdstaxableincome;
	private double prevtotaltdsundervia;
	private double tottotalExemptions;
	private double tottdspayabletax;
	private double tottdstaxableincome;
	private double tottotaltdsundervia;
	...
	public double getPrevtotalExemptions() {
		return prevtotalExemptions;
	}

	public void setPrevtotalExemptions(double prevtotalExemptions) {
		this.prevtotalExemptions = prevtotalExemptions;
	}

	public double getPrevtdspayabletax() {
		return prevtdspayabletax;
	}

	public void setPrevtdspayabletax(double prevtdspayabletax) {
		this.prevtdspayabletax = prevtdspayabletax;
	}

	public double getPrevtdstaxableincome() {
		return prevtdstaxableincome;
	}

	public void setPrevtdstaxableincome(double prevtdstaxableincome) {
		this.prevtdstaxableincome = prevtdstaxableincome;
	}

	public double getPrevtotaltdsundervia() {
		return prevtotaltdsundervia;
	}

	public void setPrevtotaltdsundervia(double prevtotaltdsundervia) {
		this.prevtotaltdsundervia = prevtotaltdsundervia;
	}

	public double getTottotalExemptions() {
		return tottotalExemptions;
	}

	public void setTottotalExemptions(double tottotalExemptions) {
		this.tottotalExemptions = tottotalExemptions;
	}

	public double getTottdspayabletax() {
		return tottdspayabletax;
	}

	public void setTottdspayabletax(double tottdspayabletax) {
		this.tottdspayabletax = tottdspayabletax;
	}

	public double getTottdstaxableincome() {
		return tottdstaxableincome;
	}

	public void setTottdstaxableincome(double tottdstaxableincome) {
		this.tottdstaxableincome = tottdstaxableincome;
	}

	public double getTottotaltdsundervia() {
		return tottotaltdsundervia;
	}

	public void setTottotaltdsundervia(double tottotaltdsundervia) {
		this.tottotaltdsundervia = tottotaltdsundervia;
	}

	public double getPrevTotalTDSIncomeFromOther() {
		return prevTotalTDSIncomeFromOther;
	}

	public void setPrevTotalTDSIncomeFromOther(double prevTotalTDSIncomeFromOther) {
		this.prevTotalTDSIncomeFromOther = prevTotalTDSIncomeFromOther;
	}

	public double getTotTotalTDSIncomeFromOther() {
		return totTotalTDSIncomeFromOther;
	}

	public void setTotTotalTDSIncomeFromOther(double totTotalTDSIncomeFromOther) {
		this.totTotalTDSIncomeFromOther = totTotalTDSIncomeFromOther;
	}

	public double getPrevtdsctc() {
		return prevtdsctc;
	}

	public void setPrevtdsctc(double prevtdsctc) {
		this.prevtdsctc = prevtdsctc;
	}

	public double getPrevstandarddedu() {
		return prevstandarddedu;
	}

	public void setPrevstandarddedu(double prevstandarddedu) {
		this.prevstandarddedu = prevstandarddedu;
	}

	public double getPrevtaxbleincomestatury() {
		return prevtaxbleincomestatury;
	}

	public void setPrevtaxbleincomestatury(double prevtaxbleincomestatury) {
		this.prevtaxbleincomestatury = prevtaxbleincomestatury;
	}

	public double getPrevtdspf() {
		return prevtdspf;
	}

	public void setPrevtdspf(double prevtdspf) {
		this.prevtdspf = prevtdspf;
	}

	public double getPrevtdspt() {
		return prevtdspt;
	}

	public void setPrevtdspt(double prevtdspt) {
		this.prevtdspt = prevtdspt;
	}

	public double getPrevtaxpayble() {
		return prevtaxpayble;
	}

	public void setPrevtaxpayble(double prevtaxpayble) {
		this.prevtaxpayble = prevtaxpayble;
	}

	public double getPrevtaxableincome() {
		return prevtaxableincome;
	}

	public void setPrevtaxableincome(double prevtaxableincome) {
		this.prevtaxableincome = prevtaxableincome;
	}

	public double getTottdsctc() {
		return tottdsctc;
	}

	public void setTottdsctc(double tottdsctc) {
		this.tottdsctc = tottdsctc;
	}

	public double getTotstandarddedu() {
		return totstandarddedu;
	}

	public void setTotstandarddedu(double totstandarddedu) {
		this.totstandarddedu = totstandarddedu;
	}

	public double getTottaxbleincomestatury() {
		return tottaxbleincomestatury;
	}

	public void setTottaxbleincomestatury(double tottaxbleincomestatury) {
		this.tottaxbleincomestatury = tottaxbleincomestatury;
	}

	public double getTottdspf() {
		return tottdspf;
	}

	public void setTottdspf(double tottdspf) {
		this.tottdspf = tottdspf;
	}

	public double getTottdspt() {
		return tottdspt;
	}

	public void setTottdspt(double tottdspt) {
		this.tottdspt = tottdspt;
	}

	public double getTottaxpayble() {
		return tottaxpayble;
	}

	public void setTottaxpayble(double tottaxpayble) {
		this.tottaxpayble = tottaxpayble;
	}

	public double getTottaxableincome() {
		return tottaxableincome;
	}

	public void setTottaxableincome(double tottaxableincome) {
		this.tottaxableincome = tottaxableincome;
	}
	...
	private double prevtaxableTotalAmount;
	private double tottaxableTotalAmount;
	
	
	
	public double getPrevtaxableTotalAmount() {
		return prevtaxableTotalAmount;
	}

	public void setPrevtaxableTotalAmount(double prevtaxableTotalAmount) {
		this.prevtaxableTotalAmount = prevtaxableTotalAmount;
	}

	public double getTottaxableTotalAmount() {
		return tottaxableTotalAmount;
	}

	public void setTottaxableTotalAmount(double tottaxableTotalAmount) {
		this.tottaxableTotalAmount = tottaxableTotalAmount;
	}
