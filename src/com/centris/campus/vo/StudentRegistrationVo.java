...
public class StudentRegistrationVo implements Serializable {
	...
	private String  meetattain;
	private String gencond;
	private String nooffail; 
	private String classnamewords; 
	private String studentIdNo;
	private String staffname;
	private String promotedClass;
	private String promotedSection;
	private String promotedAcademicYearId;
	private String toClassSection; 
	...
	private ArrayList<String> feeapplicableterm;
	private String[] feeapplicableTerm;
	
	private UserLoggingsPojo dbdetails;
	private String ckeckedval;
	private String[] ckeckedvals;
	private String[] rowIds; 
	private String[] selectvalue; 
	private String[] otherval;
	
	private String analyticalRemarksId;
	...
	private String trnsnoreason;
	private String location_address;
	private String location_phone;
	
	private String allowedmodi;
	...
	public String getAllowedmodi() {
		return allowedmodi;
	}
	public void setAllowedmodi(String allowedmodi) {
		this.allowedmodi = allowedmodi;
	}
	public String getTrnsnoreason() {
		return trnsnoreason;
	}
	public void setTrnsnoreason(String trnsnoreason) {
		this.trnsnoreason = trnsnoreason;
	}
	...
	public String getAnalyticalRemarksId() {
		return analyticalRemarksId;
	}
	public void setAnalyticalRemarksId(String analyticalRemarksId) {
		this.analyticalRemarksId = analyticalRemarksId;
	}
	...
	public String getParentsOpinion() {
		return parentsOpinion;
	}
	public void setParentsOpinion(String parentsOpinion) {
		this.parentsOpinion = parentsOpinion;
	}
	...
	public String getCkeckedval() {
		return ckeckedval;
	}
	public void setCkeckedval(String ckeckedval) {
		this.ckeckedval = ckeckedval;
	}
	public String[] getCkeckedvals() {
		return ckeckedvals;
	}
	public void setCkeckedvals(String[] ckeckedvals) {
		this.ckeckedvals = ckeckedvals;
	}
	...
	public String[] getFeeapplicableTerm() {
		return feeapplicableTerm;
	}
	public void setFeeapplicableTerm(String[] feeapplicableTerm) {
		this.feeapplicableTerm = feeapplicableTerm;
	}
	...
	public ArrayList<String> getFeeapplicableterm() {
		return feeapplicableterm;
	}
	public void setFeeapplicableterm(ArrayList<String> feeapplicableterm) {
		this.feeapplicableterm = feeapplicableterm;
	}
	...
	public String getClassnamewords() {
		return classnamewords;
	}
	public void setClassnamewords(String classnamewords) {
		this.classnamewords = classnamewords;
	}
	...
	public String getMeetattain() {
		return meetattain;
	}
	public void setMeetattain(String meetattain) {
		this.meetattain = meetattain;
	}
	...
	public String getPromotedSection() {
		return promotedSection;
	}
	public void setPromotedSection(String promotedSection) {
		this.promotedSection = promotedSection;
	}
	public String getPromotedAcademicYearId() {
		return promotedAcademicYearId;
	}
	public void setPromotedAcademicYearId(String promotedAcademicYearId) {
		this.promotedAcademicYearId = promotedAcademicYearId;
	}
	public String getToClassSection() {
		return toClassSection;
	}
	public void setToClassSection(String toClassSection) {
		this.toClassSection = toClassSection;
	}
