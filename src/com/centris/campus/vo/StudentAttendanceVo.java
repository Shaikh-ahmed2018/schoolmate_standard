...
public class StudentAttendanceVo implements Comparator<StudentAttendanceVo>{
	...
	public void setSatusid(String satusid) {
	...
	@Override
	public int compare(StudentAttendanceVo o1, StudentAttendanceVo o2) {
