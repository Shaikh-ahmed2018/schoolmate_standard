...
public class StudentAttendanceReportVo {
	
	private String accyrid;
	private String accyrname;
	...
	public String getAccyrname() {
		return accyrname;
	}
	public void setAccyrname(String accyrname) {
		this.accyrname = accyrname;
	}
