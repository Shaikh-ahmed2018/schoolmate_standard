...
public class LibrarySubscribVO {
	...
	private String desigantionId;
	private String staffRegisterId;
 
	private String loc_ID;
	
	//- --------save library subscriber-------------------
	...
	public String getDesigantionId() {
		return desigantionId;
	}
	public void setDesigantionId(String desigantionId) {
	...
	public String getShelfNno() {
		return shelfNno;
	}
	public void setShelfNno(String shelfNno) {
		this.shelfNno = shelfNno;
	}
