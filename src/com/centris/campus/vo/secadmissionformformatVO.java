...
public class secadmissionformformatVO {
	...
	public String getTemp_regid() {
		return temp_regid;
	}
	public void setTemp_regid(String temp_regid) {
		this.temp_regid = temp_regid;
	}
