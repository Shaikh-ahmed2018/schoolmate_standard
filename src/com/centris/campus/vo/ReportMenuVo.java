...
public class ReportMenuVo {
	...
	private String date;
	private String examtypePrifix;
	private double opeingBalance;
	...
	private String notebook_marks;
	private String subject_enrich_marks;
	...
	private String noStudentcount;
	private String houseName;
	private int housecount;
	private String pequeryId;
	private String email;
	
	private String locAddId;
	private String locAddName;
	
	private String schoolId;
	private String schoolName;
	private String finalperiodicmark;
	private String finalnotebook;
	private String finalsubenrichment;
	private String finalyearlymark;
	private String finalperiodicmark1;
	private String finalnotebook1;
	private String finalsubenrichment1;
	private String finalyearlymark1;
	
	
	
	public String getFinalperiodicmark() {
		return finalperiodicmark;
	}
	public void setFinalperiodicmark(String finalperiodicmark) {
		this.finalperiodicmark = finalperiodicmark;
	}
	public String getFinalnotebook() {
		return finalnotebook;
	}
	public void setFinalnotebook(String finalnotebook) {
		this.finalnotebook = finalnotebook;
	}
	public String getFinalsubenrichment() {
		return finalsubenrichment;
	}
	public void setFinalsubenrichment(String finalsubenrichment) {
		this.finalsubenrichment = finalsubenrichment;
	}
	public String getFinalyearlymark() {
		return finalyearlymark;
	}
	public void setFinalyearlymark(String finalyearlymark) {
		this.finalyearlymark = finalyearlymark;
	}
	public String getFinalperiodicmark1() {
		return finalperiodicmark1;
	}
	public void setFinalperiodicmark1(String finalperiodicmark1) {
		this.finalperiodicmark1 = finalperiodicmark1;
	}
	public String getFinalnotebook1() {
		return finalnotebook1;
	}
	public void setFinalnotebook1(String finalnotebook1) {
		this.finalnotebook1 = finalnotebook1;
	}
	public String getFinalsubenrichment1() {
		return finalsubenrichment1;
	}
	public void setFinalsubenrichment1(String finalsubenrichment1) {
		this.finalsubenrichment1 = finalsubenrichment1;
	}
	public String getFinalyearlymark1() {
		return finalyearlymark1;
	}
	public void setFinalyearlymark1(String finalyearlymark1) {
		this.finalyearlymark1 = finalyearlymark1;
	}
	...
	public String getNotebook_marks() {
		return notebook_marks;
	}
	public void setNotebook_marks(String notebook_marks) {
		this.notebook_marks = notebook_marks;
	}
	public String getSubject_enrich_marks() {
		return subject_enrich_marks;
	}
	public void setSubject_enrich_marks(String subject_enrich_marks) {
	...
	public String getPequeryId() {
		return pequeryId;
	}
	public void setPequeryId(String pequeryId) {
		this.pequeryId = pequeryId;
	}
	public String getNoStudentcount() {
		return noStudentcount;
	}
	public void setNoStudentcount(String noStudentcount) {
		this.noStudentcount = noStudentcount;
	}
	...
	public String getExamtypePrifix() {
		return examtypePrifix;
	}
	public void setExamtypePrifix(String examtypePrifix) {
		this.examtypePrifix = examtypePrifix;
	}
	...
	public double getOpeingBalance() {
		return opeingBalance;
	}
	public void setOpeingBalance(double opeingBalance) {
		this.opeingBalance = opeingBalance;
	}
	...
	public String getLocAddName() {
		return locAddName;
	}
	public void setLocAddName(String locAddName) {
		this.locAddName = locAddName;
	}
