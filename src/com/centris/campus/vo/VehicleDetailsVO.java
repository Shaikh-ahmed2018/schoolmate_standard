...
public class VehicleDetailsVO {
	...
	private String settingcapacity;
	private String fuelusedintheengine;
	...
	public String getFuelusedintheengine() {
		return fuelusedintheengine;
	}

	public void setFuelusedintheengine(String fuelusedintheengine) {
		this.fuelusedintheengine = fuelusedintheengine;
	}
