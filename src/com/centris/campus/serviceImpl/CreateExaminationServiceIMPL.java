...
public class CreateExaminationServiceIMPL {
	...
	public Map<String, String> getAccadamicYearsServiceImpl(UserLoggingsPojo custdetails) {
		...
		ArrayList<LstmsAccadamicYear> al = new CreateExaminationDaoImpl().getAccadamicYearsDaoImpl(custdetails);
	...
	public List getAllExamNames(CreateExaminationForm examform, UserLoggingsPojo custdetails) {
		...
		try {
			 examnamelist = new CreateExaminationDaoImpl()
					.getAllExamNames(examform,custdetails);
		} catch (Exception e) {
			logger.error(e);
			e.printStackTrace();
		}
	...
	public ArrayList<ExaminationDetailsVo> searchExamination(String searchName, UserLoggingsPojo userLoggingsVo) {
		...
		examlist= new CreateExaminationDaoImpl().searchExamination(searchName,userLoggingsVo);
