...
public class TeacherAttendanceServiceImpl implements TeacherAttendanceService {
	...
	public String getTotalStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		...
		return new TeacherAttendanceDaoImpl().getTotalStaffcount( userLoggingsVo ,  location_id) ;
	}

	public String getTotalPresentStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		
		return new TeacherAttendanceDaoImpl().getTotalPresentStaffcount( userLoggingsVo ,  location_id);
	}

	public String getTotalAbsentStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
	
		return new TeacherAttendanceDaoImpl().getTotalAbsentStaffcount( userLoggingsVo ,  location_id);
	}

	public String getTotalLeaveStaffcount(UserLoggingsPojo userLoggingsVo, String location_id) {
		return new TeacherAttendanceDaoImpl().getTotalLeaveStaffcount(userLoggingsVo ,  location_id);
	}
}
