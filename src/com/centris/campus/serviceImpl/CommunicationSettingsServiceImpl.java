...
public class CommunicationSettingsServiceImpl implements CommunicationSettingsService{
	...
	public ArrayList<UpcomingRemarksVO> getRemarksListDetailsService(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			...
			remarkslist = communicatedao.getRemarksListDetailsDao(userLoggingsVo);
	...
	public List<StreamDetailsVO> getStreamListDetailsService(UserLoggingsPojo custid) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		streamvo = communicatedao.getStreamListDetailsDao(custid);
	...
	public List<ClassPojo> getClassListDetailsService(ClassPojo pojo,UserLoggingsPojo userLoggingsVo) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		classpojo = communicatedao.getClassListDetailsDao(pojo,userLoggingsVo);
	...
	public ArrayList<UpcomingRemarksVO> searchRemarkDetailsService(
		...
		remarklist=communicatedao.getRemarkListDetailsDao(remrakvo, userLoggingsVo);
	...
	public ArrayList<LstmsUpcomingMeetingVO> getMeetingListDetailsService(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			...
			meetinglist = communicatedao.getMeetingListDetailsDao(userLoggingsVo);
	...
	public ArrayList<LstmsUpcomingMeetingVO> searchMeetingDetailsService(
		...
		ArrayList<LstmsUpcomingMeetingVO> meetinglist = null;
		meetinglist=communicatedao.searchMeetingListDetailsDao(meetingvo, userLoggingsVo);
	...
	public ArrayList<UpcomingBdayVo> getBdayDetailsService(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			...
			bdaylist = communicatedao.getBdayListDetailsDao(userLoggingsVo);
	...
	public ArrayList<UpcomingBdayVo> searchBdayDetailsService(
		...
		ArrayList<UpcomingBdayVo> bdaylist = null;
		bdaylist=communicatedao.searchBadyListDetailsDao(bdayvo, userLoggingsVo);
