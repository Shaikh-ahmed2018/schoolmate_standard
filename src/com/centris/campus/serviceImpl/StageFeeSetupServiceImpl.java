...
public class StageFeeSetupServiceImpl implements StageFeeSetupService{
	...
	@Override
	public ArrayList<StageFeeSetupVo> getStageFeeSetupDetails(String currentaccyear,UserLoggingsPojo userLoggingsVo) {
		...
		try {
			...
			feelist = dao.getStageFeeSetupDetails(currentaccyear,userLoggingsVo);
	...
	@Override
	public ArrayList<StageFeeSetupVo> getSearchStageFeeSetupDetails(String searchterm, String currentaccyear,UserLoggingsPojo userLoggingsVo) {
		logger.setLevel(Level.DEBUG);
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
		...
		try {
			...
			feelist = dao.getSearchStageFeeSetupDetails(searchterm,currentaccyear,userLoggingsVo);
	...
	public ArrayList<StageFeeSetupVo> getAllStages(
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StageFeeSetupServiceImpl : getAllStages Starting");
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StageFeeSetupServiceImpl : getAllStages Ending");
