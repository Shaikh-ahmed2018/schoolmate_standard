...
public class StudentEnquiryServiceImpl implements StudentEnquiryService {
	...
	public List<StudentEnquiryVo> getAllEnquiryDetails(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			allDetails = obj.getAllEnquiryDetails(userLoggingsVo);
		} catch (Exception e) {
	...
	public boolean validationPhoneno(String mobileno, String enq_Id) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentEnquiryServiceImpl: validationPhoneno  Starting");
		StudentEnquiryDao obj = new StudentEnquiryDaoImpl();
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentEnquiryServiceImpl: validationPhoneno  Ending");
		return status;
	}
	...
	public List<StudentEnquiryVo> getSearchEnquiryDetails(String text,UserLoggingsPojo userLoggingsVo) {
		...
		try {
			list = obj.getSearchEnquiryDetails(text,userLoggingsVo);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			e.printStackTrace();
		}
	...
	public List<StudentInfoVO> getStudentParentDetails(String usercode, UserLoggingsPojo custdetails,String accYears) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentEnquiryServiceImpl : getStudentParentDetails Starting");
		StudentEnquiryDao obj = new StudentEnquiryDaoImpl();
		List<StudentInfoVO> list = null;
		try {
			list = obj.getStudentParentDetails(usercode,custdetails,accYears);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			e.printStackTrace();
		}
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentEnquiryServiceImpl : getStudentParentDetails Ending");
		return list;
	}
	...
	public List<StudentAttendanceReportVo> getAttendanceDetail(String usercode, UserLoggingsPojo custdetails) {
		...
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.START_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentEnquiryServiceImpl : getAttendanceDetail Starting");
		StudentEnquiryDao obj = new StudentEnquiryDaoImpl();
		List<StudentAttendanceReportVo> list = null;
		try {
			list = obj.getAttendanceDetail(usercode,custdetails);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			e.printStackTrace();
		}
		JLogger.log(0, JDate.getTimeString(new Date())
				+ MessageConstants.END_POINT);
		logger.info(JDate.getTimeString(new Date())
				+ " Control in StudentEnquiryServiceImpl : getAttendanceDetail Ending");
		return list;
	}
	...
	public List<ExaminationDetailsVo> getDeclaredExam(String usercode, UserLoggingsPojo custdetails,String accYears) {
		...
		try {
			list = obj.getDeclaredExam(usercode,custdetails,accYears);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
			e.printStackTrace();
		}
