...
public class StaffServiceReportServiceImpl implements StaffServiceReportService{
	...
	public ArrayList<TeacherRegistrationPojo> getTeacherListDetailsService(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			...
			list = dao.getTeacherListDetailsDao(userLoggingsVo);
	...
	public ArrayList<TeacherRegistrationPojo> getTeacherListDetailsbyLocations(String locid, UserLoggingsPojo custdetails) {
		return  dao. getTeacherListDetailsbyLocations(locid,custdetails);
	}
