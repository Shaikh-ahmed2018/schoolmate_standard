...
public class ParentSettingsServiceServiceImpl implements ParentSettingsService {
	...
	public ArrayList<ParentFeedbackVo> getFeedBackDetailsService(
		...
		try {
			...
			fbvo1 = parentdao.getFeedBackDetailsDao(fbvo,custdetails);
	...
	public ArrayList<StudentAttendanceVo> getNextChildAttendanceMonthListService(
		...
		try {
			...
			list = parentdao.getNextChildAttendanceMonthListDao(year, month,studvo);
	...
	public String getsubjectfilepathService(String subid,UserLoggingsPojo custdetails) {
		...
		try {
			...
			path = parentdao.getsubjectfilepathDao(subid,custdetails);
	...
	public String deleteRequestLeaveBDService(String[] sno,String userid,String academic_year,LeaveRequestVo leavevo) {
		...
		try {
			...
			asslist = parentdao.deleteRequestLeaveDao(sno,userid,academic_year,leavevo);
	...
	public ArrayList<TimeTableVo> getStudentTimetableService(String studentid,UserLoggingsPojo custdetails) {
		...
		try {
			...
			timetablelist = parentdao.getStudentTimetableDao(studentid,custdetails);
	...
	public List<ViewallSubjectsVo> getLabDetails(ViewallSubjectsVo subvo) {
		return parentdao.getLabDetails(subvo);
	}

	@Override
	public ArrayList<ParentVO> getStudentAnalyticalPerformanceForParent(ParentVO vo) {
		return parentdao.getStudentAnalyticalPerformanceForParent(vo);
	}

	@Override
	public String SaveStudentAnalyticalPerformanceByParent(ParentVO obj) {
		return parentdao.SaveStudentAnalyticalPerformanceByParent(obj);
	}
