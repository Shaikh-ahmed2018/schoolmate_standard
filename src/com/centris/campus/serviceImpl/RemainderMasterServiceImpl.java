...

{
	...
	
	{
		...
		logger.info(JDate.getTimeString(new Date())
				+ " Control inRemainderMasterServiceImpl : getnamecount Ending");
	...
	public ArrayList<RemainderMasterVO> remainderdetails(RemainderMasterVO vo,UserLoggingsPojo userLoggingsVo) {
			...
			
		{
			...
			
			{
				...
				remainderdetails=obj_Remain.remainderdetails(vo,userLoggingsVo);
