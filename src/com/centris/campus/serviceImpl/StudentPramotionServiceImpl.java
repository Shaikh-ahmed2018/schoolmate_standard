...
public class StudentPramotionServiceImpl implements StudentPramotionService {
	...
	public List<AcadamicYearVO2> getAcadamicYear(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			yeardetailslist = new StudentPramotionDaoImpl().getAcadamicYear(userLoggingsVo);
	...
	public ArrayList<StudentPramotionVO> getpromotionslist(UserLoggingsPojo userLoggingsVo) {
		...
		try {
			yeardetailslist = new StudentPramotionDaoImpl().getpromotionslist(userLoggingsVo);
		} catch (Exception exception) {
			exception.printStackTrace();
			logger.error(exception);
		}
	...
	public List<ClassPromotionList> getClassListForPromotion(String currentYear,UserLoggingsPojo userLoggingsVo) {
		return new StudentPramotionDaoImpl().getClassListForPromotion(currentYear,userLoggingsVo);
	}
}
