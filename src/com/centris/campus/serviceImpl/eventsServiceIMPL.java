...
public class eventsServiceIMPL {
	...
	public String deleteEventRegistration(String id,String log_audit_session) {
		return eventdaoimpl.deleteEventRegistration(id,log_audit_session);
	}
	...
	public String deleteCategory(String id,String log_audit_session) {
		return eventdaoimpl.deleteCategory(id,log_audit_session);
	}
	...
	public String deleteStage(String id,String log_audit_session) {
		return eventdaoimpl.deleteStage(id,log_audit_session);
	}
	...
	public String deleteCriteria(String id,String log_audit_session) {
		return eventdaoimpl.deleteCriteria(id,log_audit_session);
	}
	...
	return eventdaoimpl.deleteGreenRoom(id,log_audit_session);
	}
	...
	public String deleteProgram(String id,String log_audit_session) {
		return eventdaoimpl.deleteProgram(id,log_audit_session);
	}
	...
	public String deletePrize(String id,String log_audit_session) {
		return eventdaoimpl.deletePrize(id,log_audit_session);
	}
	...
	public String deleteEventStudReg(String id,String log_audit_session) {
		return eventdaoimpl.deleteEventStudReg(id,log_audit_session);
	}
	...
	public String deleteProgramScheduling(String id,String log_audit_session) {
		return eventdaoimpl.deleteProgramScheduling(id,log_audit_session);
	}
	...
	public ArrayList<eventRegVo> getEventIdPrintList(String evId,String catId, String regNo,String accyear) {
		return eventdaoimpl.getEventIdPrintList(evId, catId,regNo, accyear);
	}
	...
	public String deleteProgramNumber(String[] id,String log_audit_session) {
		return eventdaoimpl.deleteProgramNumber(id,log_audit_session);
	}
...
/*	public ArrayList<eventRegVo> getprogramlist(String cat_id, String evId) {
	...
	public String deletevolanteer(String id,String log_audit_session) {
		return eventdaoimpl.deletevolanteer(id,log_audit_session);
	}
	...
	public ArrayList<eventRegVo> getEventStudentMeritListByProgramme(
			String evId, String progId, String catId, String houseId,
			String accId, int place) {
		return eventdaoimpl.getEventStudentMeritListByProgramme(evId,progId,catId,houseId,accId,place);
		}
	...
	public ArrayList<eventRegVo> getEventStudentOverallResult(String evId,
			String progId, String catId, String houseId, String accId) {
		return eventdaoimpl.getEventStudentOverallResult(evId,progId,catId,houseId,accId);
		}
