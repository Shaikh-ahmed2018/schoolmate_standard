...
/* Procedure structure for procedure `getNumberOFStudentCount` */
DELIMITER //

CREATE PROCEDURE `getNumberOFStudentCount`()
BEGIN
SELECT COUNT(*) FROM `campus_student` WHERE `student_status_var`="active";
	END //
