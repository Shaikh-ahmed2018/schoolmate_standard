...
<body>
	<div class="col-md-2 leftmenu" style="padding:0;">

		<div class="panel panel-primary"
			style="border: none; margin: 1px 0px; box-shadow: none;">
			...
			<div id="menucollapseOne" class="accordion-body collapse in">
				<div class="panel-body">
					<ul class="nav nav-pills nav-stacked">
						...
						<li><a href="parentMenu.html?method=leaveRequest">Leave Request & Status</a></li>
