...
<body>
				...
				<div class="panel-heading leftNav" role="tab" id="headingTwo">
					<h3 class="panel-title">
						...
						<a class="collapsed" role="button" data-toggle="collapse"
							data-parent="#accordion" href="#menucollapseTwo"
							style="color: #000000" aria-expanded="false" > <i
							class="glyphicon glyphicon-equalizer sideMenuIcon"></i>
							<h3 class="panel-title active">
								Master<i class="glyphicon glyphicon-triangle-bottom dropdowns"></i>
							</h3>
						</a>

					</h3>
				</div>
				<div id="menucollapseTwo" class="panel-collapse collapse in"
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									property="permissionmap" scope="session">
									<logic:equal value="LIBCTDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
							...
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									property="permissionmap" scope="session">
									<logic:equal value="LIBGSDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading leftNav" role="tab" id="headingOne">
					<h3 class="panel-title" id="beforeparent">
						<a data-toggle="collapse" data-parent="#accordion" href="#menucollapseOne"><i class=" fa fa-align-center sideMenuIcon"></i>
							<h3 class="panel-title active">
								Library&nbsp;&nbsp;<i
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									property="permissionmap" scope="session">
									<logic:equal value="LIBRJSDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
 ...
 --%>
							...
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									property="permissionmap" scope="session">
									<logic:equal value="LIBRMSDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
			...
			<div class="panel panel-primary">
				<div class="panel-heading leftNav" role="tab" id="headingThree">
					...
					<h3 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#menucollapseThree"> <i class=" fa fa-exchange sideMenuIcon"></i>
							<h3 class="panel-title active">
								Transactions&nbsp;&nbsp;<i
									class="glyphicon glyphicon-triangle-bottom dropdowns"></i>
							</h3>
			...
			<div class="panel panel-primary">
				<div class="panel-heading leftNav" role="tab" id="headingFour">
					<h3 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#menucollapseFour"> <i
							class="material-icons sideMenuIcon">receipt</i>
							<h3 class="panel-title active">
								Reports &nbsp;&nbsp;<i
									class="glyphicon glyphicon-triangle-bottom dropdowns"></i>
							</h3>
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									property="permissionmap" scope="session">
									<logic:equal value="LIBJSRPDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
							...
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									property="permissionmap" scope="session">
									<logic:equal value="LIBNWRPDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
 ...
 --%>
								...
								<logic:iterate id="daymap" name="UserDetails"
									...
									<logic:equal value="BKUDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="LibraryMenu.html?method=groupregistration">Group
													Registration</a></li>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
			...
			<!-- END ID CARD DESIGN PHASE-------------------------------------------------------------------------- -->
			<!-- 		<div class="panel panel-primary" style="margin: -1px 0px;">
				<div class="panel-heading leftNav" role="tab" id="headingThree"
					>
					<h3 class="panel-title">
						<a href="#"
