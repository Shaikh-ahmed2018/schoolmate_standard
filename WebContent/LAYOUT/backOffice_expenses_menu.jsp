							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="EXMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="menuslist.html?method=inflowslist">Inflows Accounts</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="EXMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="menuslist.html?method=revelist">Revenue Details</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="EXMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="menuslist.html?method=expenseslist">Expenses Details</a></li>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="EXMTMDIS" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
										...
										<li><a href="menuslist.html?method=getTransactionDetails">Bank
												Transactions</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="EXMTMDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">	
											...
											<li><a href="menuslist.html?method=getTransactionDetails">Bank Transactions</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="EXMTMDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">	
											...
											<li><a href="menuslist.html?method=getSummaryDetails">Account Summary</a></li>
