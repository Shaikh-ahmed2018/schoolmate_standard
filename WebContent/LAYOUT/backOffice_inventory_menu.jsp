								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="STRDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="menuslist.html?method=InventoryTypeList">Inventory Types</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="CLSDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="menuslist.html?method=InventoryList">Inventory List</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="SECDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<li><a href="menuslist.html?method=AddorModifyorDeleteList">Add/Delete/Modify</a></li>
								...
								<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="IJPDIS" name="daymap" property="key">
										...
										<li><a href="menuslist.html?method=TransactionList">Transaction</a></li>
							...
							<div class="panel-heading leftNav" role="tab" id="headingThree" style="background: #07AAB9;">
							  <h3 class="panel-title">
								<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#menucollapseThree"  style="color:#000000" aria-expanded="false" aria-controls="collapseTwo">
								  <h3 class="panel-title active">Inventory Report<i class="glyphicon glyphicon-triangle-bottom dropdowns"></i></h3>
								</a>
									 ...
									 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
										<logic:equal value="RPMDIS" name="daymap" property="key">
											<logic:equal value="true" name="daymap" property="value">	
												...
												<li><a href="menuslist.html?method=usageReport">Usage Report</a></li>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="PWMDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">	
											...
											<li><a href="menuslist.html?method=notReturnedReport">Not Returned Report</a></li>
