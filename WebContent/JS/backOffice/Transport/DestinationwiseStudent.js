...
$(document)
		.ready(
				function() {
					...
					if(urlLink=="menuslist.html?method=studentDestList"){
						$("#tabletxt").delay(1000).slideUp("slow");
						$("#searchs").delay(1000).show("fast");
					}
					$("#searchs")
					.click(
							function()
					...
					.click(
							function() {
								...
								window.location.href = 'menuslist.html?method=destinationWiseStudentXL';
								
							});
					$("#pdfDownload").click(function(){
            			
            			window.location.href = "menuslist.html?method=destinationWiseStudentDetailsPDF"
