...
// maping item type//
					...
					$("#department").change(function(){
						...
						$.ajax({
							...
							type : "POST",
							url : "menuslist.html?method=getItemtypeByDepartmnet",
					...
					.click(
...

							{
								...
								window.location.href = "menuslist.html?method=AddorModifyorDeleteList&searchname="
										+ searchname;
									...
									function() {
										...
										if (department == ""|| department == null) {
											...
											setTimeout(function(){
																	...
																	window.location.href = "menuslist.html?method=AddorModifyorDeleteList";
