$(document).ready(function() 
									...
									.ajax({
										...
										success : function(response) {
											...
											if (result.jsonResponse == "Remainder Details Deleted Successfully")
											{
												...
												window.location.href = "menuslist.html?method=remainderdetails&result="+ result.jsonResponse;
	...
	.click(
			...
			
			{
				...
				window.location.href = "menuslist.html?method=remainderdetails&searchvalue="+ searchvalue;
