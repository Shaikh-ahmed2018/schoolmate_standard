$(document).ready(function() {
	...
	$("#remarktype").change(function() {
		...
		if (remarktype == "meeting") {
			$(".meeting").show();
			window.location.href = "menuslist.html?method=getmeeting";
			
		}
	
		if (remarktype == "bday") {
			$(".birthday").show();
			window.location.href = "menuslist.html?method=getbdaylist";
			
		}
	
		if (remarktype == "remainder") {
			/*$(".birthday").show();*/
			window.location.href = "menuslist.html?method=remainderdetails";
