...
$(document).ready(function () {
	...
	$("#back1").click(function(){
		window.location.href = "menuslist.html?method=NewstudentIdCardDesign&historyaccyear="+$("#historyaccyear").val()+"&historyschoolId="+$("#historyschoolId").val()+"&historystreamId="+$("#historystreamId").val();
	});
	...
	$("#schoolName").dblclick(function(){
		...
		$("#saveChanges").click(function(){
			...
			var mainCss=cssgroup.toString().replace(/,/g,"");
			 $.ajax({
				 type: 'POST', 
				  url: "menuslist.html?method=IdDesign",
		...
		$(".main-div span").bind("contextmenu",function(e){
			...
			$(".main-div div[id]").bind("contextmenu",function(e){
				...
				$(".section .ui-draggable").click(function(e){
					ids=[];
