$(document).ready(function(){
	...
	if(pageurl=="menuslist.html?method=electionListForVoting"){
		$(".navbar-right").remove();
...
function getElectionList(){
	...
	$.ajax({
		type :'POST',
		url :"menuslist.html?method=getElectionList",
		data : dataList,
		async : false,
...
function rowClickable(){
	$("#allstudent tbody tr").click(function(){
		...
		if(pageurl=="menuslist.html?method=electionListForVoting"){
			window.location.href="menuslist.html?method=voterMachineStart&accyear="+accyear+"&group="+group+"&titleID="+titleID;
		}
		else{
