...
.ready(
		function() {
			...
			$(".Checkbox_Class").change(function(){
				if($(".Checkbox_Class").length==$(".Checkbox_Class:checked").length){
						...
						success : function(data) {
							...
							if (result.status == "success") {
								...
								setTimeout(function() {
									...
									window.location.href = "menuslist.html?method=careerupdate";
			...
			$("#plus").click(function() {
				window.location.href = "menuslist.html?method=addJob";
			});
