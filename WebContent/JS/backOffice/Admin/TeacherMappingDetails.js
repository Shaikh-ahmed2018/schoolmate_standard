...
$(document).ready(function() 
									...
									.ajax({
										...
										success : function(response) {
											...
											if (result.jsonResponse == "Term Details Deleted Successfully")
											{
												...
												window.location.href = "menuslist.html?method=termList&result="+ result.jsonResponse;
	...
	.click(
			...
			
			{
				...
				window.location.href = "menuslist.html?method=termList&searchvalue="+ searchvalue;
