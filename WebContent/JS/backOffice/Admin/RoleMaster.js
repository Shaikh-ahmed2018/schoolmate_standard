$(document).ready(function() {
					...
					$('#back1').click(function() {
						window.location.href="menuslist.html?method=roleList";
					});
					...
					if($("#hiddenadmin").val()=="Y"){
						$("#isadministrator").prop("checked",true);
					}
					
					$(".roleDetails_Checkbox_Class").change(function(){
						if($(".roleDetails_Checkbox_Class").length==$(".roleDetails_Checkbox_Class:checked").length){
					...
					$('#save').click(function() {
								...
								if (role_Code=="") {
									if(rolename==""){
										...
										$('.validateTips').text("Field Required - Role Name");
										$("#rolename").focus();
					        	  ...
					        	  var role = {
									...
									$.ajax({
												...
												success : function(
													...
													if(result.status=="Role removed successfully"){
				...
				$("#search").click(function(){
					...
					window.location.href="menuslist.html?method=roleList&searchTerm="+searchTerm;	
				});
				
				
				
				if($("#hadministrator").val()!="" && $("#hadministrator").val()!= undefined){
