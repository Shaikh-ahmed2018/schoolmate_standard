$(document).ready(function(){
	...
	$("#back1").click(function(){
		window.location.href="menuslist.html?method=getUserRecords&typename="+
		$("#typename1").val()+"&status="+$("#status1").val()+"&searchTextId="+$("#searchTextId1").val();
	});
		...
		return false;
		 ...
		 $
			.ajax({
				...
				data :{"selectUser":selectUser,"confirmpasswrd":confirmpasswrd,"hiddentechId":hiddentechId},		
