$(document).ready(function(){
	...
	$("#back1").click(function(){
		window.location.href="houseSettings.html?method=generateHouse&historyaccyear="+$("#historyaccyear").val()+
	...
	$("#back").click(function(){
		...
		if($("#filter").val() != "" && $("#filter").val() != null){
         ...
         if(selection1==undefined){
        	 window.location.href="houseSettings.html?method=generateHouse";
         }
         else if(selection == "Name Wise"){
