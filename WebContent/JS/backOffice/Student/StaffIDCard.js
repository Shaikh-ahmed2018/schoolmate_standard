...
function rowClickable(){
	$("#allstudent tbody tr").click(function(){
		...
		window.location.href="menuslist.html?method=PrintStaffIDCard&accyear="+$(this).attr("class").split(" ")[0]
		+"&schoolId="+$(this).attr("class").split(" ")[1]+"&departmentId="+$(this).attr("class").split(" ")[2]
		+"&historydepartmentId="+$("#department").val();
...
$("#allstudent tbody tr").click(function(){
			...
			window.location.href="menuslist.html?method=PrintStaffIDCard";
