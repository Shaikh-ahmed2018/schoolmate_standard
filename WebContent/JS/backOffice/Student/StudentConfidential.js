$(document).ready(function(){
	...
	$("#allstudent tbody tr").click(function(){
		...
		window.location.href="menuslist.html?method=AddStudentConfidentialReport&studentId="+student_Id[0]+
		...
		+"&branchName="+$("#locationname").find(":selected").text();
	...
	$.ajax({
		...
		success : function(response) {
			...
			var result = $.parseJSON(response);
				...
				$("#allstudent tbody tr").click(function(){
					var student_Id = $( this ).find(".studentid").attr("class").split(" ");
					window.location.href="menuslist.html?method=AddStudentConfidentialReport&studentId="+student_Id[0]+"&accyear="+student_Id[1]+
