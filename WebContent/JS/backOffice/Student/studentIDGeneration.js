										...
										if (bValid) {
											$(".errormessagediv").hide();
													...
													$
															.ajax({
																type : 'POST',
																url : "menuslist.html?method=searchStudent",
																data : datalist,
																success : function(
																		response) {
																	var result = $
							...
							.click(
									...
									if(stuIdArray.length>0){
										var jdata={"AccId":$("#acadamicyear").val(),
										 ...
										 $.ajax({
											 type: 'POST', 
											  url: "menuslist.html?method=studentIdCreationPrint",
									          data:jdata,
											  ...
											  success: function(response) {
												...
												if(result.studentList.length>0){
													...
													$("#div").append('<section class="col-md-4 section">'
															...
															+'<span class="name" id="name">Name :</span><span class="name1">'+result.studentList[i].stuName+'</span>'
															+'</div>'
															...
															+'<span class="label">Class/Div</span><span>'+result.studentList[i].className+'</span>'
															+'</div>'
															...
															+'<span class="addresss">Address :</span><span>'+result.studentList[i].adress+'</span>'
															+'</div>'


															+'<div class="phonedetails" id="phonedetails">'
															+'<span class="phones">Ph:</span><span>'+result.studentList[i].phone+'</span>'
															+'</div>'
					     ...
					     buttons : {
					    	 ...
					    	 "A4 Size" : function() {
					    		 var a=$("#printing-css").val();
					    	        ...
					    	        frameDoc.document.write('<link href="CSS/IdCard.css" rel="stylesheet" type="text/css" />');
