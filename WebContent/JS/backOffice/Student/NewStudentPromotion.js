...
$(document).ready(function() {
    ...
    $("#back1").click(function(){
		window.location.href="menuslist.html?method=NewstudentPromotionList&tabstatus="+$("#tabstatus").val()
	...
	$("#addnew").click(function(){
		...
		window.location.href="menuslist.html?method=getStudentForPromotion";
	...
	$(".promoted").click(function(){
		...
		window.location.href="menuslist.html?method=studentPromotionPage";
...
function getClassList(){
	...
	$.ajax({
		...
		success : function(response) {
			...
			$("#classname option[value='CCD15']").remove();
		}
	...
	$.ajax({
		...
		success : function(response) {
			...
			$("#allstudent").append("<tr>"
					...
					+"<th>Status</th>"
					+"<th>New Division</th>"
					+"<th style='width:19%;'>New Specilization</th>"
					+"</tr>");
...
function getEachRowRecord(){
	$(".settingpromotion").click(function(){
		...
		window.location.href="menuslist.html?method=studentPromotionPage&studentId="+studentId+"&accyear="+academicyearid+"&locationId="+locationId;
	    		 ...
	    		 $.ajax({
	    			 ...
	    			 success:function(response){
	    				 ...
	    				 if(result.expense_Result == "success"){
	    					 ...
	    					 $('.validateTips').css({ 'visibility' : 'visible',});
