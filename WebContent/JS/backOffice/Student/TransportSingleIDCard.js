...
$(document).ready(function(){
	...
	$("#allstudent tbody tr").click(function(){
		...
		window.location.href="menuslist.html?method=PrintTransportIDCardSingle&studentId="+student_Id[0]+"&accyear="+student_Id[1]+"&locationId="+student_Id[2];
...
function getStudentListBySection(locationid,accyear,classname,sectionid){
	...
	datalist = {
			...
			type : 'POST',
			url : "menuslist.html?method=getStudentListforPrint",
			data : datalist,
			async : false,
