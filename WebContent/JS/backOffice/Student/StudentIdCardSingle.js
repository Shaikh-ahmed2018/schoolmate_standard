...
$(document).ready(function(){
	...
	$("#allstudent tbody tr").click(function(){
		...
		window.location.href="menuslist.html?method=PrintStudentSingleIDCard&studentId="+student_Id[0]+"&accyear="+student_Id[1]+"&locationId="+student_Id[2];
	});
			...
			success : function(response) {
				...
				var result = $.parseJSON(response);
					...
					$("#allstudent tbody tr").click(function(){
						...
						window.location.href="menuslist.html?method=PrintStudentSingleIDCard&studentId="+student_Id[0]+"&accyear="+student_Id[1]+"&locationId="+student_Id[2];
						//window.location.href="menuslist.html?method=PrintStudentSingleIDCard";
					});	
					
				/*	function rowClickable(){
						$("#allstudent tbody tr").click(function(){
							
							window.location.href="menuslist.html?method=PrintTransportIDCardSingle&accyear="+$(this).attr("class").split(" ")[0]+"&schoolId="+$(this).attr("class").split(" ")[1]+"&designationId="+$(this).attr("class").split(" ")[2];
...
datalist = {
			...
			success : function(response) {
				...
				/*	$("#allstudent tbody tr").click(function(){
						...
						window.location.href="menuslist.html?method=PrintTransportIDCardSingle";
