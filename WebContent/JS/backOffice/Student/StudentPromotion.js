		...
		.ready(
				function() {
					...
					$("#searchButtonId").click(function(){
						...
						window.location.href="menuslist.html?method=studentPromotionSearchList&className="+className+"&sectionName="+sectionName;	
														...
														$
																.ajax({
																	...
																	success : function(
																		...
																		window.location.href = "menuslist.html?method=studPromotion&notptomotedStudentList="
																				+ result.RESULT;
