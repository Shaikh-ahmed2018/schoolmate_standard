...
function rowClickable(){
	$("#allstudent tbody tr").click(function(){
		...
		window.location.href="menuslist.html?method=StaffSingleIDCardPrint&teacherID="+$(this).attr("class").split(" ")[0]+"&accyear="+$(this).attr("class").split(" ")[1]+"&locationId="+$(this).attr("class").split(" ")[2]+"&departmentId="+$(this).attr("class").split(" ")[3]+"&designationId="+$(this).attr("class").split(" ")[4];
