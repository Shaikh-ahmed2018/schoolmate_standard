		...
		.ready(
				function() {
					...
					$("#back1").click(function(){
						window.location.href="menuslist.html?method=PrintStudentMultipleIDCard&historyacademicId="+$("#historyacademicId").val()
						+"&historylocId="+$("#historylocId").val()+"&historystreamId="+$("#historystreamId").val()+
