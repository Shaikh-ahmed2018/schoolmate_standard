...
$("#dates").change(function(){
	...
	$("#excelDownload").click(function(){
		window.location.href ='LibraryMenu.html?method=overdueReportExcel&schId='+$("#locationName").val()+'&schname='+$("#locationName option:selected").text();
	});
	$("#pdfDownload").click(function(){
			window.location.href = 'LibraryMenu.html?method=overdueReportPDF&schId='+$("#locationName").val()+'&schname='+$("#locationName option:selected").text();
	  });
