$(document).ready(function(){
	...
	if($("#hiddenAmountStatus").val() == "PAID"){
		$("#status option[value='PAID']").attr('selected', true);
	}
	else if($("#hiddenAmountStatus").val() == "UNPAID"){
	...
	$('#schoolName option').each(function(){
		if ($("#schoolName").val() !="" || $("#schoolName").val() !="all") {
			getLibraryLocation();
		}
	});
	...
	if($("#historysubscriberType").val()!="" && $("#historysubscriberType").val()!=undefined){
		$("#back1").show();
		$("#updatesubscriber").show();
	...
	$("#locationName").click(function(){
		if($("#schoolName").val()==""){
			showError("#schoolName","Select Branch Name");
		}
	});
	...
	$("#save").click(function(){
		...
		if (schoolName == "" || schoolName == null) {
			showError("#schoolName","Enter Branch");
			return false;
		} 

		else if (locationName == "" || locationName == null) {
			showError("#locationName","Enter Library Branch ");
			return false;
		} 
		else
			if(subscriberNo=="" || subscriberNo==null){
				showError("#subscriberNo","Field-Required Subscriber Number");
				return false;
			}
			...
			else if($("#depositType").val()=="Cash" && $("#enterAmount").val()==""){
				showError("#enterAmount","Enter The Valid Amount");
				return false;
			}
			else if($("#depositType").val()=="Card" && $("#cardNo").val()==""){
				showError("#cardNo","Enter Valid Card Number");
				return false;
			}
			else if($("#depositType").val()=="Check" && $("#Check").val()==""){
				showError("#Check","Enter Valid Check Number");
				return false;
			}

			else if($("#depositType").val()=="Check" && $("#enterAmount").val()==""){
				showError("#checkNoAmount","Enter Valid Amount to be paid by Check");
				return false;
			}
			else if($("#depositType").val()=="Card" && $("#enterAmount").val()==""){
	...
	$("#update").click(function(){
		...
		if (locationName == "" || locationName == null) {
			showError("#locationName","Enter Branch");
			return false;
		} 
	...
	$("#status").change(function(){
		  if($("#hiddenusetype").val()!="" && $("#hiddenusetype").val()!=null && $("#hiddenusetype").val()!=undefined){
		    	$("#save").hide();
		    }else{
		    	$("#save").show();
		    }
