$(document).ready(function()
{
	...
	$("#add").click(function(){
		window.location.href = "LibraryMenu.html?method=addLibraryLocations&historylocId="+$("#locationname").val();
	}); 
...
$("#dialog").dialog(
	{
		...
		$.ajax({
			...
			success:function(response){
				...
				$(".validateTips").text("Selected Record is Mapped Cannot Delete");
