$(document).ready(function() {
	...
	if($("input[name='requested_by']:checked").val()=="studentwise"){
		$(".class").show();
		$(".division").show();
	...
	$("input[name='requested_by']").change(function(){
		...
		$("#excelDownload").click(function(){
			...
			window.location.href ='LibraryMenu.html?method=getSubscriberDetailExcelReport&type=excel'+"&accyear="+accyear+"&locId="+$("#locationname").val()+"&locationname="+$("#locationname option:selected").text();
			locationname
		});

		$("#pdfDownload").click(function(){
			var accyear = $("#accyear option:selected").text().trim();
			window.location.href ='LibraryMenu.html?method=getSubscriberDetailExcelReport&type=pdf'+"&accyear="+accyear+"&locId="+$("#locationname").val()+"&locationname="+$("#locationname option:selected").text();
