...
$(document).ready(function(){
	...
	$("#gobutton").click(function(){
		...
		var orderby=$("input[name='subscriber_by']:checked").val();
		var search=$("#searchValue").val(); 
		var historyclassname = $('#classname').val();
		var historysectionid = $('#sectionid').val(); 
		var historydepartment = $('#department').val();
		var historydesignation = $('#designation').val();
		...
		if((subscriberId==undefined || subscriberId==" ")){
			...
			window.location.href ="LibraryMenu.html?method=gotosubscribersDetails&subId="+subscriberId+
			"&location="+location+"&accyear="+accyear+"&subscriberType="+subscriberType+
			"&historygoto="+selection+"&historystartedby="+startedby+"&historysearch="+search+
			"&historyorderby="+orderby+"&historyclassname="+historyclassname+"&historysectionid="+historysectionid
			+"&historydepartment="+historydepartment+"&historydesignation="+historydesignation+"&historylocId="+locid;
		}
		else if(selection=="issuestate"){
			window.location.href ="LibraryMenu.html?method=IssueStatementBySubScriberType&subId="+subscriberId+
			"&location="+locid+"&accyear="+accyear+"&subscriberType="+subscriberType+
			"&historygoto="+selection+"&historystartedby="+startedby+"&historysearch="+search+
			"&historyorderby="+orderby+"&historyclassname="+historyclassname+"&historysectionid="+historysectionid
			+"&historydepartment="+historydepartment+"&historydesignation="+historydesignation+"&historylocId="+locid;
		}
		else if(selection=="issuereturn"){
			window.location.href ="LibraryMenu.html?method=IssueReturnBySubScriberType&subId="+subscriberId+
			"&location="+locid+"&accyear="+accyear+"&subscriberType="+subscriberType+
			"&historygoto="+selection+"&historystartedby="+startedby+"&historysearch="+search+
			"&historyorderby="+orderby+"&historyclassname="+historyclassname+"&historysectionid="+historysectionid
			+"&historydepartment="+historydepartment+"&historydesignation="+historydesignation+"&historylocId="+locid;
	...
	if($("#historysubscriberType").val()!="")
	{
		$("input[name='requested_by'][value='"+$("#historysubscriberType").val()+"']").prop('checked', true);
		$("input[name='subscriber_by'][value='"+$("#historyorderby").val()+"']").prop('checked', true);
		$("input[name='started_by'][value='"+$("#historystartedby").val()+"']").prop('checked', true);
		...
		if($("input[name='requested_by']:checked").val()=="Student"){
			...
			$("#designation").val($("#historydesignation").val());
			staffsearch();
			stafforderby()
			if(startwith=="startwith"){
...
function stafforderby(){
	$("input[name='subscriber_by']").change(function(){
		if($("input[name='subscriber_by']").val()=="subscriberno")
		{
			getStaffListDetails();
		}
		else if($("input[name='subscriber_by']").val()=="subscribername")
		{
			getStaffListDetails();
		}
	});
