$(document).ready(function(){
	...
	$("#back1").click(function(){
	    window.location.href ="LibraryMenu.html?method=IssueStatementBySubScriberType&historysubscriberType="+$("#historysubscriberType").val()
	...
	$("#Fromdate").datepicker({
		...
		$("input[name='requested_by']").change(function(){
			...
			$("#hiddencontactno,#hiddenotheraddr,#hiddendepartment,#hiddendesignation").val("");
