$(document).ready(function(){
	...
	/*$(".section").each(function(){
		...
		qrcode.makeCode("Name:"+$(this).find("#stunm").text()+
				" AdmissionNo:"+$(this).find("#admno").text()+
				" Class:"+$(this).find("#cls").text()+
				" Roll No.:"+$(this).find("#rolno").text()+
				" Event Name:"+$(this).find("#evenm").text()+
				" Event Category:"+$(this).find("#evecat").text()+
				" Program Name:"+$(this).find("#prognm").text());
				" Phone No.:"+$(this).find("#faterName").text()+
				" :"+$(this).find("#motherName").text()+
	...
	$('#goPage').click(function(){
		...
		if(forwardPage=='adm_Form'){
			...
			//alert('id');
			window.location.href="menuslist.html?method=NewstudentIdCardDesign";
...
function singleprint(){
  ...
  frame1.css({ "position": "absolute", "top": "-2000000px" });
  $("body").append(frame1);
  ...
  frameDoc.document.write('<link href="CSS/IdCard/Event IdCard.css" rel="stylesheet" type="text/css" />');
