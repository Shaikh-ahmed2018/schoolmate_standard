$(document).ready(function() {
	...
	$("#back1").click(function(){
		...
		"&Itdeclaration="+$("#Itdeclaration").val();
	});
	...
	$("#submit").click(function() {
		...
		$.ajax({
			type : "POST",
			url : "staffemployement.html?method=saveStaffIncomeTaxTDSDeductionDetails",
			...
			success : function(data) {
				...
				if(result.status == "true"){
					...
					$(".validateTips").text("IT Declaration Saved Successfully...");
					setTimeout(function() {
						window.location.href="menuslist.html?method=staffEmployementList&historylocId="+$("#historylocId").val()+
						"&historydepartment="+$("#historydepartment").val()+"&historysearchname="+$("#historysearchname").val()+
						"&Itdeclaration="+$("#Itdeclaration").val();
					...
					$(".validateTips").text("IT Declaration Not Saved Successfully,Try later...");
					setTimeout(function() {
						window.location.href="menuslist.html?method=staffEmployementList&historylocId="+$("#historylocId").val()+
						"&historydepartment="+$("#historydepartment").val()+"&historysearchname="+$("#historysearchname").val()+
						"&Itdeclaration="+$("#Itdeclaration").val();
...
function getTotalTax(){
	var taxableincome=Number($('#tdsctc').val())-Number($('#tdspt').val())-Number($('#totalSectionAmount').val())-Number($('#totalChapter80U').val())-Number($('#totalChapter').val())+Number($('#totalofOtherIncome').val());
...
function getHraCalculation(){
	...
	var ismetro=$('#ismetro').val();
	var foutyper=((basicperYear/100) * ismetro).toFixed(2);
