$(document).ready(function() {
					$(".section").each(function(){
						...
						qrcode.makeCode("Name:"+$(this).find("#nametext").text()+
								" Abbravative:"+$(this).find("#abbrativeText").text()+
								" Department:"+$(this).find("#regNotext").text()+
								" Designation:"+$(this).find("#degIdtext").text()+
								" Valid Upto:"+$(this).find("#validUptotext").text()+
								" Phone No.:"+$(this).find("#phonetext").text());
					});
					
		$("#back1").click(function(){
			window.location.href="menuslist.html?method=printMultiStaffIDCardDesign&historyacademicId="+$("#historyacademicId").val()
			+"&historylocId="+$("#historylocId").val()+"&historysearchvalue="+$("#historysearchvalue").val()+
			"&historydepartId="+$("#historydepartId").val()+"&historydesigId="+$("#historydesigId").val();
		});
