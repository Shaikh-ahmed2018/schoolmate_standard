$(document).ready(function(){
	...
	$("#next").click(function(){
		...
		$("#rowid"+currMonthDay+currMonthVal+currentdate.getFullYear() +" td:nth-child(1)").append("<span class='todayHilight primarythemecolor'>Today</span>");	
...
function getComments(){
	...
	$.ajax({
		type:'POST',
		url:'menuslist.html?method=getDairy',
		async:false,
