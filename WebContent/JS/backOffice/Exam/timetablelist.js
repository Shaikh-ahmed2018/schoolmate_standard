$(document).ready(function(){
	...
	$("#allstudent tbody tr").click(function(){
		...
		"&locid="+locid+"&historyaccyear="+$("#accyear").val()+"&historylocation="+$("#location").val();*/
		$('#myValue').val(accyear+","+locid+","+$("#accyear").val()+","+$("#location").val());
		$('#myform').submit();
	});
	
	
	if($("#historyaccyear").val()!="" ||$("#historylocation").val()!=""){
			...
			success : function(response) {
				...
				var result = $.parseJSON(response);
					...
					$("#allstudent tbody").append("<tr>"
							...
							+"<td><span class='"+result.examTimeTableListYear[i].status+"'>"+result.examTimeTableListYear[i].status+"</span></td>"
							+"</tr>");
					}	
					...
					$(".numberOfItem").empty();
			        $(".numberOfItem").append(" No. of Records  "+result.examTimeTableListYear.length);
