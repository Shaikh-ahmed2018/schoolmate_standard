...
<script type="text/javascript"
	src="JS/backOffice/Parents/MeetingAndEvent.js"></script>
...
<body>
	...
	<div class="col-md-10"
		...
		<input type="hidden" name="parenthidden" id="parenthidden"
			value="<logic:present name="parenthiddenid" ><bean:write name="parenthiddenid" property="parentID"/></logic:present>" />
