...
<script type="text/javascript"
	src="JS/backOffice/Parents/viewExamDetails.js"></script>
...
<body>
	<div class="col-md-10"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Exam Time-Table Details</span>
		</p>
					...
					<div class="panel-body">
							...
							<div class="form-group clearfix">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control" id="sectionName" readonly="readonly"
										value="<logic:present name="examlist"><bean:write name="examlist" property="examid"></bean:write></logic:present>" />
								</div>
							</div>
							</div>
						</div>
						<div class="col-md-12" style="margin-top: 5px;">
							<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control" id="sectionName"readonly="readonly" placeholder=""
										value="<logic:present name="examlist"><bean:write name="examlist" property="startdate"></bean:write></logic:present>" />
								</div>
								</div>
							</div>
						<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;">
							<div class="form-group clearfix">
								...
								<div class="col-xs-6">
									<input type="text" class="form-control" id="sectionName"readonly="readonly" placeholder=""
										value="<logic:present name="examlist"><bean:write name="examlist" property="endate"></bean:write></logic:present>"/>
								</div>
							</div>
						</div>						
					</div>
