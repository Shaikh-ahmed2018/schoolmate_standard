...
<script type="text/javascript" src="/JS/backOffice/Parents/SyllabusDetails.js"></script>
...
<body>
	...
	<div class="col-md-10" style="font-family: Roboto Medium; font-size: 20pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; margin-top: -6px;">
		...
		<div class="col-md-8" id="div2">
			<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span id="pageHeading">Syllabus Details</span>
			</p>
		</div>
		...
		<input type="hidden" id="hspecid" value="<logic:present name="studentData"><bean:write name="studentData" property="specId" /></logic:present>" />
		
		<div class="input-group col-md-4" style="margin: 20px 0px;">
				<div class="form-group" style="margin-bottom: 0;">
						<label for="inputPassword" class="control-label col-xs-3" style="text-align: right; line-height: 35px; color: #000; font-size: 13px; font-family: Roboto,sans-serif;">Student</label>
					<div class="col-xs-9">
			...
			<!-- <div class="form-group" style="margin-bottom: 0;">
				<label for="inputPassword" class="control-label col-xs-2"
					style="text-align: right; line-height: 35px; color: #797676; font-size: 16px; font-family: Roboto,sans-serif;">Class</label>
				<div class="col-xs-4">
		...
		<div class="panel-group" id="accordion">
    		<div class="panel panel-primary">
        	 ...
        	 <h4 class="panel-title" style="color: #000000;">
         	 <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Subject Details</a>
       		 </h4>
      		</div>
    		...
    		<div class='panel panel-primary labdiv'>
      			<div class="panel-heading">
        			<h4 class="panel-title" style="color: #000000;">
         			 <a data-toggle="collapse" data-parent="#accordion" href="#collapse2"><span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Laboratory Details</a>
       				</h4>
      			</div>
