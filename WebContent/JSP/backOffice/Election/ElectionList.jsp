	...
	<div class="searchWrap">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"href="#collapseOne" style="color: #fff;"><h3 class="panel-title class" style="color: #000000;">
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Election Details
					</h3></a>
					
					<div class="navbar-right" style="top:; right:10px;">
					<a href ="menuslist.html?method=addNewElection">
