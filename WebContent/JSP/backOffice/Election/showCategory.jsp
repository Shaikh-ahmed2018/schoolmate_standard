			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					...
					<div class="panel-heading" role="tab" id="heading<bean:write name="CollectionVo" property="electionCategoryId" />">
							...
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse<bean:write name="CollectionVo" property="electionCategoryId" />" style="color: #000000; vertical-align: 7px;"> 
							<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;<bean:write name="CollectionVo" property="electionCategory" />
							</h3></a>
