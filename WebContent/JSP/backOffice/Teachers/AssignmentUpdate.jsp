						...
						<input type="hidden" id="assignmentId" value="<logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="assignmentId"/></logic:present>"/>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif" id="addmissionNo"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="classname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="assigName"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="startdate"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12" id="maxmarks"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="marks"/></logic:present>
										</label>
									</div>
								</div>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="section"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="subjectname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif" id="concessionPercent"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="enddate"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="AssignmentDetailsVo"><bean:write name="AssignmentDetailsVo" property="specializationName"/></logic:present>
										</label>
									</div>
								</div>
							</div>
						
						<display:table class="table allstudent" id="assignmentList" style="font-family: Roboto,sans-serif; color: #897676;border-top: 2px solid #ddd;"
