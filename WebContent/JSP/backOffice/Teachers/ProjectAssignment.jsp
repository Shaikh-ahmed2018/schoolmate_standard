				...
				<%-- 	<display:table class="table" id="allstudent"
					...
					<logic:present name="ProjectList" scope="request">
						<table class="table" id="allstudent">
							<thead>
							<tr>
							<th><input type='checkbox' class='selectall' name='selectAll' style='text-align:center' id='selectAll'/></th>
							<th>Project Name</th>
							<th>Class</th>
							<th>Section</th>
							<th>Assigned Date</th>
							...
							<logic:iterate id="ProjectList" name="ProjectList">
								<tr>
								<td><input type='checkbox' name='select' class='select'style='text-align: center' id='<bean:write name="ProjectList" property='projectcode'/>'/></td>
