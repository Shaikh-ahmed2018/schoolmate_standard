	...
	<div class="col-md-10"
		...
		<div class="col-md-7" id="div2">
			...
			<p style="margin: 16px 0px;">
				...
				<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Circular&Remainder
				</span>
		...
		<div class="input-group col-md-5" style="margin: 20px 0px;">
			...
			<div class="form-group">
				<%--  <label for="inputPassword" class="control-label col-xs-3"
										style="text-align: left;    line-height: 35px;    color: #797676;    font-size: 16px;    font-family: Roboto,sans-serif;">Teacher</label> 
									<div class="col-xs-7">
									...
									<logic:present name="teacherlist" scope="request">
									  ...
									  <option value="">---Select--- </option>
											...
											<bean:write name='stream' property='userName'/></option>
										    </logic:iterate>
							                </select>
											</logic:present>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<!-- <img src="images/rightline.png" style="margin-top: 0px;"> <img
				...
				<div class="panel-body"
					...
					<logic:present name="remainderlist" scope="request">
						<display:table class="meeting table" pagesize="10"
							...
							requestURI="teachermenuaction.html?method=circularRemainder"
							id="allstudent">
							...
							<display:column property="name" sortable="true"
								title="Remainder-Title <img src='images/sort1.png' style='float: right'/>"></display:column>



							<display:column property="remtype" sortable="true"
								title="Remainder-To<img src='images/sort1.png' style='float: right'/>"></display:column>
