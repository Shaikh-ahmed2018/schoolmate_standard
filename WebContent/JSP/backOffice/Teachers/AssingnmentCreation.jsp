				...
				<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						<div class="col-md-6" id="txtstyle">
							...
							<div class="form-group clearfix">
								<label for="inputPassword" class="control-label col-xs-4" style="text-align: right; line-height: 35px;">Branch</label>
								<div class="col-xs-7">
						...
						<div class="col-md-6" id="txtstyle">
							...
							<div class="form-group clearfix">
								...
								<div class="col-xs-7">
									<input type="text" name="maxid" id="maxid" class="form-control" onkeypress="return CheckIsNumeric2(event);"></input>
								</div>
							</div>
