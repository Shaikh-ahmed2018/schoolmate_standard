...
<script type="text/javascript" src="JS/backOffice/Teacher/AddProject.js"></script>
...
<body>
	<div class="col-md-10" id="div-main"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Assign New Project</span>
		</p>
				...
				<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
					<div class="panel-body">
						<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Project
										Name </label>
									<div class="col-xs-7">
						...
						<div class="col-md-6" id="txtstyle">
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" name="maxid" id="maxid"
											class="form-control" onkeypress="return CheckIsNumeric2(event);"></input>
									</div>
								</div>
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Assigned
										Date</label>
									<div class="col-xs-7">
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Submission
										Date</label>
									<div class="col-xs-7">
