				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading" role="tab" id="headingOne" >
							...
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapseOne" style="color: #000000"><h3 class="panel-title" style="vertical-align: text-top;" id="beforeparent"><i
						...
						<div class="panel-body" id="tabletxt" style="padding: 15px;">
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix clearfix clearfix clearfix clearfix clearfix">
									...
									<div class="col-xs-7">
										<select id="eventprogramname" name="eventprogramname" class="form-control" required="required">
											<option value="">All</option>
										</select>
									</div>
								</div>
							...
							<div class="col-md-6" id="txtstyle">
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select id="eventcategory" name="eventCategory" class="form-control" required="required">
											<option value="">All</option>
