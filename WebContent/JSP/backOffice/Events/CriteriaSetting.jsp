...
<!-- Pop up starts -->
			...
			<div class="col-md-12">
				...
				<div class="col-md-7" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000; margin-top: 10px;">
							...
							<%-- <div class="form-group clearfix ">
								...
								<!-- <div class="col-md-4" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000; margin-top: 10px;">
							<div class="form-group clearfix ">
	...
	<input type='hidden' id='hiddencriteriaid' value=''/>
			...
			<div class="row">
			<div class="col-md-12  addjudges" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000; margin-top: 10px;">
		...
		<div class="panel panel-primary clearfix">
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2" href="#collapseOne"
					style="color: #fff;"><h3 class="panel-title class" style="color: rgb(118, 118, 118); vertical-align: text-top;">
