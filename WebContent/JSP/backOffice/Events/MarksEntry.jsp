...
<script  type="text/javascript" src="JS/backOffice/Events/marksEntry.js"></script>
...
<body>
	...
	<div class="eventRegistration">
			<p><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span	id="pageHeading">Marks Entry</span></p>
	</div>
<!--Pop Up Ends  -->		
...
<div id="filteration" class="filteration clearfix">
	<div class="panel-body" id="tabletxt">
		...
		<div class="col-md-6" id="txtstyle">
			...
			<div class="form-group clearfix wrap">
				<label for="inputPassword" class="control-label col-xs-4" align="right"
					id="inputnames">Chest Number</label>
					<div class="col-xs-7">
					<input type="text" id="chestNo" class="form-control text"/>
					</div>
			</div>
