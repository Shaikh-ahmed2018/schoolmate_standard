	...
	<div class="content" id="div1">
		...
		<div class="searchWrap">
			<div id="div2">
                ...
                <%-- 		<div class="form-group clearfix" id="accyear">
		...
		<div class="panel panel-primary clearfix">
			<div class="panel-heading clearfix">
				...
				<div class="navbar-right" id="headbuttons">
					<span class="buttons" id="chestnogeneration" data-toggle="modal" style="margin-right:3px;"
						data-target="#myModal">Generate Chest No</span> 
						
						<span class="buttons" id="iconsimg" data-toggle="modal"
							data-target="#myModal" style="left:-8px;"
							data-placement="bottom">Download </span>
						
						<span class="buttons" id="save" data-toggle="modal" data-target="#myModal">save</span> 
