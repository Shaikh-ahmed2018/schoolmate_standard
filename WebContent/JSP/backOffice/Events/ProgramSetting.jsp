...
<div class="form-group clearfix ">
	...
	<div class="col-xs-8">
		...
		<option value="">---Select---</option>
	<%-- 	<logic:present name="teacherName">
						<logic:iterate id="name" name="teacherName">
							<option value='<bean:write name="name" property="teacherId"/>'><bean:write name="name" property="teacherName"/></option>
						</logic:iterate>
					</logic:present> --%>
									</select>
								</div>
