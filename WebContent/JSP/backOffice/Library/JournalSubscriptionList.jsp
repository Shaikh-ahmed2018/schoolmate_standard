...
<script type="text/javascript" src="JS/backOffice/Library/LibraryJournalSubscriptionList.js"></script>
		...
		<div class="col-md-8" id="div2">
			...
			<p style="">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Journal Subscription</span>
			</p>
		</div>
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;vertical-align: text-top;"><h3 class="panel-title"  style="color: #000000;vertical-align: text-top;">
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp; Journal Subscription
					</h3></a>
					

				<div class="navbar-right">

							<a href="LibraryMenu.html?method=JournalSubscription"> 
							<span class="buttons" id="add">New</span></a> 
