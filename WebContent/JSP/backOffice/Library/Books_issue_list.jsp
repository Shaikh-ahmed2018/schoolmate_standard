		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<span id="Addbookissuedetails" class="buttons" Onclick="Addbookissuedetails()" data-toggle="tooltip" data-placement="bottom" title="Add">New</span></a> 
					<span id="editbookissuelist" class="buttons" data-toggle="tooltip" data-placement="bottom" title="Edit">Modify</span> 
					<span id="deletebookissuelist" class="buttons" data-toggle="tooltip" data-placement="bottom" title="Delete">Remove</span>
				...
				<div class="panel-body"
					...
					<logic:present name="booksnames" scope="request">
						<display:table class="table" pagesize="10"
							...
							requestURI="menuslist.html?method=bookissuedlist"
							id="allstudent">
