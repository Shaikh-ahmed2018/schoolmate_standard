...
<script type="text/javascript" src="JS/backOffice/Library/ListPublisherSettings.js"></script>
		...
		<div class="col-md-12 input-group" id="div2">
			...
			<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Publisher Details</span>
			</p>
		</div>
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;vertical-align: text-top;"><h3 class="panel-title"  style="color: #000000;vertical-align: text-top;">
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp; Publisher Details
					</h3></a>
