...
<body>
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
		<p>
			<span class="glyphicon glyphicon-user" style="font-size: 27px;"></span>&nbsp;<span id="pageHeading">Returns</span>
		</p>
			...
			<div class="panel panel-primary panel-list">
				<div class="panel-heading" role="tab" id="headingOne">
					...
					<div class="navbar-right">
						...
						<span class="buttons" id="back1" style="margin: 0px 12px 0px 0px;left:4px;display:none;">Back</span>
						                 </logic:equal>
						            </logic:equal>
						         </logic:iterate>
						</logic:present>
							...
							<div class="col-md-6"
								...
								<div class="form-group">
									...
									<label for="inputPassword" class="control-label col-xs-5" style="left:133px;top:2px;">
										Issued to<font color="red">*</font></label>
					...
					<div class="col-md-6" id="designation"
				    	...
				    	<div class="form-group clearfix" id="contactno" style="display:none;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="hidden" readonly="readonly" onkeypress="HideError()"  class="form-control" id="itemtype" maxlength="20"
										value="<logic:present name="studentList"><bean:write name="studentList" property="itemType"></bean:write></logic:present>" />
										
										<input type="text" readonly="readonly" onkeypress="HideError()"  class="form-control" id="item" maxlength="20"
										value="<logic:present name="studentList"><bean:write name="studentList" property="itemType"></bean:write></logic:present>" />
									</div>
								</div>
							...
							<div class="col-md-6"
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;"> Book
										Issue Date<font color="red">*</font> </label>
									<div class="col-xs-7">
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;"> Book
										Return Date<font color="red">*</font></label>
									<div class="col-xs-7">
										<input type="text" class="form-control" readonly="readonly"
