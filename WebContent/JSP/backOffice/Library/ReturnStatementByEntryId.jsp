	...
	<div class="content" id="div1">
		<div class="col-md-6" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Return Statement</span>
			</p>
		</div>
		...
		<div class="input-group col-md-6">
			...
			<label class="hedderstyle form-control"
				style="margin: 20px 0px; width: 20% !important; border: none; font-family: Roboto Medium; font-size: 14px; font-weight: lighter; background: transparent; color: #000000 !important;"></label>
		...
		<div class="panel panel-primary">
			<div class="panel-heading heading1">
				...
				<div class="navbar-right" style="right: -8px;">
					...
					<span class="buttons" id="back1" style="margin: 0px 12px 0px 0px;">Back</span>
    ...
    value='<logic:present name="historygoto" scope="request"><bean:write name="historygoto"/></logic:present>' />
			...
			<div class="col-md-6" id="txtstyle">
				...
				<div class="form-group clearfix className1">
					<label for="inputPassword" class="control-label col-xs-4"
						align="right" id="inputnames">Current Status</label>
					<div class="col-xs-7">
			...
			<div class="col-md-6 collapseOne" id="txtstyle">
				...
				<div class="form-group clearfix">
					<label for="inputPassword" class="control-label col-xs-4"
						align="right" id="inputnames">Author</label>
					<div class="col-xs-7">
				...
				<input type="hidden" id="hidensize1" value="<logic:present name="listsize"><bean:write name="listsize" /></logic:present>" />
