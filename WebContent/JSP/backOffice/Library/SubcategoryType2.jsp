...
<script type="text/javascript" src="JS/backOffice/Library/SubCategoryType2.js"></script>
			...
			<div id="div2">
				...
				<p>
					<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
						id="pageHeading">Sub Category Type2 Details</span>
				</p>
			</div>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					...
					<h3 class="panel-title"
						style="color: #000000vertical-align: text-top;">
						...
						<logic:iterate id="daymap" name="UserDetails"
							...
							<logic:equal value="LIBMADD" name="daymap" property="key">
								<logic:equal value="true" name="daymap" property="value">
									<a href="LibraryMenu.html?method=addSubCatagoryType2"> <span
					...
					<logic:present name="UserDetails" scope="session">
						<logic:iterate id="daymap" name="UserDetails"
							...
							<logic:equal value="LIBMUPD" name="daymap" property="key">
								<logic:equal value="true" name="daymap" property="value">
									<span id="edit" class="buttons">Modify</span>
								</logic:equal>
							</logic:equal>
						</logic:iterate>
					</logic:present>
			...
			<div id="collapseOne" class="panel-collapse collapse in"
				...
				<div class="panel-body" id="tabletxt" style="padding: 15px;">
					...
					<div class="col-md-6"
                     ...
                     <div class="col-md-6"
						...
						<div class="form-group clearfix">
							<label for="inputPassword" class="control-label col-xs-5"
								style="text-align: right; line-height: 35px;">Sub
								Category Type 2 Name</label>
							<div class="col-xs-7">
								<select class="form-control" onkeypress="HideError()"
									name="subcategorytype2" id="subcategorytype2">
									<option value="all">ALL</option>
								</select>
							</div>
						</div>
					...
					<div id="dialog"></div>
						<%-- <logic:present name="SubcategoryType2Details" scope="request">
						<display:table class="table" id="allstudent"
							name="SubcategoryType2Details"
							requestURI="LibraryMenu.html?method=subCategoryType2"
							...
							<input type='checkbox' name='select' class='select' style='text-align:center' id='${allstudent.subcategorytype2_id }'  /></display:column>
							<display:column property="subcategorytype2code" sortable="true"
								title="Sub Category Type2 Code<img src='images/sort1.png' style='float: right'/>" />
							...
							<display:column property="subcategorytype1name" sortable="true"
								...
								<display:column property="subcategorytype2name" sortable="true"
								title="Sub Category Type2 Name<img src='images/sort1.png' style='float: right'/>" />
