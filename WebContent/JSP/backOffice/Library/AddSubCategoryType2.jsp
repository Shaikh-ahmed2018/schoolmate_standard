...
<script type="text/javascript" src="JS/backOffice/Library/AddCategoryType2Details.js"></script>
<style>
.buttons {
	vertical-align: 0px;
}
					...
					<div class="panel-body clearfix">
						<div class="col-md-6"
							...
							<div class="form-group clearfix">
									...
									<input type="hidden" id="hiddensubcat2id" value='<logic:present name="editlist"><bean:write name="editlist" property="hidden_subcat2_id" /></logic:present>'>
					            	...
					            	<input type="hidden" id="hiddensubcat1code" value='<logic:present name="editlist"><bean:write name="editlist" property="subcategorytype1code" /></logic:present>'/>
					            	<input type="hidden" id="hiddensubcat2code" value='<logic:present name="editlist"><bean:write name="editlist" property="subcategorytype2code" /></logic:present>'/>
								</div>
                               <div class="form-group clearfix">
 									<label for="inputPassword" class="control-label col-xs-5"
									...
									<div class="col-xs-7">
										...
										<select class="form-control" onkeypress="HideError()" 
											              name="subcategorytype" id="subcategorytype">
							...
							<div class="form-group clearfix">
 									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: left; line-height: 35px;">Sub Category Type 1</label>
									<div class="col-xs-7">
										<select class="form-control" onkeypress="HideError()" 
							...
							<div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5"
									style="text-align: left; line-height: 35px;">Sub Category Type2 Code</label>
								<div class="col-xs-7">
									<input type="text" onkeypress="HideError()"
										class="form-control" id="subcategorytype2code"
										value='<logic:present name="editlist"><bean:write name="editlist" property="subcategorytype2code" /></logic:present>'></input>
								</div>
							</div>

                      <div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5"
									style="text-align: left; line-height: 35px;">Sub Category Type2 Name</label>
								<div class="col-xs-7">
									<input type="text" onkeypress="HideError()"
										class="form-control" id="subcategorytype2name"
										value='<logic:present name="editlist"><bean:write name="editlist" property="subcategorytype2name" /></logic:present>'></input>
								</div>
							</div>
						</div>
						<div class="col-md-6"
							...
							<div class="form-group clearfix">
								...
								<div class="col-xs-7">
									<textarea style="resize: none" rows="4" cols="25" class="form-control" name="description" id="description"><logic:present name="editlist"><bean:write name="editlist" property="description" /></logic:present>
									</textarea>
								</div>
							</div>
							</div>
