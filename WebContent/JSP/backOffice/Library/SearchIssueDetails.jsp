							...
							<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="LIBRUPD" name="daymap" property="key">
										...
										<span class="select" id="library" style="cursor: pointer; color: #000000;"> 
					...
					<div class="row">
						<div class="col-md-5">
							<fieldset class="fieldset">
								<legend
									style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 15px; color: #000000;">Subscriber:</legend>
								<div class="form-group clearfix"
									style="margin-left: 48px; max-height: 106px; margin-top: 20px; font-size: 13px;">
							...
							<fieldset class="fieldset">
								<legend
									style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 14px; color: #000000;">Search
									By:</legend>
							...
							<div class="row">
								<div class="col-md-12">
									<fieldset class="fsetRight" style="margin-top: -14px;">
										<legend
											style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 15px; color: #000000;">Search</legend>
										<div class="form-group clearfix"
