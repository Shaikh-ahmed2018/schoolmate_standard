...
<div id="dialog"></div>
<p style="margin-bottom: 0px;"><span class="glyphicon glyphicon-user"></span>&nbsp;<span id="pageHeading">Block Subscriber</span></p>
	...
	<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		<div class="panel panel-primary panel-list">
			<div class="panel-heading" role="tab" id="headingOne">
					...
					<a data-toggle="collapse" data-parent="#accordion" href="#" style="color: #000000; vertical-align: text-top;"> 
	<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Subscriber Details
	</h3></a>
...
<div class="form-group clearfix">
			<label for="inputPassword" class="control-label col-xs-5" align="right" 
				id="inputnames">Library Branch<font color="red"> *</font></label>
			<div class="col-xs-7">
...
<div class="form-group clearfix" id="usertype"
		...
		<div class="form-group clearfix">
			<label for="inputPassword" class="control-label col-xs-5"
				style="text-align: right; line-height: 35px;">Subscriber Number<font color="red"> *</font></label>
...
<!-- --------------------------------------------------------------------------------------------------------------- -->							 
   ...
   <div class="student">
		<div class="form-group clearfix">
			...
			<div class="col-xs-7">
				<textarea rows="4" style="margin-bottom: 5px" cols="35" id="studentAddress" class="form-control" name="studentAddress">
				</textarea>
...
<div class="teacher">
	<div class="form-group clearfix">
			<label for="inputPassword" class="control-label col-xs-4"
				style="text-align: right; line-height: 35px;">Address</label>
			<div class="col-xs-7">
				<textarea rows="4" style="margin-bottom:5px;" readonly cols="35" id="teacherAddress" class="form-control" name="teacherAddress">
				</textarea>
  ...
  <div class="teacher">
	<div class="form-group clearfix">
	     <label for="inputPassword" class="control-label col-xs-4"style="text-align: right; line-height: 35px;">Mobile Number</label>
			<div class="col-xs-7">
...
<div class="teacher">
		<div class="form-group clearfix">
		<label for="inputPassword" class="control-label col-xs-4"style="text-align: right; line-height: 35px;">Email ID</label>
		<div class="col-xs-7">
	...
	<div class="form-group clearfix">
			...
			<div class="col-xs-7">
				<textarea  readonly rows="4" style="margin-bottom: 5px" cols="35" class="form-control" onkeypress="HideError()" id="otherUserAddr">
				</textarea>
	...
	<div class="others">
 <div class="form-group clearfix">
 	<label  class="control-label col-xs-4" style="text-align: right; line-height: 35px;" >Contact Number<font color="red">*</font></label>
		<div class="col-xs-7">
...
<div class="others">
 <div class="form-group clearfix">
 	<label  class="control-label col-xs-4" style="text-align: right; line-height: 35px;" >Email ID</label>
		<div class="col-xs-7">
...
<div>
		...
		<div class="tab" style="margin-top:-15px;">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#contacts" style="font-weight: 600;" id="staffTab">Staff</a></li>
				<li><a data-toggle="tab" href="#classHistory" style="font-weight: 600;" id="studentsTab">Student</a></li>
				<li><a data-toggle="tab" href="#classHistory" style="font-weight: 600;" id="othersTab">Others</a></li>
			</ul>
