...
<script type="text/javascript" src="JS/backOffice/Library/ReservationList.js"></script>
								...
								<logic:iterate id="daymap" name="UserDetails"
									...
									<logic:equal value="LIBRUPD" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											...
											<span type="button" class="buttons" id="print">Print</span>
					...
					<div class="row">
						...
						<div class="col-md-12"
							...
							<fieldset class="fieldset">
								<legend style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif;font-weight:700;margin-left:-20px;font-size: 14px;color: #1149aeeb;">
								...
								<div class="row" style="margin-top: 10px;">
									<div class="col-md-6 clearfix ">
										<div class="form-group clearfix with"
											style="margin-left: 54px;margin-top: 16px">
