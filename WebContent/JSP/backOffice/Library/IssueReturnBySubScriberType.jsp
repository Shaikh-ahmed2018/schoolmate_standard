...
<script type="text/javascript"
	src="JS/backOffice/Library/GotoIssueReturnDetails.js"></script>
...
<body>
	...
	<div class="content" id="div1">
		<div class="col-md-6" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Issue Return</span>
			</p>
		</div>
		...
		<div class="input-group col-md-6">
    		...
    		color: #000000 !important;"	class="form-control"></label>
			...
			<div class="panel-heading heading1">
				<a data-toggle="collapse" data-parent="#accordion2"
					href=".collapseOne1" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp; Return Details
					</h3></a>
				<div class="navbar-right" style="right:-8px;">
              
               <span class="buttons" id="back1" style="left:-15px;" >Back</span> 
			  ...
			  <!----------------------- Student table ------------------------>
				...
				<div class="allstudenttable" >
					<div id="collapseOne" class="panel-collapse collapse in"
						...
						<td> <bean:write name="issuedetails" property="bookTitle"/></td>   <%-- <bean:write name="studentList" property="issueId"/>--%>
