								...
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									...
									<div class="form-group">
										...
										<label for="inputEmail" class="control-label col-xs-4"
											id="inputnames"></label>
											<div class="col-xs-7">
											  <input type="file" name="formFile" id="studentfile" class="form-control"
											   style="height: auto;width:100%;"></input>
										    </div>
									</div>
								</div>
								
								<div class="col-md-2" style="padding:7px 0px;margin-left:-10%;">
								    <span id="saveid" class="buttons">Upload</Span>
							    </div>

								<div class="col-md-3" id="txtstyle" style="padding: 10px 0px;">
						   <a href="uploadLibraryXSL.html?method=downloadStockEntryfileformat">Download Template</a>
								</div>
