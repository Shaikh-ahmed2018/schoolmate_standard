					...
					<div class="row">
						...
						<div class="col-md-6"
							...
							<fieldset class="fieldset">
								<legend
									style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; color: #000000; margin-left: 56px;">
						...
						<div class="col-md-6"
							...
							<fieldset class="fieldset1">
								<legend style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; color: #000000; margin-left: 46px;">Order
									By:</legend>
						...
						<div class="col-md-12"
							...
							<legend style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; color: #000000; margin-left: 56px;">Search</legend>
