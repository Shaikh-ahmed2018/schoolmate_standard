...
<body>
  <div class="col-md-10">
 		<p>
			<span class="glyphicon glyphicon-user" style="font-size: 27px;"></span>&nbsp;<span id="pageHeading">Subscriber List </span>
		</p>
		...
		<div class="panel-group" id="accordion" role="tablist"
			...
			<div class="panel-heading" role="tab" id="headingOne">
				...
				<div id="collapseOne" class="panel-collapse collapse in"
				    ...
				    <label for="inputPassword" class="control-label col-xs-5" style="text-align:left; line-height: 35px;">Branch</label>
						<div class="col-xs-7">
