...
<form id="staffLeavereport" action="teacherLeaveDetailsReport.html?method=getLeaveDetailsReport" method="post" >
	<div class="col-md-10"
		...
		<p style="margin: 4px 0 5px !important;">
			<img src="images/addstu.png" />&nbsp;<span style="font-size: 16pt; " id="pageHeading">Staff Leave Report
			</span>
		</p>
      <div class="errormessagediv" align="center" style="display: none;">
				...
				<div id="collapseOne" class="panel-collapse collapse in"
					...
					<div class="panel-body" id="tabletxt" style="margin-top: 19px;">
						...
						<div class="col-md-12 selecteditems">
						 ...
						 <div class="col-md-12" id="allstudent1" style="padding:7px;height: 4px;text-align: center;">
		...
		<input type="hidden" id="hideenId" value="studentlist" />
				...
				<table style="width:100px"  class="table" id="allstudent" style="overflow:scroll">		
