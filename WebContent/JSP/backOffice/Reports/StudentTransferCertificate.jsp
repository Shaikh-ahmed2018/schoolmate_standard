...
<link href="CSS/newUI/font-awesome/css/font-awesome.min.css"
 ...
 <script type="text/javascript"
	src="JS/backOffice/Reports/StudentTransferCertificateReport.js"></script>
...
<form id="stuattnid" action="studentattendanceReport.html?method=getStudentAttendanceAction" method="post" enctype="multipart/form-data">
	<div class="col-md-10"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span>Student Transfer Certificate
			</span>
		</p>
			...
			<div class="panel panel-primary">
				<div class="panel-heading" role="tab" id="headingOne">
						...
						<a data-toggle="collapse" data-parent="#accordion2"
							...
							class="glyphicon glyphicon-menu-hamburger"></i> &nbsp;&nbsp;Student Transfer Certificate
						</h3>	 
						</a>
					...
					<div class="panel-body" id="tabletxt">
						...
						<div class="col-md-6" id="txtstyle">
							...
							<div class="form-group">
									...
									<div class="col-xs-7">
										<textarea name="address" id="reason" class="form-control"><logic:present name="driverlist"><bean:write name="driverlist" property="address"/></logic:present></textarea>
									</div>
								</div>
							<br />
