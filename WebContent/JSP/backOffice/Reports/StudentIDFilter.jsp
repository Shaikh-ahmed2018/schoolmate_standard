...
<script src="JS/backOffice/Reports/StudentIDFilter.js"></script>
...
<body>
	...
	<div class="col-md-10"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span style="font-size: 16pt;">Student ID Card
			</span>
		</p>
		...
		<form action="IDCreationAction.html?method=getStudentDetailsReport"
			method="post">
 ...
 --%>
									...
									sortable="true"
									title="<input type='checkbox' name='selectall' style='text-align:center' id='selectall' onClick='selectAll()' />"><input type='checkbox' name='select' class='selectall' style='text-align:center' id='${allstudent.studentId }' onClick='selectAll()' /></display:column>
									...
									<display:column property="fathermobno" sortable="true"
										title="Phone <img src='images/sort1.png' style='float: right'/>"
										media="html"></display:column>
