...
<body>
	...
	<div>
		<div class="col-md-10"
			...
			<p style="">
				<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Leave Type Details
					</span>
			</p>
				...
				<div class="panel-group" id="accordion" role="tablist"
					...
					<div class="panel panel-primary">
						...
						<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								<div class="col-md-5" id="txtstyle"
									style="font-size: 13px; color: #000; padding-top :8px;">
									<div class="form-group">
										<label for="inputEmail" class="control-label col-xs-4"
											style="text-align: right; line-height: 35px;">Academic
											Year</label>
										<div class="col-xs-7">
										<input type="text" name="Accyear" id="Accyear" readonly class="form-control"
											value='<logic:present name="AccName"><bean:write name="AccName"/></logic:present>'/>
										</div>
										<br /> <br />
								</div>
						...
						<input type="hidden" name="hiddenloc" id="hiddenloc" 
							...
							<div class="col-md-5" id="txtstyle" style="font-size: 13px; color: #000; padding-top :8px;">
							
								<div class="form-group">
										<label for="inputEmail" class="control-label col-xs-4"
											style="text-align: right; line-height: 35px;">Branch</label>
										<div class="col-xs-7">
											<input type="text" name="Locname" id="Locname" readonly class="form-control"
							...
							<!-- <div class="col-md-2" id="txtstyle" style="font-size: 13px; color: #000; padding-top :15px;">
