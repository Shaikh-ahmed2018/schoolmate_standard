			...
			<div id="collapseOne" class="panel-collapse collapse in"
				...
				<logic:iterate id="studentSearchList" name="studentSearchList">
					...
					<div class="col-md-12">
                        ...
                        <td><logic:present name="subjectList"><bean:write name="subjectList" property="passmarks"></bean:write></logic:present></td>
                        ...
                        <td><logic:present name="subjectList"><bean:write name="subjectList" property="gradename"></bean:write></logic:present></td></tr>
                               ...
                               <td><logic:present name="pass" scope="request"><bean:write name="pass"/></logic:present></td>
