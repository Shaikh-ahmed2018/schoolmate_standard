...
<div>
	<div class="col-md-10"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">PayCertificate</span>
		</p>
										...
										<select id="accyear" name="accyear" class="form-control"
											...
											<logic:present name="AccYearList">
												...
												<logic:iterate id="AccYear" name="AccYearList">
													...
													<option
														value="<bean:write name="AccYear" property="accyearname"/>">
								...
								<div class="form-group clearfix">
					               ...
					               <select id="teachername" name="teachername" class="form-control"
											...
											<logic:present name="teacherlist">
												...
												<logic:iterate id="AccYear" name="teacherlist">

													<option
														value="<bean:write name="AccYear" property="teacherId"/>">
														<bean:write name="AccYear" property="tfastname" />
													</option>
