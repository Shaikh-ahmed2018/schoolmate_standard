...
<head>
<script type="text/javascript" src="JS/backOffice/Settings/ClassExcelUpload1.js">
</script>
</head>
<body>
  ...
  <div id="loder" style="display: none; position:absolute; height: 800px;width: 800px;left: 0;right: 0;top: -40px;;bottom: 0;margin: auto;z-index: 99999; "><img style="width: 165px;position: absolute;left: 0;right: 0;height: 165px;bottom: 0;top: -190px;margin: auto;" src="./images/ajax-loading.gif"/></div>
	...
	<div class="col-md-10" id="div-main"
		...
		<p>
			<span class="glyphicon glyphicon-user"></span>&nbsp;<span id="pageHeading">Class Excel upload</span>
		</p>
	...
	<form action="settingXLUpload.html?method=insertClassXLFormat"
				...
				<div class="panel panel-primary">
					...
					<%-- 	<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="UPLCLSADD" name="daymap" property="key">
						...
						<div id="collapsebOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									<div class="form-group">
										<label for="inputEmail" class="control-label col-xs-4"
											id="inputnames"></label>
										<div class="col-xs-7">
											<input type="file" name="formFile" id="Classfile"
								...
								<div class="col-md-3" id="txtstyle">
									<a href="settingXLUpload.html?method=ClassXLFormat">Download Instructions</a>
									<br/>
									<a href="settingXLUpload.html?method=ClassXLSampleData">Download Template</a>
								
								</div>
								
								
								
						 <logic:present name="FailedClassList" scope="request">
							...
							<display:table id="allstudent" name="requestScope.FailedClassList" class="table"
											requestURI="/SettingXLUpload.html?method=insertClassXLFormat">
