	...
	<div class="content" id="div1">
		<div class="col-md-8" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span id="pageHeading">Quota
					details</span>
			</p>
		</div>
		...
		<form id="myForm" action="menuslist.html?method=QuotaDetails" method="post">
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Quota
						Details
					</h3></a>
				...
				<div class="navbar-right" >
					 ...
					 <a	href="QuotaMenu.html?method=AddQuota"><span
						class="buttons"
						  data-toggle="tooltip" data-placement="bottom" title="Add">New</span></a>
         ...
         <div class="modal fade" id="myModal" tabindex="-1" role="dialog"
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					export="false" requestURI="/menuslist.html?method=QuotaDetails"
