...
<link href="CSS/newUI/custome.css" rel="stylesheet">
 ...
 <script type="text/javascript" src="JS/backOffice/Student/TransportSingleIDCard.js"></script>
...
<body>
			...
			<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span	id="pageHeading">Print Transport ID Card - Single</span>
			</p>
		</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading" role="tab" id="headingOne" >
							...
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapseOne" style="color: #000000;vertical-align: text-top"> <h3 class="panel-title" id="beforeparent" style="color: #000000;"><i
...
<div id="collapseOne" class="panel-collapse collapse in"
				...
				<div class="panel-body"
					...
					<display:table class="table" id="allstudent"
						...
						<display:column property="studentAdmissionNo" class="${allstudent.studentId} ${allstudent.academicYearId} ${allstudent.locationId} studentid" sortable="true" title="Admission No <img src='images/sort1.png' style='float: right'/>"
