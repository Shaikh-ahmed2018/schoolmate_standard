...
<script type="text/javascript" src="JS/backOffice/Settings/RemarksEntryPage.js"></script> 
...
<body>
	<div class="col-md-10"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Add Remark</span>
		</p>
		...
		<form method="post">
			<div class="panel-group" id="accordion" role="tablist"
				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
						...
						<a href="menuslist.html?method=communicationRemarksList"><span class="glyphicon glyphicon-list2"
			...
			<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="col-md-6"
								...
								<div class="form-group">
									<label for="inputPassword" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Remarks To</label>
								...
								<div class="form-group">
									<label for="inputPassword" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Remarks Type</label>
									<div class="col-xs-7" id="radiostyle" style="margin-top: 8px">
								...
								<div class="form-group">
									...
									<div class="col-xs-7">
										<textarea name="remarks" id="remarks" class="form-control" onkeypress="HideError()"><logic:present name="driverlist"><bean:write name="driverlist" property="address"/></logic:present></textarea>
									</div>
								</div>
						...
						<div class="form-group">
									...
									<div class="col-xs-7">
										<select name="accyear" id="remarksid" class="form-control" onkeypress="HideError()" >
					...
					<div class="form-group">
								...
								<div class="form-group">
									<label for="inputEmail" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Title<font color="red">*</font></label>
									<div class="col-xs-7">
											<input type="text" name="meetingtitle" id="meetingtitle" class="form-control"  value="<logic:present name="AcadamicYearPlanDetails"  scope="request"><bean:write name="AcadamicYearPlanDetails" property="weekday"/></logic:present>"/>
									</div>
								</div>
							...
							<div class="form-group">
								<label for="inputPassword" class="control-label col-xs-4"
									...
									Time<font class="mandotary" color="red">*</font>
								</label>
								<div class="col-xs-7">
							...
							<div class="form-group">
								<label for="inputPassword" class="control-label col-xs-4"
									style="text-align: right; line-height: 35px;">End Time<font
									class="mandotary" color="red">*</font></label>
								<div class="col-xs-7">
