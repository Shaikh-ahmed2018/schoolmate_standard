...
<script type="text/javascript" src="JS/backOffice/Settings/CasteCategoryExcelUpload.js">
</script>
...
<body>
   ...
   <div id="loder" style="display: none; position:absolute; height: 800px;width: 800px;left: 0;right: 0;top: -40px;;bottom: 0;margin: auto;z-index: 99999; "><img style="width: 165px;position: absolute;left: 0;right: 0;height: 165px;bottom: 0;top: -190px;margin: auto;" src="./images/ajax-loading.gif"/></div>
	...
	<div class="col-md-10" id="div-main"
		...
		<p>
			<span class="glyphicon glyphicon-user"></span>&nbsp;<span id="pageHeading">Caste Category Excel upload</span>
		</p>
	...
	<form action="settingXLUpload.html?method=CasteCategoryInsertData"
				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<a href="#collapsebOne" class="topPannel" style="color: #000000"><h3 class="panel-title"> <i
								...
								&nbsp;&nbsp;Upload Caste Category Details
							</h3></a>
					<%-- 	<div class="navbar-right">
						<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="UCASCATADD" name="daymap" property="key">
						...
						<div id="collapsebOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									<div class="form-group">
										<label for="inputEmail" class="control-label col-xs-4"
											id="inputnames"></label>
										<div class="col-xs-7">
											<input type="file" name="formFile" id="CasteCatefile"
								...
								<div class="col-md-3" id="txtstyle">
									<a href="settingXLUpload.html?method=CasteCategoryExcelFormat">Download Instructions</a>
										<br>
									<a href="settingXLUpload.html?method=CasteCategorySampleData">Download Template</a>
								</div>
								
								
					 		
					 <logic:present name="FailedCasteCategoryList" scope="request">
							...
							<display:table id="allstudent" name="requestScope.FailedCasteCategoryList" class="table"
											requestURI="/SettingXLUpload.html?method=CasteCategoryInsertData">
							<display:column property="reason" title="Reason" headerClass="heading1" style="width:400px;text-align:left" />
							<display:column property="religionName" title="Religion " headerClass="heading1" />
							<display:column property="casteName" title="Caste " headerClass="heading1" />
							<display:column property="casteCategoryName" title="Caste Category " headerClass="heading1" />
							</display:table>
						</div>
