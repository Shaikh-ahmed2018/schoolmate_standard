...
<script type="text/javascript" src="JS/backOffice/Settings/StreamExcelUpload.js">
</script>
...
<body>
   ...
   <div id="loder" style="display: none; position:absolute; height: 800px;width: 800px;left: 0;right: 0;top: -40px;;bottom: 0;margin: auto;z-index: 99999; "><img style="width: 165px;position: absolute;left: 0;right: 0;height: 165px;bottom: 0;top: -190px;margin: auto;" src="./images/ajax-loading.gif"/></div>
	...
	<div class="col-md-10" id="div-main"
		...
		<p>
			<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span id="pageHeading">Stream Excel upload</span>
		</p>
	...
	<form action="settingXLUpload.html?method=insertStreamXLFormat"
						...
						<div id="collapsebOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									<div class="form-group">
										<label for="inputEmail" class="control-label col-xs-4"
											id="inputnames"></label>
										<div class="col-xs-7">
											<input type="file" name="formFile" id="Streamfile"
								...
								<div class="col-md-3" id="txtstyle">
									<a href="settingXLUpload.html?method=StreamXLFormat">Download Instructions</a>
									<br/>
									<a href="settingXLUpload.html?method=StreamXLSampleData">Download Template</a>
								</div>
								
							<logic:present name="FailedStreamList" scope="request">
							...
							<display:table id="allstudent" name="requestScope.FailedStreamList" class="table"
											requestURI="/SettingXLUpload.html?method=insertStreamXLFormat">
							<display:column property="reason" title="Reason" headerClass="heading1" style="width:250px;text-align:left"/>
							...
							<display:column property="description" title="Description" headerClass="heading1" />
