			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Student Details
							</h3></a>
					...
					<!-- 	<div class="navbar-right">
							...
							<span style="margin-left:4px" class="buttons"><a href="menuslist.html?method=DesignStudentSingleIDCard">Back</span>
						</div> -->
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
						...
						<div class="navbar-right">
					<span class="buttons"><a href="menuslist.html?method=addStudent">Print</a></span>
					<span style="margin-left:5px" id="editStudent" class="buttons"><a href="menuslist.html?method=DesignTransportIDCardSingle">back</a></span>
					</div>
				</div>
