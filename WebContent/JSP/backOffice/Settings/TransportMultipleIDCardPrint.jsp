...
<script type="text/javascript" src="JS/backOffice/Student/printTransportMultipleIDCard.js"></script>
...
<body>
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		...
		<p><img src="images/addstu.png" /><span id="pageHeading">Print Transport ID Card - Multiple</span></p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						...
						<input type="hidden" name="Acyearid" id="hiddenaccyear" value='<logic:present name="Acyearid"><bean:write name="Acyearid"/></logic:present>'></input>
				...
				<div class="panel-body"
					...
					<thead>
					 <tr>
						...
						<th>Roll No</th>
						<th>Class</th>
						<th>Division  <img src='images/sort1.png' style='float: right'/></th>
					 	<th>Photo</th>
					 </tr>
					</thead>
					<tbody>
