...
<link href="CSS/IdCard/StaffId/StaffIdCard.css" rel="stylesheet" />
		...
		<div class="panel panel-primary clearfix">
			<div class="panel-heading">
				...
				<span id="print" class="buttons">Print</span>
					...
					<span id="back1" style="margin-left:7px;" class="buttons">Back</span>
	 ...
	 value='<logic:present name="historydesigId" scope="request" ><bean:write name="historydesigId" /></logic:present>' />
 		...
 		<logic:present name="staffList" scope="request">
			...
			<div class="logodiv" id="logodiv">
			 	 <img src="./<bean:write name="staffList" property="schoollogourl"/>" width="100%" height="100%"  />
				</div>
