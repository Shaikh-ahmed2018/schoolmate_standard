...
<input type="hidden" id="layoutDetails" value='<logic:present name="templateClass" scope="request" ><bean:write name="templateClass" /></logic:present>' />
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading" role="tab" id="headingOne" >
							...
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapseOne" style="color: #767676"><h3 class="panel-title" id="beforeparent" style="color: #000000;"><i
	...
	<input type="hidden" id="historydepartmentId" 
							...
							<div class="col-md-6" id="txtstyle">
								...
								<input  type="text" id="academicYearNmae" name="tempale" class="form-control" readonly="readonly"
								 value='<logic:present name="accYearName"  scope="request" ><bean:write name="accYearName" /></logic:present>' />
									...
									<div class="col-xs-7">
								<input  type="text" id="templateid" name="tempale" class="form-control" readonly="readonly" value="Staff ID Card">
									</div>
								</div>
			...
			<div class="navbar-right" style="color:#000000;">
		...
		<section class="col-md-4 section">
			<div class="main-div" id="main-div" >
			 <img src='images/IdCard/<logic:present name="templateClass" scope="request" ><bean:write name="templateClass" /></logic:present>.jpg' height="100%" id="layoutImage" style="width: 100%;" />
			  <header>
