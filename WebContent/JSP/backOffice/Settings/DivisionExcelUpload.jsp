...
<script type="text/javascript" src="JS/backOffice/Settings/DivisionExcelUpload1.js">
</script>
...
<body>
   ...
   <div id="loder" style="display: none; position:absolute; height: 800px;width: 800px;left: 0;right: 0;top: -40px;;bottom: 0;margin: auto;z-index: 99999; "><img style="width: 165px;position: absolute;left: 0;right: 0;height: 165px;bottom: 0;top: -190px;margin: auto;" src="./images/ajax-loading.gif"/></div>
	...
	<div class="col-md-10" id="div-main"
		...
		<p>
			<span class="glyphicon glyphicon-user"></span>&nbsp;<span id="pageHeading">Division Excel upload</span>
		</p>
	...
	<form action="settingXLUpload.html?method=insertDivisionExcelFormat"
				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<a href="#collapsebOne" class="topPannel" style="color: #000000"><h3 class="panel-title"> <i
								...
								&nbsp;&nbsp;Upload Division Details
							</h3></a>
				<%-- 		<div class="navbar-right">
							<logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="UPLDIVADD" name="daymap" property="key">
						...
						<div id="collapsebOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									<div class="form-group">
										<label for="inputEmail" class="control-label col-xs-4"
											id="inputnames"></label>
										<div class="col-xs-7">
											<input type="file" name="formFile" id="Divisionfile"
								...
								<div class="col-md-3" id="txtstyle">
									<a href="settingXLUpload.html?method=DivisionExcelFormat">Download Instructions</a>
									<br/>
									<a href="settingXLUpload.html?method=DivisionExcelSampleData">Download Template</a>
								
								</div>
								
								
							
						 <logic:present name="FailedDivisionList" scope="request">
							...
							<display:table id="allstudent" name="requestScope.FailedDivisionList" class="table"
											requestURI="/SettingXLUpload.html?method=insertDivisionExcelFormat">
							...
							<display:column property="divisionName" title="Division" headerClass="heading1" />
							<display:column property="strength" title="Strength" headerClass="heading1" />
							</display:table>
						</div>
