...
<body>
	...
	<div class="content" id="div1">
		...
		<div class="col-md-09">
			<form id="myForm" action="menuslist.html?method=searchremark"
				method="post">
				<div class="input-group col-md-8" style="margin: 20px 0px;">
					...
					<div class="form-group" style="margin-bottom: 0;">
						<label for="inputPassword" class="control-label col-xs-1"
							style="text-align: left; line-height: 35px; color: #797676; font-size: 16px; font-family: Roboto,sans-serif;">From</label>
						<div class="col-xs-3">
					...
					<div class="form-group" style="margin-bottom: 0;">
						<label for="inputPassword" class="control-label col-xs-1"
							style="text-align: left; line-height: 35px; color: #797676; font-size: 16px; font-family: Roboto,sans-serif; margin-right: -32px;">To</label>
						<div class="col-xs-3">
							<input type="text" class="form-control" Placeholder="Click Here"
				...
				<div class="panel-body"
					...
					<logic:present name="remarkslist" scope="request">
						<display:table class="remarks table" pagesize="10"
							...
							requestURI="menuslist.html?method=communicationRemarksList"
					...
					<logic:present name="meetinglist" scope="request">
						<display:table class="meeting table" pagesize="10"
							...
							requestURI="menuslist.html?method=getmeeting"
 ...
 --%>
					...
					<logic:present name="bdaylist" scope="request">
						<display:table class="birthday table" pagesize="10"
							...
							requestURI="menuslist.html?method=getbdaylist"
