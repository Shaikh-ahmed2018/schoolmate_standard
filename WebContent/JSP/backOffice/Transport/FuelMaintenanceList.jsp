...
<body>
	...
	<div class="content" id="div1">	<div class="col-md-8" id="div2">
			...
			<div class="panel-heading">
				...
				<a href="fuelMenu.html?method=AddFuelDetails"><span
					...
					<span class="buttons" id="edit"
						style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" title="Edit">Modify</span>
						
						
				   <span class="buttons" id="delete"
					style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" title="Delete">Remove</span>
			...
			<div id="collapseOne" class="accordion-body collapse in">
				...
				<logic:present name="fuelList" scope="request">
						...
						<display:table id="allstudent" name="fuelList" class="table" 
							requestURI="/menuslist.html?method=fuelMaintenance" sort="list" export="false" pagesize="15" decorator="com.centris.campus.decorator.FuelMaintenanceDecorator">
