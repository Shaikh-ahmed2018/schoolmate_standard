				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading" role="tab" id="headingOne" >
							...
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapseOne" style="color: #000000"><h3 class="panel-title" id="beforeparent" style="color: #000000; vertical-align: text-top;"><i
						...
						<span class="search" style="top:-3px">
							<label style="text-align: right;color:#000000;font-family:inherit;font-weight: 500;font-size: 16px;padding: 4px;">Term</label>	 
							 				<select id="termid" name="termid" class="nil" style="color:#000000;font-family:inherit;font-size: 14px;padding: 2px">
...
<div id="collapseOne" class="panel-collapse collapse in"
				...
				<div class="panel-body"
					...
					<%--<display:table class="table" id="allstudent" name="requestScope.studentList"
					...
					<logic:present name="studentList" scope="request">
						<table class="table" id="allstudent">
							...
							<logic:iterate id="studentList" name="studentList">
								<tr>
								<td><input type='radio' name='select' class='select' style='text-align:center' value='<bean:write name="studentList" property='studentId'/><bean:write name="studentList" property='academicYearId'/> <bean:write name="studentList" property='locationId'/> <bean:write name="studentList" property='classDetailId'/> <bean:write name="studentList" property='section_id'/>'/></td>
								<td><bean:write name="studentList" property='studentAdmissionNo'/></td>
