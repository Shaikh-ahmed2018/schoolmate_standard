...
#forpenal{
	padding:15px;    font-family: Roboto Medium;    font-size: 12pt;    color: #000000;
}
#forpenal span{
			...
			<form method="post" class="form-inline">
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading"  id="headingOne">
							...
							<h3 class="panel-title" id="beforeparent"> <i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Mapping
							</h3></a>
