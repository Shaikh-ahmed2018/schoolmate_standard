	...
	<div class="content" id="div1">	<div class="col-md-8" id="div2">
		...
		<logic:present name="successmessagediv" scope="request">
			...
			<div class="panel-heading">
				...
				<span class="buttons" id="edit" style="cursor:pointer">Modify</span>
						
				<span class="buttons" id="delete" style="cursor:pointer">Remove</span>
			...
			<div id="collapseOne" class="accordion-body collapse in">
				...
				<logic:present name="VehicleDriverMapList" scope="request">
						...
						<display:table id="allstudent" name="VehicleDriverMapList" class="table" 
							requestURI="/menuslist.html?method=getVehicleDriverMapping" sort="list" export="false" pagesize="15" decorator="com.centris.campus.decorator.FuelMaintenanceDecorator">
