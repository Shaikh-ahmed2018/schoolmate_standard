	...
	<div class="content" id="div1">
		<p class="transportheader">
			<span class="glyphicon glyphicon-user" style="font-size: 27px;"></span>&nbsp;<span
				id="pageHeading">Tranport Request/Cancel</span>
		</p>
		<div class="searchWrap" style="padding: 0;">
    ...
    value='<logic:present name="historyistransport" scope="request"><bean:write name="historyistransport"></bean:write></logic:present>' />
				...
				<div id="collapseOne" class="accordion-body collapse in">
					...
					<div class="col-md-6" style="font-family: Roboto, sans-serif; font-size: 13px; color: #000; margin-top: 20px;">
						...
						<div class="form-group clearfix">
							<label for="inputPassword" class="control-label col-xs-5" 
							style="text-align: right; line-height: 35px;">Availed Transport</label>
							<div class="col-xs-7">
								<select id="istransport" name="istransport" class="form-control" required>
								...
								<tbody>
									<%-- <logic:iterate id="studentList" name="studentList">
										<tr>
											...
											<td class='<bean:write name="studentList" property='academicYearId'/> <bean:write name="studentList" property='locationId'/> studentid'><bean:write name='studentList' property="studentAdmissionNo" /></td>
											<td class='<bean:write name="studentList" property='studentId'/> stuid'><bean:write name="studentList" property='studentFullName' /></td>
											<td class='classid <bean:write name="studentList" property='classDetailId'/>'><bean:write name="studentList" property='classname' /></td>
											<td class='sectionid <bean:write name="studentList" property='sectioncode'/>'><bean:write name="studentList" property='sectionnaem' /></td>
										</tr>
									</logic:iterate> --%>
								</tbody>
							</table>
