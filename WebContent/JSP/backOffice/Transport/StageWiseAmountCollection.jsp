...
<script type="text/javascript" src="JS/backOffice/Transport/stagewiseamountcollList.js"></script>
</head>
	...
	<div class="content" id="div1">
		...
		<p class="transportheader">
				<span class="glyphicon glyphicon-user" style="font-size: 27px;"></span>&nbsp;<span
					id="pageHeading">Stage Wise Amount Setup</span>
		</p>
		</div>
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#" style="color: #fff;"><h3
						class="panel-title grade" style="font-family: Roboto,sans-serif;color: #000; line-height: 18px;">
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Stage Wise Amount Setup
					</h3></a>
