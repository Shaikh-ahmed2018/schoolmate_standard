...
<script type="text/javascript"
	src="JS/backOffice/Exam/setgradedependency.js"></script>
...
<body>
	...
	<div class="col-md-10" id="div-main"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Grade Dependency</span>
		</p>
		...
		<div class="panel-group" id="accordion" role="tablist"
			...
			<div class="panel panel-primary">
				<div class="panel-heading clearfix" role="tab" id="headingOne">
						...
						<a href="#" style="color: #000000"><h3 class="panel-title examdetails"><i class="glyphicon glyphicon-menu-hamburger"></i> &nbsp;&nbsp;Exam
							Details
						</h3></a>
					...
					<div class="col-xs-5">
						...
						<div class="form-group">
							...
							<thead>
								<tr>
									<th
										style="font-size: 13px; text-align: center; width: 95px; padding: 9px;">Exam
										Code</th>
									<th style="font-size: 13px; text-align: center; padding: 9px;">Exam
										Name</th>
									<th style="font-size: 13px; text-align: center; padding: 9px;">Start
										Date</th>
									<th style="font-size: 13px; text-align: center; padding: 9px;">End
										Date</th>
									...
									<logic:present name="examsettings" scope="request">
										<logic:iterate id="examsettings" name="examsettings"
											...
											<tr>
												...
												<td class="examCode"
													id="<bean:write name="examsettings"
															property="examid"/>"><bean:write
														name="examsettings" property="examCode" /></td>
												<td class="examname"><bean:write name="examsettings"
														property="examName" /></td>
												<td class="startdate"><bean:write name="examsettings"
														property="startDate" /></td>
												<td class="enddate"><bean:write name="examsettings"
														property="endDate" /></td>
												<td><span
													class="<bean:write name="examsettings" property="status"/>"><bean:write
															name="examsettings" property="status" /></span></td>
