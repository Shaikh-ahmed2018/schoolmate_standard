...
<div class="content" id="div1">
	...
	<div style="margin-bottom: 10px;vertical-align: top;line-height: 0;">
		...
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input readonly="readonly" style="font-size: 17px;margin-left: 20px; width: 100px;text-align: left;" value="<logic:present name="accYear"  scope="request"><bean:write name="accYear" /></logic:present>" /></label>
	...
	<div style="margin-bottom: 10px;vertical-align: top;line-height: 0;">
		...
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input readonly="readonly" style="font-size: 17px;margin-left: 20px; width: 100px;text-align: left;" value="<logic:present name="className"  scope="request"><bean:write name="className" /></logic:present>" /></label>
		<span style="font-size: 18px; color: #000; font-weight: normal;margin-left: 200px;">Section</span>
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input readonly="readonly" style="font-size: 17px;margin-left: 70px; width: 100px;text-align: left;" value="<logic:present name="sectionName"  scope="request"><bean:write name="sectionName" /></logic:present>" /></label>
	</div>
	
	<div style="margin-bottom: 10px;vertical-align: top;line-height: 0;">
		<span style="font-size: 18px; color: #000; font-weight: normal;margin-right: 30px;">Exam Code</span>
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input readonly="readonly" style="font-size: 17px;margin-left: 20px; width: 100px;text-align: left;" value="<logic:present name="examCode"  scope="request"><bean:write name="examCode" /></logic:present>" /></label>
		<span style="font-size: 18px; color: #000; font-weight: normal;margin-left: 200px;">Exam Name</span>
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input readonly="readonly" style="font-size: 17px;margin-left: 35px; width: 100px;text-align: left;" value="<logic:present name="examName"  scope="request"><bean:write name="examName" /></logic:present>" /></label>
	</div>
	
	<div style="margin-bottom: 10px;vertical-align: top;line-height: 0;">
		<span style="font-size: 18px; color: #000; font-weight: normal;margin-right: 40px;">Start Date</span>
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input id="startdate" readonly="readonly" style="font-size: 17px;margin-left: 20px; width: 100px;text-align: left;" value="<logic:present name="examStartDate"  scope="request"><bean:write name="examStartDate" /></logic:present>" /></label>
		<span style="font-size: 18px; color: #000; font-weight: normal;margin-left: 200px;">End Date</span>
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input id="enddate" readonly="readonly" style="font-size: 17px;margin-left: 60px; width: 100px;text-align: left;" value="<logic:present name="examEndDate"  scope="request"><bean:write name="examEndDate" /></logic:present>" /></label>
	</div>
	...
	<logic:present name="success" scope="request">
		...
		<div class="panel panel-primary">
			...
			<a data-toggle="collapse" data-parent="#accordion2"	href="#collapseOne" style="color: #fff;">
				<h3 class="panel-title" style="color: #000000; line-height: 18px;">
