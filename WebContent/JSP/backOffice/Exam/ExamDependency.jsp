...
<script type="text/javascript" src="JS/backOffice/Exam/SetExamDependency.js"></script>
...
<div id="dialog"></div>
	...
	<div class="searchWrap">
		<p>
			<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span	id="pageHeading">Exam Dependency Setup</span>
		</p>
	</div>
		...
		<div class="panel panel-primary">
			...
			<a data-toggle="collapse" data-parent="#accordion2"	href="#collapseOne" style="color: #fff;">
				<h3 class="panel-title exam" style="color: #000000; line-height: 18px;">
					<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Exam Dependency List
				</h3></a>
			</div>
