...
<script type="text/javascript" src="JS/backOffice/Exam/Examtimetableclass.js"></script>
<style>
/* #allstudent tr td {
	color: black;
	text-align: center;
		...
		<div class="panel-group" id="accordion" role="tablist"
			...
			<div class="panel panel-primary">
				<div class="panel-heading clearfix" role="tab" id="headingOne">
						...
						<a href="#" style="color: #000000"><h3 class="panel-title class"><i class="glyphicon glyphicon-menu-hamburger"></i> &nbsp;&nbsp;Class List</h3></a>
		...
		<div class="clearfix" id="inputcolor">
			<div class="col-md-6" id="txtstyle"
				...
				<div class="form-group clearfix">
					...
					<div class="col-xs-5">
						<input type="text" readonly="readonly" name="accyear" onkeypress="HideError()" id="location" class="form-control" style="text-align: left;"
