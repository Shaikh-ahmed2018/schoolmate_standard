			...
			<div id="gradeOne" class="accordion-body collapse in">
				...
				<div class='clearfix' id="inputcolor">
					<div class="col-md-6"  id="txtstyle" style="font-size: 13px; color: #000;">
			             <div class="form-group clearfix">
						 	<label for="inputEmail" class="control-label col-xs-4" style="text-align: left; line-height: 35px;">Branch</label>
									<div class="col-xs-6">
				...
				<div class="form-group clearfix">
					<label for="inputEmail" class="control-label col-xs-4" style="text-align: left; line-height: 35px;">Exam Code</label>
						<div class="col-xs-6">
						 <input type="text" readonly="readonly" name="examCode" onkeypress="HideError()" id="examCode" class="form-control" value='<logic:present name="examCode" scope="request"><bean:write name="examCode"></bean:write></logic:present>'/>
						</div>
				...
				<!-- <div id = "markstable"></div> -->
					<div class="form-group scrollbar">
						...
						<th style="font-size: 15px; text-align: left;">Class</th>
						<th style="font-size: 15px; text-align: center;">Division</th>
