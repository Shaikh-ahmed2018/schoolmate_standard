...
<body>
	...
	<div class="content" id="div1">
			...
			<div class="col-md-4">
				...
				<div class="form-group clearfix">
						<label for="inputPassword" class="control-label col-xs-5"
						style="text-align: left;font-size:16px;font-weight:300;color:#000000;line-height: 2; padding-right:0px;">Next Academic
						Year </label>
						<div class="col-xs-7" style=" padding: 0px;">
		...
		<div class="panel panel-primary">
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body" id="promotionClass" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;">
