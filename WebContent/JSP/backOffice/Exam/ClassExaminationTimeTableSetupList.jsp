...
<script type="text/javascript">
	 $(document).ready(function(){
		$("#allstudent tbody tr").click(function(){
			...
			window.location.href="examTimetablePath.html?method=setClassSubjectExamTimeTableDetails&accYear="+splitVal[0]+"&classId="+splitVal[1]+"&examId="+splitVal[3];
		});
	}); 
</script>
<style>
...
<div id="dialog"></div>
	...
	<div style="margin-bottom: 10px;vertical-align: top;line-height: 0;">
		...
		<span style="font-size: 18px; color: #000; font-weight: normal;margin-left: 50px;">Class</span>
		...
		<div class="panel panel-primary">
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<display:table name="requestScope.getClassExamWithOutSpecializationDetails"
						requestURI="/examTimetablePath.html?method=setClassExamTimeTableDetails" pagesize="8"
						export="false" class="table" id="allstudent" decorator="com.centris.campus.decorator.ExamAccYearDecorator">

						<display:column property="sno1" title="Sl.No." class="${allstudent.accyearid},${allstudent.classid},${allstudent.sectionid},${allstudent.examid}"></display:column> 

						<display:column property="examcode" sortable="true" title="Exam Code <img src='images/sort1.png' style='float: right'/>" /> 

						<display:column property="examName" sortable="true" title="Exam Name <img src='images/sort1.png' style='float: right'/>" /> 
						...
						<display:column property="section" sortable="true" title="Section <img src='images/sort1.png' style='float: right'/>" />
