...
<html lang="en">
<head>
   <script type="text/javascript" src="JS/backOffice/Exam/gradeSettings.js"></script>
</head>
...
<body>
	<form method="POST" action="examCreationPath.html?method=addGradeSettings" id="myform">
	...
	<div class="content" id="div1">
		<p>
				<span class="glyphicon glyphicon-user" style="font-size: 27px;"></span>&nbsp;<span
					id="pageHeading">Grade Setup</span>
		</p>
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Grade
						List
					</h3></a>
