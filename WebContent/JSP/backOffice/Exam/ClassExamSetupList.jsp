...
<div id="dialog"></div>
	...
	<div style="margin-bottom: 10px;vertical-align: top;line-height: 0;">
		...
		<label style="font-size: 18px; color: #000000; font-weight: normal;"><input readonly="readonly" style="font-size: 17px;margin-left: 20px; width: 125px;text-align: center;" value="<logic:present name="accYear"  scope="request"><bean:write name="accYear" /></logic:present>" /></label>
