		...
		<div class="academic_year clearfix">
			<div class="col-md-4">
				<div class="form-group clearfix">
						...
						style="text-align: left;font-size:16px;font-weight:300;color:#000000;line-height: 2; padding-right:0px;">Academic
						Year </label>
				...
				<div class="form-group clearfix">
						<label for="inputPassword" class="control-label col-xs-5"
						style="text-align: left;font-size:16px;font-weight:300;color:#000000;line-height: 2; padding-right:0px;">Next Academic Year </label>
						<div class="col-xs-7" style=" padding: 0px;">
			...
			<div class="col-md-4">
				<div class="form-group clearfix">
						<label for="inputPassword" class="control-label col-xs-5"
						style="text-align: left;font-size:16px;font-weight:300;color:#000000;line-height: 2; padding-right:0px;">Class </label>
						<div class="col-xs-7" style=" padding: 0px;">
				...
				<div class="form-group clearfix">
						<label for="inputPassword" class="control-label col-xs-5"
						style="text-align: left;font-size:16px;font-weight:300;color:#000000;line-height: 2; padding-right:0px;">Division</label>
						<div class="col-xs-7" style=" padding: 0px;">
			...
			<div class="specName clearfix">
				...
				<div class="form-group clearfix">
						<label for="inputPassword" class="control-label col-xs-5"
						style="text-align: left;font-size:16px;font-weight:300;color:#000000;line-height: 2; padding-right:0px;">Specialization </label>
						<div class="col-xs-7" style=" padding: 0px;">
