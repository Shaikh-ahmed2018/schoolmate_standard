...
<script type="text/javascript"
	src="JS/backOffice/Exam/editExamination.js"></script>
		...
		<div class="col-md-8" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Exam details</span>
			</p>
		</div>
				...
				<div class="panel-heading" role="tab" id="headingOne">
					<a data-toggle="collapse" data-parent="#accordion2"
						href="#collapseOne" style="color: #fff;"><h3
							...
							<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Exam
							Details
						</h3></a>
					<div class="navbar-right">
						<a href="menuslist.html?method=createExam"><span
							class="buttons" data-toggle="tooltip"
							data-placement="bottom" title="Add">New</span></a> <span
					...
					<div class="panel-body"
						...
						<logic:present name="examDetailsList" scope="request">
							<display:table class="table" pagesize="10"
								...
								requestURI="menuslist.html?method=examList"
