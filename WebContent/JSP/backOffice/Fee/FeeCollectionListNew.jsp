...
<script type="text/javascript" src="JS/backOffice/Fee/FeeCollectionListNew.js"></script>
	...
	value='<logic:present name='historysearch' scope='request'><bean:write name='historysearch'></bean:write></logic:present>'/>				
					...
					<div id="collapseOne" class="panel-collapse collapse in "
						...
						<div class="panel-body own-panel">
							<div class="col-md-6"
								style="font-family: Roboto,sans-serif; font-size: 11pt; color: #000; margin-top: 20px;">
