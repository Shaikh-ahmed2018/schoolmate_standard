					...
					<!-- Term Name -->
						...
						<logic:iterate id="FeeCollection" name="FeeCollectionVo" property="feeNamelist" > 	
							<tr class="collapsable">
								...
								<td id='<bean:write name="FeeCollection" property="fineAmount" />,<bean:write name="FeeCollection" property="advanceCarry" />,<bean:write name="FeeCollection" property="dueCarry" />,<bean:write name="FeeCollection" property="concessionAmt" />'>
								
							<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="FEECOLLADD" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											 <input type="button" name="<bean:write name="FeeCollection" property="status" />" id="<bean:write name="FeeCollection" property="termId" />" class="pay buttons" maxlength="50" value="Pay Now" style="padding: 1px 5px;border: none;" />
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>
							...
							<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="FEECOLLDIS" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											 <input type="button" id="<bean:write name="FeeCollection" property="paidDate" />" name="<bean:write name="FeeCollection" property="paidAmt" />" class="buttons view" value="View" style="display:none;padding: 1px 5px;border: none;"/>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>
							...
							<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="FEECOLLDWD" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											 <input type="button" id="<bean:write name="FeeCollection" property="paidDate" />" name="<bean:write name="FeeCollection" property="recieptNo" />,<bean:write name="FeeCollection" property="paidAmt" />,<bean:write name="FeeCollection" property="paymode" />,<bean:write name="FeeCollection" property="ddno" />,<bean:write name="FeeCollection" property="dddate" />" class="buttons print" value="Print" style="display:none;padding: 1px 5px;border: none;"/>
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present>
