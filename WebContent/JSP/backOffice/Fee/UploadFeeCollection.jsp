...
<script type="text/javascript" src="JS/backOffice/Fee/UploadFeeCollection.js"></script>
</head>
...
<body>
 <div class="col-md-10" id="div-main"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Fee Collection Upload</span>
		</p>
		...
		<form action="feeupload.html?method=insertFeeXSL" id="excelfileupload" name="feecollectionform" method="post" enctype="multipart/form-data">
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" align="center">
							<div class="panel-body">
								<div class="col-md-6" id="txtstyle" style="padding: 0;">
									<div class="form-group clearfix">
										<label for="inputEmail" class="control-label col-xs-4"
											id="inputnames"></label>
										<div class="col-xs-7">
											<input type="file" name="formfile" id="studentfile" onchange="checkFileSize(this)"; class="form-control" style="height: auto;"></input>
										</div>
									</div>
								</div>
								...
								<div class="col-md-3" id="txtstyle" style="padding: 10px 0px;">
									<a href="feeupload.html?method=downloadfileformat">Download Template</a>
								</div>
								...
								<logic:present name="FailFeeList" scope="request">
									...
									<div class="col-md-12">
										...
										<display:table id="allstudent" name="requestScope.FailFeeList" class="table" requestURI="/feeupload.html?method=insertFeeXSL">
											...
											<%-- <display:column property="fineAmount" title="Fine" headerClass="heading1" /> --%>
											<display:column property="paymentmode" title="Mode" headerClass="heading1" />
											<display:column property="paymentdate" title="Date" headerClass="heading1" />
