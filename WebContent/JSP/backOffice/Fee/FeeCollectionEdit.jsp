...
<script type="text/javascript" src="JS/backOffice/Fee/FeeCollectionEdit.js"></script>
			...
			<div class="panel-group" id="accordion" role="tablist"
				...
				<div class="panel panel-default">
					...
					<div class="navbar-right">
							...
							<span id="saveid" class="buttons" data-toggle="tooltip" data-placement="bottom" title="Pay Fee"> Save
	...
	$(document).ready(function(){
	    $('[data-toggle="tooltip"]').tooltip();   
			...
			<div class="feebody panel-group" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<input type="hidden" id="hsection" value="<logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="sectionId"/></logic:present>"/>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif" id="addmissionNo"><logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="addmissionno"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="accYearname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="classname"/></logic:present>-<logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="sectionname"/></logic:present>
										</label>
									</div>
								</div>
								</div>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="studentname"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="term"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif" id="concessionPercent"><logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="concession"/></logic:present>%
										</label>
									</div>
								</div>
				...
				<table  class="table" id="allstudent" style="font-family: Roboto,sans-serif;color: #897676;" >
										...
										<tr>
											...
											<logic:iterate name="FeeCollectionVo" property="feeNamelist" id="dateVO">
												...
												<input type="hidden" class="hconcessionpercentArray" value='<bean:write name="dateVO" property="concessionpercentArray"/>'></input>	
													...
													<td class="actualamount" style="text-align: right;"><input type="text" class="feeAmount form-control" style="margin:-7px 0px;width: 100%; text-align: right;" value="<bean:write name="dateVO" property="feeAmountArray" />" />
													...
													<td class="concessionamount" style="text-align: right;"><input type="text" class="feePayingAmount form-control" style="margin:-7px 0px;width: 100%; text-align: right;" value="<bean:write name="dateVO" property="feePayingAmountArray" />"/></td>
											...
											<td id="currentpayment" style="text-align: right;"><input type="text" class="currentpayment1 form-control" id="currentpayment1" style="margin:-7px 0px;text-align: right;width: 100%;" ></td>
											</tr>
