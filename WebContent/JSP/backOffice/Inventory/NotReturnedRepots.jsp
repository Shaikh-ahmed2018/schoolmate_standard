...
<script type="text/javascript"
	src="JS/backOffice/Inventory/NotReturnedReport.js"></script>
...
<body>
	<div class="col-md-10" id="div-main"
		...
		<p style="margin: 20px 0px;">
			<img src="images/addstu.png" />&nbsp;<span>Not Returned Reports</span>
		</p>
		...
		<form action="menuslist.html?method=getNotReturnedReportAction" name="InventoryTransactionForm"
			id="notreturnedreport" enctype="multipart/form-data" method="post">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<a data-toggle="collapse" data-parent="#accordion"
								...
								class="glyphicon glyphicon-menu-hamburger"></i> &nbsp;&nbsp;Not Returned Reports
							</h3></a>
					 ...
					 <!-- <div class="navbar-right">
							...
							</a> <a href="menuslist.html?method=driverList"> <span
