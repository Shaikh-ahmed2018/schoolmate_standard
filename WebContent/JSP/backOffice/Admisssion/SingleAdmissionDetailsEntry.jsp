				...
				<div id="collapseOne" class="panel-collapse collapse in"
					...
					<div class="panel-body">
						...
						<div class="col-md-6"
							...
							<div class="form-group">
								<label for="inputPassword" class="control-label col-xs-4"
									style="text-align: right; line-height: 35px;">PSchool Name </label>
								<div class="col-xs-7">
				...
				<div class="panel-body">
					<div class="col-md-6"
						...
						<div class="form-group">
							...
							<div class="col-xs-7">
								<input type="text" placeholder="" onkeypress="HideError()"
									name="dateofAppointmentId" id="dateofAppointmentId"
									class="form-control"
									value='' />
							</div>
						</div>
						...
						<div class="form-group">
							<label for="inputPassword" class="control-label col-xs-4"
								style="text-align: right; line-height: 35px;" id="inputnames">Status
							</label>
							<div class="col-xs-7">
								<select id="status" name="status" class="form-control">
									...
									<option value="Called For Discussion">Called For
										Discussion</option>
					...
					<div class="col-md-6"
						...
						<div class="form-group">
							<label for="inputPassword" class="control-label col-xs-4"
								style="text-align: right; line-height: 35px;">Appointment Time
							</label>
							<div class="col-xs-7">
								<div id="datetimepicker3" class="input-append">
									<input type="text" data-format="hh:mm:ss" size="8"
										onkeypress="HideError()"  name="starttime"
										id="starttime" class="form-control"
										value='' /><img
										src="./images/time1.jpg" width="30" height="30" class="add-on"
						...
						<div class="form-group">
							<label for="inputPassword" class="control-label col-xs-4"
								id="inputnames" style="text-align: right; line-height: 35px;">Remarks </label>
							<div class="col-xs-7">
