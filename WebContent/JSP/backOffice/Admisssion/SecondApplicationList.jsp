		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<a href="parentrequiresappointment.html?method=secondadmissionformat"> <span
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<logic:present name="SecondAdmissionDetailsList" scope="request">
						<display:table class="table" id="allstudent"
							name="SecondAdmissionDetailsList" pagesize="10"
					
							requestURI="/parentrequiresappointment.html?method=secadmissionapplication"
							decorator="com.centris.campus.decorator.SecondAdmissionDetailsDecorator">
...
<%-- 								title="Academic Year<img src='images/sort1.png' style='float: right'/>" /> --%>
							...
							<display:column property="stu_firstname" sortable="true"
								title="Student Name<img src='images/sort1.png' style='float: right'/>" />

							<display:column property="date_birth" sortable="true"
...
<%-- 								title="Parent Name<img src='images/sort1.png' style='float: right'/>" /> --%>
							...
							<display:column property="previous_school" sortable="true"
								title="Previous School<img src='images/sort1.png' style='float: right'/>" />
