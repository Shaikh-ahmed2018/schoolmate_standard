...
<script type="text/javascript"
	src="JS/backOffice/Admission/ThirdApplicationFormat.js"></script>
<style>
<
style>.save:hover {
	cursor: pointer;
...
<body>
	...
	<div class="col-md-12" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
		...
		<div class="" id="div2">
          <div id="dialog"></div>
			<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span	id="pageHeading">Registration Form Format For Class XI</span>
			</p>
		</div>
		...
		<form action="parentrequiresappointment.html?method=saveThirdAdmissionApplication" enctype="multipart/form-data" id="formstudent" method="post">
					...
					<div class="row">
						<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;">
                                ...
                                <div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" name="placeofBirth" id="placeOfBirthId" class="form-control" />
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select name="casteCategory" id="casteCategoryId" tabindex="16"
											class="form-control">
											<option value="">----------Select----------</option>
                            ...
                            <div class="form-group clearfix">
								<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 20px;">Name of Qualifying Examination<font color="red">*</font></label>
								<div class="col-xs-7">
									<select class="form-control" name="qualifying" id="qualifyingId">
										<option value="">----------Select----------</option>
							...
							<div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Group Prefered<font color="red">*</font></label>
								<div class="col-xs-7">
							...
							<div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Optional Subject</label>
								<div class="col-xs-7">
									<input type="text" name="optionalsubject" id="optionalsubjectId" maxlength="20" class="form-control" />
								</div>
							</div>
						...
						<div class="form-group clearfix" style="margin-top:20px;">
							<label for="inputEmail" class="control-label col-xs-5"
								style="text-align: right; line-height: 35px;margin-left:-122px;margin-top:2px;">MarkSheet Upload</label>
							<div class="col-xs-7">
								<input type="file" id="uploadmarksheet" name="marksheet" class="form-control" style="height: 20%;" /> 
							</div>
						</div>
				</div>
		</form>
