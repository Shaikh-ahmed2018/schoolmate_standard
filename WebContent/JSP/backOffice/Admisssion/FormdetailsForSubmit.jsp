...
<body>
	   ...
	   <div id="loader" style="display: none; position:absolute; height: 800px;width: 800px;left: 0;right: 0;top: -40px;;bottom: 0;margin: auto;z-index: 99999; "><img style="width: 165px;position: absolute;left:0;right: 0;height: 165px;bottom: 0;top: -285px;margin: auto;" src="./images/ajax-loading.gif"/></div>
				...
				<div class="panel-group" id="accordion" role="tablist"
					...
					<div class="panel panel-primary">
						<div class="panel-heading clearfix" role="tab" id="headingOne">
							...
							<div class="navbar-right" style="top: -3px; right: 9px;">
						...
						<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="panel-body" id="inputcolor">
								<div class="col-md-6"
                             ...
                             <div class="form-group clearfix">
								<label for="inputEmail" class="control-label col-xs-4"
									...
									Year</label>
								<div class="col-xs-7">
									<select id="Acyearid" name="accyear" class="form-control" disabled="disabled"
										required>
                                 ...
                                 <div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<select id="stream" disabled="disabled" name="stream" style="background-color: white;"
									...
									<div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<textarea class="form-control" style="background-color: white;" name="address" onkeypress="HideError()" readonly id="address"><logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="address" /></logic:present></textarea>
										</div>
									</div>
								...
								<div class="col-md-6"
                                    ...
                                    <div class="form-group clearfix">
									  <label for="inputEmail" class="control-label col-xs-4" style="text-align: right; line-height: 35px;">Branch<span style="color: red;">*</span></label>
										<div class="col-xs-7">
											<select id="locationname" name="locationnid" disabled="disabled" class="form-control" required>
					                ...
					                <div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<select id="class" disabled="disabled" name="classname" style="background-color: white;"
												class="form-control" required>
												<option value="">----------Select----------</option>
									...
									<div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<select name="stu_parrelation" id="stu_parrelation" style="background-color: white;"
					          ...
					          <input type="hidden" name="hiddenaccyearId" id="hiddenaccyearId"
										value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="accyearId"/></logic:present>" />
                              <input type="hidden" name="hiddenloc" id="hiddenloc"
										value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="location_id"/></logic:present>" />

									<input type="hidden" name="updateClassCode" id="updateClassCode"
									...
									<input type="hidden" name="hiddenrelationname" id="hiddenrelationname"
										value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="stu_parrelation"/></logic:present>" />
