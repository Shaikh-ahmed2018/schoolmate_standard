		...
		<div class="col-md-8" id="div2">
			...
			<p style="margin: 16px 0px;">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
					id="pageHeading">Called For Evaluation</span>
			</p>
		</div>
			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Called
						For Evaluation
					</h3></a>
				...
				<div class="navbar-right">
					...
					<span class="buttons" id="editcalledadmission"
				...
				<div class="panel-body"
					...
					<logic:present name="TemporaryAdmissionDetailsList" scope="request">
						<display:table class="table" id="allstudent"
							...
							requestURI="/menuslist.html?method=CalledForEvaluationList"
							...
							<display:column property="mobile_number" sortable="true"
								title="Mobile Number<img src='images/sort1.png' style='float: right'/>" />

							<display:column property="appointment_date" sortable="true"
								title="Appointment Date<img src='images/sort1.png' style='float: right'/>" />
