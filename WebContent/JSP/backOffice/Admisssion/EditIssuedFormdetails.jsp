...
<div id="add" class="tab-pane">
   ...
   value="<logic:present name="historytabstatus" scope="request"><bean:write name="historytabstatus"/></logic:present>" />				
		...
		<form enctype="multipart/form-data" id="formstudent" >
   ...
   value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="accyearId" /></logic:present>"></input>
		<input type="hidden" class="form-control" id="locname"  value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="location_id" /></logic:present>"></input>
		...
		<input type="hidden" id="updateenquiryid" value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="enquiryid" /></logic:present>' />
				...
				<div class="panel panel-primary">
					<div class="panel-heading clearfix" role="tab" id="headingOne">
	                        ...
	                        <div class="navbar-right" >
								 <span style="top:3px;" id="save" class="buttons">Save</span>
								 <span style="top:3px;"class="buttons" id="back1">Back</span>
							</div>
                           ...
                           <div class="form-group clearfix">
							...
							<div class="form-group clearfix">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7"> 
										<input type="text" name="parentfirstName" onkeypress="HideError()" class="form-control" id="parentfirstName" value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="parentfirstName" /></logic:present>"></input>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" class="form-control" name="parentEmailId"
											...
											value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="parentEmailId" /></logic:present>"></input>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<textarea class="form-control" name="address" onkeypress="HideError()"  id="address"><logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="address"/></logic:present></textarea>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" class="form-control" maxlength="50"
											...
											onkeypress="HideError()" value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="parent_LastName" /></logic:present>'/>
									</div>
								</div>
	...
	<input type="hidden" name="hiddenloc" id="hiddenloc" value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="location_id"/></logic:present>"/>
	<input type="hidden" name="updateClassCode" id="updateClassCode" value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="classid"/></logic:present>"/>
	<input type="hidden" name="hiddenStreamId" id="hiddenStreamId" value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="streamId"/></logic:present>"/>	
	<input type="hidden" name="hiddenrelationname" id="hiddenrelationname" value="<logic:present name="edit_issuedlist" ><bean:write name="edit_issuedlist" property="stu_parrelation"/></logic:present>"/>	
