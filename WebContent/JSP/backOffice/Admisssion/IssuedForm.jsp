...
<body>
	...
	<div id="issued" class="tab-pane">
      ...
      <div class="content" id="div1">
		...
		<form id="myForm" action="menuslist.html?method=tempadmissionMenu" method="post">
			...
			<div class="panel-heading">
				...
				<div class="navbar-right">
				     ...
				     <span
						...
						data-placement="bottom" title="Edit">Modify</span>
				...
				<div class="panel-body"
					...
					<logic:present name="issuedList" scope="request">
						<display:table class="table" id="allstudent"
							...
							<display:column property="parentfirstName"  href="menuslist.html?method=issuedformEdit"
							    sortable="true" 
