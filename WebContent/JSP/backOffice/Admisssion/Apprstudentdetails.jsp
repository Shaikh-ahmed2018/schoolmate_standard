...
<body>
	<div id="add" class="tab-pane">
		<div id="loader"
			...
			<img src="images/ajax-loadersmall.gif" width="150px" height="150px" />
		</div>
   ...
   value="<logic:present name="historytabstatus" scope="request"><bean:write name="historytabstatus"/></logic:present>" />	
			...
			<form action="" enctype="multipart/form-data" id="formstudent"
				...
				<input type="hidden" id="updateenquiryid"
					value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="enquiryid" />
		</logic:present>'></input>
				...
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
					<div class="panel panel-primary">
						...
						<div class="navbar-right">
								...
								<span class="buttons" id="back1" style="margin-left:2px;top: 6px;">Back</span>
							 
							 
								<span style="margin-right:-4px;top:-15px;margin-left: -56px;" class="buttons" id="cancelled">Cancel</span>
							...
							<div class="panel-body">
							 ...
							 <div class="form-group clearfix">
									...
									<div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<textarea class="form-control" name="address"  readonly id="address"><logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="address" /></logic:present></textarea>
										</div>
									</div>
								...
								<div class="col-md-6"
									...
									<div class="form-group clearfix">
										<label for="inputEmail" class="control-label col-xs-4"
											style="text-align: right; line-height: 35px;" id="inputnames">Branch
											<span style="color: red;">*</span>
										</label>
										<div class="col-xs-7">
											<select id="location" disabled="disabled" name="location"
												class="form-control" required>
									...
									<div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<select id="class" disabled="disabled" name="classname" class="form-control" required>
												<logic:present name="ClassList">
													<logic:iterate id="ClassList" name="ClassList">
														<option
															value="<bean:write name="ClassList" property="classId"/>">
									...
									<div class="form-group clearfix">
										<label for="inputPassword" class="control-label col-xs-4"
											style="text-align: right; line-height: 35px;">Approved Reason<span
											style="color: red;">*</span>
										</label>
										<div class="col-xs-7">
											<input type="text" class="form-control" name="reason"
												id="parents_name" onkeypress="HideError()" maxlength="10" style="margin-top:6px;"
												value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="reason" /></logic:present>'
												readonly />
										</div>
									</div>
