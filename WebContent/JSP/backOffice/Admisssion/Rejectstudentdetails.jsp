				...
				<div class="panel-group" id="accordion" role="tablist"
					...
					<div class="panel panel-primary">
						<div class="panel-heading clearfix" role="tab" id="headingOne">
							...
							<div class="navbar-right" style="top: 0px; line-height: 1.3;right: 5px;">
						...
						<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="panel-body">
								<div class="col-md-6"
							      ...
							      <div class="form-group clearfix">
										<label for="inputEmail" class="control-label col-xs-4" style="text-align: right; line-height: 35px;" id="inputnames">Stream
											<span style="color: red;">*</span>
										</label>
										<div class="col-xs-7">
											<select id="stream" disabled="disabled" name="stream" class="form-control" required>
									...
									<div class="form-group clearfix">
										...
										<div class="col-xs-7">
											<textarea class="form-control" name="address" onkeypress="HideError()" readonly id="address"><logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="address" />
								...
								<div class="form-group clearfix">
								    ...
								    <div class="form-group clearfix">
										<label for="inputPassword" class="control-label col-xs-4"
											style="text-align: right; line-height: 35px;">Rejected Reason<span
											style="color: red;">*</span>
										</label>
										<div class="col-xs-7">
											<input type="text" class="form-control" name="rejectreason"
												id="rejectreason" onkeypress="HideError()" maxlength="10"
												value='<logic:present name="edit_issuedlist"><bean:write name="edit_issuedlist" property="rejectreason" /></logic:present>'
												readonly />
										</div>
									</div>
