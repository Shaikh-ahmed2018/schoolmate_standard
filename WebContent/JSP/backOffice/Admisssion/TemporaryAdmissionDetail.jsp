		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<a href="menuslist.html?method=AddNewAdmissionApplication"> <span
						class="buttons">New</span>
					</a> <span class="buttons" id="editadmission">Modify</span>
				...
				<div class="panel-body"
					...
					<logic:present name="TemporaryAdmissionDetailsList" scope="request">
						<display:table class="table" id="allstudent"
							...
							requestURI="/menuslist.html?method=admissionsList"
