		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<a href="menuslist.html?method=thirdadmissionformat"> <span
						class="buttons" data-toggle="tooltip"
						data-placement="bottom" title="Add">New</span>
					</a> <span class="buttons" id="editadmission"
						data-toggle="tooltip" data-placement="bottom" title="Edit">Modify</span>


					<span class="buttons" id="delete"
						data-toggle="tooltip" data-placement="bottom" title="Delete">Remove</span>
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<logic:present name="ThirdAdmissionDetailsList" scope="request">
						<display:table class="table" id="allstudent"
							name="ThirdAdmissionDetailsList" pagesize="10"
							requestURI="/parentrequiresappointment.html?method=Thirdadmissionformat"
							decorator="com.centris.campus.decorator.ThirdadmissionDetailsDecorator"> 
...
<%-- 								title="Academic Year<img src='images/sort1.png' style='float: right'/>" /> --%>
							...
							<display:column property="stu_name" sortable="true"
...
<%-- 								title="Parent Name<img src='images/sort1.png' style='float: right'/>" /> --%>
							...
							<display:column property="pre_school" sortable="true"
								title="PreviousSchool<img src='images/sort1.png' style='float: right'/>" />
								
<%-- 							<display:column property="total_matrks" sortable="true"  --%>
<%-- 								title="TotalMarks<img src='images/sort1.png' style='float: right'/>" />   --%>
