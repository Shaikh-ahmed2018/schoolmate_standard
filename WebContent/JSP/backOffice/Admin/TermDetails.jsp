					...
					<div class="navbar-right">
							...
							<%-- <logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="TRMADD" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											 <span class="buttons" id="delete">InActive</span> 
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present> --%>
							...
							<%-- <logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="TRMADD" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">
											 <span class="buttons" id="deleteId">Delete</span> 
										</logic:equal>
									</logic:equal>
								</logic:iterate>
							</logic:present> --%>
				...
				<div id="collapseOne" class="accordion-body collapse in">
					<div class="panel-body"
						...
						<div class=row>
							...
							<logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
								<logic:equal name="daymap" property="key" value="TRMDEL">
									<logic:equal value="true" name="daymap" property="value">
						...
						<div id=listtermdetail>
							<logic:present name="termlist" scope="request">
								<table class="table" id="allstudent">
									<thead>
										<tr>
										    <th>Sl.No.</th>
											<th style="width: 117px;">Academic Year</th>
											<th>Branch</th>
											<th>Term Name</th>
											<th>Start Date</th>
											<th>End Date</th>
									...
									<tbody>
										<logic:iterate id="termlist" name="termlist">
											<tr>
												<%-- <td><span name='select' class='academic_Checkbox_Class'
													value='<bean:write name="termlist" property='termid'/>,'
													id='academicCheckBox_<bean:write name="termlist" property='termid'/>,'></span>
													<bean:write name="termlist" property='sno' /></td> --%>
											<td><input type='checkbox' name='select' class='academic_Checkbox_Class' id='academicCheckBox_"+<bean:write name="termlist" property='termid'/>+",' value='<bean:write name="termlist" property='termid'/>' /></td>
												...
												<%-- <td class="status"><bean:write name="termlist" property='status' /></td>
												<td><bean:write name="termlist" property='remark' /></td> --%>
											</tr>
										</logic:iterate>
									</tbody>
								</table>
					...
					<div><span class="note">2 - Delete last record and enter new record.</span></div>
					</div>
						<div class='pagebanner'>
							<select id='show_per_page' style="margin-left: 10px;"><option value='50'>50</option>
