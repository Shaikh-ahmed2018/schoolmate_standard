	...
	<input type="hidden" name="searchterm" class="searchtermclass"
		...
		<div class="errormessagediv" align="center" style="display: none;">
			...
			<div class="panel-heading">
				<h3 class="panel-title" style="color: #000000;font-family:Poppins;">Academic Year Details</h3>
				<div class="navbar-right" >
					...
					<span class="btn btn-xs btn-primary margin-t-5" data-toggle="modal" data-target="#myModal">
					<span class="glyphicon glyphicon-plus" ></span>Add Academic year</span>				
							...
							<div class="form-group clearfix">
								...
								<div class="col-xs-7">
									<input type="text" name="enddate" id="enddate" readonly="readonly"
										 placeholder="End Date" onclick="HideError(this)" class="form-control date hasDatepicker" value=''></input>
			               ...
			               <div class="col-md-6"
							...
							<div class="form-group clearfix">
								...
								<div class="switch-cirle"></div>
									...
									<select style="display: none;" id="status" name="status" class="form-control">
			 ...
			 <logic:present name="academicyearlist" scope="request">
				<table class="table" id="allstudent">
					...
					<logic:iterate name='academicyearlist' id="academicyearlist">
						<tr id="<bean:write name='academicyearlist' property="acadamic_id"/>">
						<td><bean:write name='academicyearlist' property="sno" /></td> 
						<td><bean:write name='academicyearlist' property="acadamic_name" /></td> 
						<td><bean:write name='academicyearlist' property="startDate" /></td> 
						<td><bean:write name='academicyearlist' property="endDate" /></td>
						<td><bean:write name='academicyearlist' property="description" /></td>
						...
						<logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="ACCYRUPD" name="daymap" property="key">
				                      ...
				                      <span  data-toggle="modal" data-target="#myModal" class="btn btn-xs btn-primary margin-t-5 editDesignationId" title="Edit"><span class="glyphicon glyphicon-edit"></span> Edit</span>
				                       </logic:equal>
				                    </logic:equal>
				                 </logic:iterate>
				           </logic:present>
								 ...
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="ACCYRDEL" name="daymap" property="key">
										<logic:equal value="true" name="daymap" property="value">	
				                         ...
				                         <span  class="btn btn-xs btn-primary margin-t-5 inactive" title="Active/Inactive"><span class="glyphicon glyphicon-link"></span> Inactive</span>
				                        </logic:equal>
				                   </logic:equal>
				                 </logic:iterate>
				           </logic:present>
