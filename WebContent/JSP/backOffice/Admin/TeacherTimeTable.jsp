...
<body>
	<div class="col-md-10" style="font-family: Roboto Medium; font-size: 20pt; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; margin-top: -6px;">
				...
				<div class="panel-heading" role="tab" id="headingOne">
					<h3 class="panel-title" style="color: #000000;">
						...
						<div class="navbar-right" >
							...
							<span  id="UpdateTimeTable" class="buttons">Save</span>
