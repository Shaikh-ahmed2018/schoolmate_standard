...
<script type="text/javascript">
	function handle(e) {
		...
		if (e.keyCode === 13) {
			...
			window.location.href = "menuslist.html?method=acdamicYearPlanList&searchTerm="
				...
				<div class="panel-body"
					...
					<logic:present name="AcadamicYearPlanList">
						...
						<table class="table" id="allstudent">
							...
							<tbody>
								<logic:iterate name='AcadamicYearPlanList'
									id="AcadamicYearPlanList">
									<tr>
										<td><input type='checkbox' name='select' class='select'
											style='text-align: center'
											id='<bean:write name='AcadamicYearPlanList' property="eventid"/>' /></td>
										<td><bean:write name='AcadamicYearPlanList'
												property="Branch" /></td>
										<td><bean:write name='AcadamicYearPlanList'
												property="title" /></td>
										<td><bean:write name='AcadamicYearPlanList'
												property="venue_details" /></td>
										<td><bean:write name='AcadamicYearPlanList'
												property="date" /></td>
										<td><bean:write name='AcadamicYearPlanList'
