...
<script type="text/javascript" src="JS/backOffice/Student/studentVisa.js"></script>
...
<body>
	...
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		<p><img src="images/addstu.png" /><span id="pageHeading">Student VISA</span></p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Student VISA
							</h3></a>
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						<div class="panel-body own-panel">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select class="form-control" tabindex="2"
											name="purpose" id="purpose" onchange="HideError(this)" >
											<option value="">----------------Select---------------</option>
											<option value="applypassport">Applying For Passport</option>
											<option value="renewal">Passport Renewal</option>
											<option value="applyvisa">Applying For VISA</option>
										</select>
									</div>
								</div>
								
								<div class="form-group clearfix" id="passno">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">Passport No<font color="red">*</font></label>
									<div class="col-xs-7">
										<input type="text" name="passportno" tabindex="1" id="passportno"
											maxlength="25" class="form-control" onkeypress="HideError(this)"
							...
							<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;margin-top: 10px;">
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">Print With Address</label>
									<div class="col-xs-7">
										<select class="form-control"  tabindex="3" name="printadd" id="printadd" >
