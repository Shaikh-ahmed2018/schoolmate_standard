...
<script type="text/javascript"
	src="JS/backOffice/Student/TransferCertificate.js"></script>
<style>
.form-group{
margin-bottom: 5px;}
.save:hover {
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i	class="glyphicon glyphicon-menu-hamburger"></i>	&nbsp;&nbsp;Transfer Certificate</h3></a>
						

						<div class="navbar-right">
							<span class="buttons" id="save">Save & Print</span>
