		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					<a href="menuslist.html?method=enquiryCreateScreen" id="plus"><span
						class="buttons" data-toggle="tooltip" data-placement="bottom" title="Add">Save</span></a>
						 <span
						id="editDesignationId" class="buttons" data-toggle="tooltip" data-placement="bottom" title="Edit">Modify</span>
					<span id="trash" class="buttons" data-toggle="tooltip" data-placement="bottom" title="Delete">Remove</span> 
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<display:table class="table" id="allstudent"
						...
						requestURI="/menuslist.html?method=studentEnquiryList">
