...
<script type="text/javascript"
	src="JS/backOffice/Student/StudentWithheld.js"></script>
<style>
.form-group{
margin-bottom: 5px;}
.save:hover {
...
<body>
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		<p><img src="images/addstu.png" /><span id="pageHeading">Student Withheld</span></p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i	class="glyphicon glyphicon-menu-hamburger"></i>	&nbsp;&nbsp;Student Withheld</h3></a>
						...
						<div class="panel-body own-panel">
							...
							<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;margin-top: 10px;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
									<input type="text" class="form-control" name="studSectionId" tabindex="4"
											onkeypress="HideError()" id="studSectionId"
											onchange="checkRollnumber()" maxlength="25"/>
							...
							<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;width:21%;">Reason</label>
									<div class="col-xs-7">
									<textarea rows="3" cols="113"></textarea>
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;width:21%;">Cancelled Reason</label>
									<div class="col-xs-7">
									<textarea rows="3" cols="113"></textarea>
