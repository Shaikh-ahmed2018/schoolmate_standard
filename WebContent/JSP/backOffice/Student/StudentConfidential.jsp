...
<script type="text/javascript"  src="JS/backOffice/Student/StudentConfidential.js"></script>
	...
	<div class="col-md-10" id="div-main"
		...
		<p>
			<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span
				id="pageHeading">Disciplinary Action</span>
		</p>
	 ...
	 value="<logic:present name="historystatus" scope="request"><bean:write name="historystatus"/></logic:present>"/>
				...
				<div id="collapseOne" class="panel-collapse collapse in "
					...
					<div class="panel-body own-panel">
						<div class="col-md-6"
							style="font-family: Roboto,sans-serif; font-size: 10pt; color: #000; margin-top: 20px;">
