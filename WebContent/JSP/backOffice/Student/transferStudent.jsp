...
<script type="text/javascript" src="JS/backOffice/Student/transferSchool.js"></script>
...
<body>
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		...
		<p><img src="images/addstu.png" /><span id="pageHeading">School Transfer</span></p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i	class="glyphicon glyphicon-menu-hamburger"></i>	&nbsp;&nbsp;School Transfer</h3></a>
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						<div class="panel-body own-panel">
							...
							<div style="background-color: #f5f5f5;color: #000000;font-weight: 500;font-size: 16px;"> Select School To Transfer</div>
