...
<script type="text/javascript"
	src="JS/backOffice/Student/StudentForAppraisal.js"></script>
<style>
.form-group{
margin-bottom: 5px;} 
.save:hover {
...
<body>
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span	id="pageHeading">Student Appraisal > New > Find Student</span>
			</p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i	class="glyphicon glyphicon-menu-hamburger"></i>	&nbsp;&nbsp;Find Student</h3></a>
						

						 <div class="navbar-right">
							<span class="buttons" id="admissionform">New</span>
