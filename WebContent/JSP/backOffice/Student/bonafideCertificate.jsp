...
<script type="text/javascript" src="JS/backOffice/Student/bonafideCertificate.js"></script>
...
<body>
	...
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		<p><img src="images/addstu.png" /><span id="pageHeading">Bonafide  Certificate</span></p>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Bonafide Certificate
							</h3></a>
 ...
 --%>	<input type="hidden" id="hiddenaddress" value='<logic:present name="stuList" scope="request"><bean:write name="stuList" property="address"/></logic:present>'/>
...
<input type="hidden" id="schName"
 ...
 value='<logic:present name="fatherName" scope="request"><bean:write name="fatherName"/></logic:present>'/>					
...
<input type="hidden" id="historyfindcerti"
 value='<logic:present name="historyfindcerti" scope="request"><bean:write name="historyfindcerti"/></logic:present>'/>				
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						<div class="panel-body own-panel" id="contents">
							...
							<div class="form-group clearfix">
								...
								<input type="hidden" id="hiddencurrentdate" value="<logic:present name="currentdate"><bean:write name="currentdate"/></logic:present>"/>
							...
							<div class="form-group clearfix">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" readonly="readonly" id="classname" style="background-color: #fff;" tabindex="1"	maxlength="25" class="form-control" 
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" readonly="readonly" style="background-color: #fff;" tabindex="1"	id="fathername"
											maxlength="25" class="form-control" 
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" tabindex="1"	id="purpose" maxlength="25" class="form-control" onclick="HideError(this)"/>
									</div>
								</div>
							...
							<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;margin-top: 10px;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" readonly="readonly" style="background-color: #fff;" tabindex="1"	 id="studentstatus"
											maxlength="25" class="form-control" 
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">DOB In Words</label>
									<div class="col-xs-7">
										
										<textarea style="background-color: #fff; resize: none" readonly="readonly" class="form-control" name="dobwords" id="dobwords"><logic:present name="stuList"><bean:write name="stuList" property="dateofBirthInWords"/></logic:present></textarea>
										<%-- <input type="text" readonly="readonly" style="background-color: #fff;" tabindex="1"	 id="dobwords" maxlength="25" class="form-control" 
											value='<logic:present name="stuList"><bean:write name="stuList" property="dateofBirthInWords"/></logic:present>' /> --%>
									</div>
								</div>
							</div>
						</div>
