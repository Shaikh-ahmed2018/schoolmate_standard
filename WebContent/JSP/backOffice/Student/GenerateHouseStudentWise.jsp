					...
					<div class="panel-heading" role="tab" id="headingOne">
						...
						<div class="navbar-right">
							...
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="GENHOUADD" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
											<span class="buttons"  style= "top:4px;"id="house">Generate House</span>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
						...
						<logic:present name="UserDetails" scope="session">
							<logic:iterate id="daymap" name="UserDetails"
								...
								<logic:equal value="GENHOUADD" name="daymap" property="key">
									<logic:equal value="true" name="daymap" property="value">
											<span class="buttons" style= "top:4px;"id="save">Save</span>
									</logic:equal>
								</logic:equal>
							</logic:iterate>
						</logic:present>
							<span class="buttons" style= "top:4px;"id="back">Back</span>
						</div>
							...
							<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;margin-top: 20px;">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										...
										<input type="hidden" name="filter1" id="filter1" class="form-control" readonly="readonly" value='<logic:present name="filter1"><bean:write name="filter1"/></logic:present>' />
									</div>
								</div>
							</div>
						...
						<logic:present name="housestudentwise" scope="request">
					   	<logic:iterate id="housestudentwise" name="housestudentwise" scope="request">
					   		<tr>
					   			...
					   			<td style="text-align:center" class="housename"><span></span><input type="hidden" class="houseid" /></td>
					   		</tr>
					   	</logic:iterate>
					   </logic:present>	
					 </tbody>					
