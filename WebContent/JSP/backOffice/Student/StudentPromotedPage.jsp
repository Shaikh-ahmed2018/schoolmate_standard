...
<script type="text/javascript" src="JS/backOffice/Student/StudentPromotedPage.js"></script>
<style>
.form-group{
margin-bottom: 5px;}
.save:hover {
						...
						<div class="navbar-right">
						    <logic:present name="UserDetails" scope="session">
								<logic:iterate id="daymap" name="UserDetails"
									...
									<logic:equal value="STUPROMUPD" name="daymap" property="key">
...
<input type="hidden" id="historylocId" 
  ...
  <input type="hidden" id="historysearchBy" 
  value="<logic:present name="historysearchBy" scope="request"><bean:write name="historysearchBy" /></logic:present>" />					
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						...
						<%-- <logic:iterate id="studentPromotedSetting" name="studentPromotedSetting"> --%>
							...
							<input type="hidden" id="promotedClass" name="promotedClass"
								value="<logic:present name="studentPromotedSetting"><bean:write name="studentPromotedSetting" property="classTo"/></logic:present>" />
							...
							<input type="hidden" id="hiddenSpecilizationId" name="hiddenSpecilizationId"
								value="<logic:present name="studentPromotedSetting"><bean:write name="studentPromotedSetting" property="tospec"/></logic:present>" />
							...
							<input type="hidden" id="hiddenPhotoId" name="hiddenPhotoId"
								value="<logic:present name="studentPromotedSetting"><bean:write name="studentPromotedSetting" property="studentPhoto"/></logic:present>" />
							...
							<div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;margin-top: 10px;">
								<div class="form-group clearfix" style="height: 87px;">
									...
									<div class="col-xs-7">
										<div style="border: 1px solid #B3B0B0; margin-bottom: 10px; width: 172px; height: 172px;">
												...
												<input type="file" id="studentImageId" name="studentImage" class="form-control" style=" height: 170px !important;width:170px; opacity: 0; z-index: 99999999;">
												</div>
										</div>
									</div>
								</div>
								...
								<div class="form-group clearfix" id="promotedClassf">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">Promoted Class</label>
									<div class="col-xs-7">
									    <select class="form-control" onkeypress="HideError()" tabindex="8" disabled="disabled"	name="newclass" id="newclass">
											<option value=""></option>
										</select>
								...
								<div class="form-group clearfix" id="newsectiondivid">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">Promoted Division<font color="red">*</font></label>
									<div class="col-xs-7">
							...
							<div class="form-group clearfix">
									...
									<div class="col-xs-7">
									<textarea style="border: 1px solid #ccc;font-size: 14px;" rows="3" cols="113" id="comments" name="comments"><logic:present name="studentPromotedSetting"><bean:write name="studentPromotedSetting" property="comments"/></logic:present></textarea>
