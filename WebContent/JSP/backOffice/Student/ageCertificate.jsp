			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Age Certificate
								</h3></a>
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						<div class="panel-body own-panel">
							...
							<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" readonly="readonly" id="schoolNames" style="background-color: #fff;" class="form-control" value='<logic:present name="stuList"><bean:write name="stuList" property="locname"/></logic:present>' />
								...
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5" style="text-align: right; line-height: 35px;">Purpose<font color="red">*</font></label>
									<div class="col-xs-7">
										<input type="text" id="purpose" class="form-control" maxlength="249" onclick="HideError(this)"/>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<input type="text" id="otherinfo" maxlength="249" class="form-control" />
									</div>
								</div>
							</div>
