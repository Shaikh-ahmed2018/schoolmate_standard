...
<script type="text/javascript"
	src="JS/backOffice/Student/StudentForTransferCertificate.js"></script>
<style>
.form-group{
margin-bottom: 5px;}
.save:hover {
...
<body>
	<div class="col-md-10" id="div-main" style="font-size: 16pt; color: #07aab9; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; ">
		<p>
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span	id="pageHeading">Transfer Certificate > New > Find Student</span>
			</p>
