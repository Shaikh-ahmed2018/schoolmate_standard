						...
						<input type="hidden" id="hSubjectId" value="<logic:present name="SubjectId"><bean:write name="SubjectId"/></logic:present>"/>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif" id="addmissionNo"><logic:present name="ClassName"><bean:write name="ClassName"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="SubjectName"><bean:write name="SubjectName"/></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<%-- <label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="MaxMarks"><bean:write name="MaxMarks" /></logic:present>-<logic:present name="FeeCollectionVo"><bean:write name="FeeCollectionVo" property="sectionname"/></logic:present>
										</label> --%>
							...
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="SectionName"><bean:write name="SectionName" /></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif"><logic:present name="ExamName"><bean:write name="ExamName" /></logic:present>
										</label>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-xs-6">
										<%-- <label for="inputPassword" class="col-xs-12"
											style="text-align: left; line-height: 35px;font-size: 13px;font-family: Roboto,sans-serif" id="concessionPercent"><logic:present name="MinMarks"><bean:write name="MinMarks" /></logic:present>%
										</label>
										 --%>
