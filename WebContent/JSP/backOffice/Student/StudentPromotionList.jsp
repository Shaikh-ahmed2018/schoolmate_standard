	...
	<div class="content" id="div1">
		...
		<div class="input-group col-md-7">
			...
			<label style="margin: 20px 0px; width: 8%; border: none;"
				...
				<label style="margin: 20px 0px; width: 8%; border: none;"
				class="form-control">Division</label> <select name="section"
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="navbar-right">
					...
					<a href="menuslist.html?method=studentPromotionscreen" id="plus">
						<span class="buttons">New</span>
					</a> 
					
					<!-- <a href="menuslist.html?method=studentPromotionscreenedit" id="editID">
					
						<span class="buttons">Edit</span>
					</a>
					
					 <a href="menuslist.html?method=studentPromotionList">
			...
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="panel-body"
					...
					<display:table class="table" id="allstudent"
						...
						requestURI="/menuslist.html?method=studentPromotionList">
