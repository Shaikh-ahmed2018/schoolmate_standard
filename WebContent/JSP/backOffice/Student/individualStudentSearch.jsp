			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary panel-list">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>&nbsp;&nbsp;Student Search
							</h3></a>
						
						
						<div class="navbar-right">
							<span class="search"  style="top:0px">
							<label style="text-align: right;color:#000000;font-family:Roboto,sans-serif;font-weight: 500;font-size: 15px;padding: 4px;">Select Action</label>	 
							 				<select class="nil" style="color:#000000;font-family:inherit;font-size: 14px;padding: 2px">
					...
					<div id="collapseOne" class="panel-collapse collapse in " role="tabpanel" aria-labelledby="headingOne">
						...
						<input type="hidden" name="status"  id="status"
							value='<logic:present name="studentSearchList"><bean:write name="studentSearchList" property="status"/></logic:present>' /> 
