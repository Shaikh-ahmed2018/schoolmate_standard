...
<body>
	...
	<div class="col-md-10" id="div-main"
		...
		<p class="transportheader">
			<span class="glyphicon glyphicon-user"></span>&nbsp;<span id="pageHeading">Generate Payroll</span>
		</p>
				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="color: #000000;vertical-align: text-top"> 
								<h3 class="panel-title"><i class="glyphicon glyphicon-menu-hamburger"></i>
								&nbsp;&nbsp;Generate Payroll
							</h3></a>
					...
					<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="margin-bottom: 34px;">
						...
						<div class="col-md-12" style="font-size: 16px;padding:5px;clear:both;">
							...
							<display:table export="false" id="allstudent"  name="requestScope.payroll_list_status" 
							requestURI="teachermenuaction.do?method=generatePayroll" class="table table-bordered allstudent">
							...
							<display:column property="yearval" title="Financial Year" headerClass="heading1" sortable="false" />
