						...
						<div class="panel-body">
							<div class="col-md-6" id="txtstyle">
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
									<input type="text" class="form-control" value="<logic:present name="locationname"><bean:write name="locationname" /></logic:present>">
								</div>
								</div>
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										...
										<div class="col-xs-7">
										<input type="text" class="form-control" value="<logic:present name="monthname"><bean:write name="monthname" /></logic:present>">
								</div>
								</div>
						</div>
						...
						<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
										style="text-align: right; line-height: 35px;">Financial Year:</label>
											<div class="col-xs-7">
										<input type="text" class="form-control" value="<logic:present name="accyear"><bean:write name="accyear" /></logic:present>">
										</div>
								</div>
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-5"
