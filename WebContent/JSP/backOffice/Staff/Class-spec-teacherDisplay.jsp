...
<script type="text/javascript" src="JS/backOffice/Staff/Class-spec-teacherDisplay.js"></script>
    ...
    <input type="hidden" id="historyacayear" 
     ...
     value='<logic:present name="historylocation" scope="request"><bean:write name="historylocation"/></logic:present>'/>
			...
			<div id="ExamOne" class="accordion-body collapse in">
				...
				<div class="clearfix">
					...
					<div class="col-md-6" id="txtstyle" style="font-size: 13px; color: #000;margin-top:10px;">
							<div class="form-group clearfix">
									...
									<div class="col-xs-7">
											<input type="text" readonly="readonly" name="locName"  id="locationName"
									...
									<input type="hidden"  name="hiddenlocName"  id="hiddenlocName"
									 value='<logic:present name="locName" scope="request"><bean:write name="locName" ></bean:write></logic:present>' />
					</div>
						</div>		
					...
					<div class="form-group clearfix">
									...
									<div class="col-xs-7">
											<input type="text" readonly="readonly" name="accyear1"  id="acayear1"
				...
				<!-- table info -->
				<div class="panel-body emptytableCheck"
					style="font-family: Roboto,sans-serif; font-size: 13px; color: #000;">

					<logic:present name="teacherInfo" scope="request">
						<table class="table" id="allstudent">
							...
							<tbody>
							<logic:iterate id="teacherInfo" name="teacherInfo">
								<tr id="<bean:write name="teacherInfo" property='teacherId'/>">
									<td><bean:write name="teacherInfo" property='sno'/></td>
									<td><bean:write name="teacherInfo" property='accyearName'/></td>
									<td><bean:write name="teacherInfo" property='locationName'/></td>
									<td><bean:write name="teacherInfo" property='registerId'/></td>
									<td><bean:write name="teacherInfo" property='teacherName'/></td>
									<td><span class="<bean:write name="teacherInfo" property='status'/>"><bean:write name="teacherInfo" property='status'/></span></td>
								</tr>
							</logic:iterate>
							</tbody>
