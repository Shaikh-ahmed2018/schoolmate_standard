...
#collapseOne #allstudent  tr td, .allstudent  tr td {
	padding: 0;
	margin: 0;
	padding-left: 5px;
}
...
#collapseOne input[type="text"], select {
	...
	<div class="content" id="div1">
		<div class="col-md-8" id="div2">
			...
			<p class="transportheader">
				<span class="glyphicon glyphicon-user" style="vertical-align: -5px; margin-right: 5px; padding-left: 5px;"></span><span id="pageHeading">IT Declaration Details</span>
			</p>
		</div>
 ...
 -->
					...
					<!-- Entering Manually -->
						...
						<table class="section" id="allstudent" cellpadding="5" cellspacing="0" border="1" width="100%">
							...
							<input type="hidden" name="tdssd" id="tdssd" value="<logic:present name="list"><bean:write name="list" property="standarddedu" /></logic:present>" />
							...
							<input type="hidden" name="taxworkPerMonth" id="taxworkPerMonth" value="" />
								...
								<td class="tdfirstchild">
									<input type="text" name="empprovidentfund"	id="empprovidentfund"  tabindex="15"
										value="" class="tdsecondchildon" readonly="readonly" />
