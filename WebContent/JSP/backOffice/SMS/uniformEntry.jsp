...
<script type="text/javascript" src="JS/backOffice/SMS/uniformEntry.js"></script>
...
<body>
	<div class="col-md-10"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">Uniform</span>
		</p>
			...
			<div class="message-item">
			   ...
			   <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<div class="panel panel-primary">
					...
					<!-- <input type="hidden" name="hiddenclassname" class="searchtermclass"
						id="hclassid" value="" /> <input type="hidden" name="hiddensection"
						class="searchtermclass" id="hsectionid" /> <input type="hidden"
						name="student" class="searchtermclass" id="hstudentid" /> -->
						...
						<div class="panel-body" style="margin-top: 11px;">
							<div class="col-md-6" id="txtstyle">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select  multiple id="studentid" class="form-control" onkeypress="HideError()" >
									<option value=""></option>
							...
							<div class="col-md-6" id="txtstyle">
                              ...
                              <div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select  id="locId" onkeypress="HideError()"
											class="form-control">
											<option value="">------Select------</option>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select  multiple id="sectionid" onkeypress="HideError()" class="form-control">
											<option value=""></option>
											<logic:notEmpty name="ALLACCYEARS" scope="request">
												<logic:iterate id="map" name="ALLACCYEARS" scope="request">
													<option value='<bean:write name='map' property='key'/>'>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<textarea id="smstext" class="form-control"
											onkeypress="HideError()"
											style="width: 100%; height: 108px; margin-top: 0px; margin-bottom:">
