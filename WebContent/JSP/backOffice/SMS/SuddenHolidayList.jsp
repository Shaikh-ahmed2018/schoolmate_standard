...
<script type="text/javascript" src="JS/backOffice/SMS/SuddenHoliday.js"></script>
...
<div id="loder" style="display: none; position:absolute; height: 800px;width: 800px;left: 0;right: 0;top: -40px;bottom: 0;margin: auto;z-index: 99999; "><img style="width: 165px;position: absolute;left: 0;right: 0;height: 165px;bottom: 0;top: -190px;margin: auto;" src="./images/ajax-loading.gif"/></div>
	<div class="content" id="div1">
        ...
        <div class="" id="div2">
			<p style="">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span id="pageHeading">Sudden Holiday Details</span>
			</p>
		</div>
			...
			<div class="panel-heading clearfix">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Sudden Holiday List
            ...
            <div class="col-md-6" style="font-family: Roboto,sans-serif; font-size: 13px; color: #000; margin-top: 10px;">
					...
					<logic:present name="holidayList" scope="request">
						<table class="table" id="allstudent">
							...
							<th style="min-width:114px;">Holiday Date</th>
							...
							<logic:iterate id="holidayList" name="holidayList">
								...
								<td><bean:write name="holidayList" property='slNo'/></td>
								<td><bean:write name="holidayList" property='credate'/></td>
								<td><bean:write name="holidayList" property='date'/></td>					
								<td><bean:write name="holidayList" property='classname'/>-<bean:write name="holidayList" property='secname'/></td>
								<td><bean:write name="holidayList" property='smsstatus'/></td>
