...
<script type="text/javascript" src="JS/backOffice/SMS/AbsentSMS.js"></script>
<style>
...
<body>
	...
	<div class="content" id="div1">
		<div class="" id="div2">
			<p style="">
				<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<span id="pageHeading">Absent List Details</span>
			</p>
		</div>
			...
			<div class="panel-heading">
				<a data-toggle="collapse" data-parent="#accordion2"
					href="#collapseOne" style="color: #fff;"><h3
						...
						<span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;&nbsp;Absent
						List
					</h3></a>
				...
				<div class="navbar-right">
                            ...
                            <logic:present name="UserDetails" scope="session">
								 <logic:iterate id="daymap" name="UserDetails" property="permissionmap" scope="session">
									<logic:equal value="ABADD" name="daymap" property="key">
			...
			<div id="collapseOne" class="accordion-body collapse in clearfix">
				<div class="panel-body"
					...
					<div class="col-md-6"
						...
						<input type="hidden" id="hiddenAcademicYear"
							value="<logic:present name="academic_year"><bean:write name="academic_year"/></logic:present>">
					...
					<div id="scrolid" style="width: 100%;">

						<logic:present name="absentList" scope="request">

							<table class="table" id="allstudent" style="margin-bottom: 0px;">
								<thead>
									<tr>
										<!-- <th><input type='checkbox' name='selectall' id='selectall'/></th> -->
										<th style="min-width: 50px;">Sl.No</th>
										<th style="min-width: 114px;">SMS Sent Date</th>
										<th style="min-width: 100px;">Absent Date</th>
										<th style="min-width: 200px;">Student Name</th>
										<th style="min-width: 90px;">Class - Division</th>
								...
								<tbody>
									<logic:iterate id="absentList" name="absentList">
										<tr>
											<%-- <td><input type='checkbox' name='selectall' value='<bean:write name="absentList" property='absentcode'/>' class='select' id='select' onClick='selectAll()' /></td> --%>
											<td><bean:write name="absentList" property='slNo' /></td>
											<td><bean:write name="absentList" property='senddate' /></td>
											<td><bean:write name="absentList" property='date' /></td>
											<td><bean:write name="absentList" property='studentName' /></td>
											<td><bean:write name="absentList" property='classname' />
												- <bean:write name="absentList" property='section' /></td>
											<td><bean:write name="absentList" property='status' /></td>
										</tr>
									</logic:iterate>
								</tbody>
							</table>
					...
					<div class="pagebanner" style="margin-top: 3px;">
