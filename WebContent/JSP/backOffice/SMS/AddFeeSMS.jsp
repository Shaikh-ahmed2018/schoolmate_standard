...
<script type="text/javascript" src="JS/backOffice/SMS/AddFeeSMS.js"></script>
...
<body>
	<div class="col-md-10"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">New Fee SMS</span>
		</p>
						...
						<div class="panel-body" style="margin-top: 11px;">
							<div class="col-md-6" id="txtstyle">
							 ...
							 <div class="form-group clearfix">
								  ...
								  <div class="form-group clearfix">
									<label for="inputEmail" class="control-label col-xs-4"
										style="text-align: right; line-height: 35px;">Term<font color="red">*</font></label>

									<div class="col-xs-7">
										<select name="term" id="termid" class="form-control"  onclick="HideError(this)" >
											<option value=""></option>
										</select>
									</div>
						     </div>
									...
									<div class="col-xs-7">
										<select name="accyear" multiple id="studentid" class="form-control" onclick="HideError(this)" style="height: 137px !important;" >
									<option value=""></option>
							...
							<div class="col-md-6" id="txtstyle">
								<div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-4"
										...
										Fee Date<font color="red">*</font></label>
									<div class="col-xs-7">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<textarea  readonly="readonly"  name="smstext" id="description" class="form-control" onclick="HideError()" style=" width: 100%; height: 108px; margin-top: 0px; margin-bottom:"></textarea>
									</div>
								</div>
