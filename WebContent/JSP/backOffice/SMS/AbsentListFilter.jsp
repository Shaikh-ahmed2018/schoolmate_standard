...
<script type="text/javascript" src="JS/backOffice/SMS/AbsentSMSList.js"></script> 
...
<body>
	<div class="col-md-10"
		...
		<p>
			<img src="images/addstu.png" />&nbsp;<span id="pageHeading">New Absent SMS</span>
		</p>
  ...
  <logic:present name="errormessage" scope="request">
		...
		<!-- <form id="SuddenHolidays" action="absentSMS.html?method=storeAbsentSms" method="post"> -->
				...
				<div class="panel panel-primary">
					<div class="panel-heading" role="tab" id="headingOne">
							...
							<div class="navbar-right" >
							  ...
							  <span id="AbsentSave"  class="buttons" data-toggle="modal"
		    ...
		    <input	type="hidden" name="student" id="studentCode" value=""/>
			...
			<div id="collapseOne" class="panel-collapse collapse in"
						...
						<div class="panel-body" style="margin-top: 11px;">
							<div class="col-md-6"
								id="txtstyle">
									...
									<div class="col-xs-7">
										<select  id="locId" onchange="HideError(this)"
											class="form-control">
						...
						<div class="form-group clearfix">
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select  multiple id="studentid" class="form-control" onchange="HideError(this)" style="height: 168px !important;" >
									<option value=""></option>
							...
							<div class="col-md-6" id="txtstyle">
							 <div class="form-group clearfix">
									<label for="inputPassword" class="control-label col-xs-4"
										...
										Absent Date<font color="red">*</font></label>
									<div class="col-xs-7">
										<input type="text"  class="form-control absentDate" readonly="readonly" name="date" id="dateId" onkeypress="HideError()"  value="<logic:present name="driverlist" ><bean:write name="driverlist" property="dateofJoin"/></logic:present>"/>
									</div>
								</div>
								...
								<div class="form-group clearfix">
									...
									<div class="col-xs-7">
										<select  multiple id="sectionid" onchange="HideError(this)" class="form-control">
											<option value=""></option>
											<logic:notEmpty name="ALLACCYEARS" scope="request">
												<logic:iterate id="map" name="ALLACCYEARS" scope="request">
													<option value='<bean:write name='map' property='key'/>'>
